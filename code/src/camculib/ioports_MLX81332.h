/*!*************************************************************************** *
 * \file        ioports_MLX81332.h
 * \brief       MLX81332A|B I/O-ports-map
 *
...
#ifndef __MLX81332A01__
#ifndef __MLX81332B01__
#ifndef __MLX81332B02__
#error "Wrong ioports.h file"
#endif /* __MLX81332B02__ */
#endif /* __MLX81332B01__ */
#endif /* __MLX81332A01__ */
...
/* Block: PORT_ADC_CTRL */
/* ******************** */
extern volatile uint16_t IO_PORT_ADC_CTRL_S __attribute__((io, addr(0x34)));    /*!< IO_PORT_ADC_CTRL (System) */
...
#define B_PORT_TEST_ADC_TEST_ADC_CURSRC         (1U << 4)                       /*!< RW: Value for analogue */
...
/* Block: MLX16 */
/* ************ */
extern volatile uint16_t IO_MLX16_DBG_DATA0 __attribute__((nodp, addr(0x00038)));  /*!< IO_MLX16_DBG_DATA0_S */
...
#define M_MLX16_ITC_PEND3                       (511U << 0)                     /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#elif defined (__MLX81332B01__) || defined (__MLX81332B02__)
...
#define B_MLX16_ITC_PEND3_IO_IN4                (1U << 4)                       /*!< 0x01D0 */
#define B_MLX16_ITC_PEND3_IO_IN5                (1U << 5)                       /*!< 0x01D8 */
#define B_MLX16_ITC_PEND3_IO_IN6                (1U << 6)                       /*!< 0x01E0 */
#define B_MLX16_ITC_PEND3_IO_IN7                (1U << 7)                       /*!< 0x01E8 */
#if defined (__MLX81332A01__)
#define B_MLX16_ITC_PEND3_MLX16_SOFT            (1U << 8)                       /*!< 0x01F0 */
#elif defined (__MLX81332B01__) || defined (__MLX81332B02__)
#define B_MLX16_ITC_PEND3_UART_SB               (1U << 8)                       /*!< 0x01F0 */
#define B_MLX16_ITC_PEND3_UART_RS               (1U << 9)                       /*!< 0x01F8 */
#define B_MLX16_ITC_PEND3_UART_RR               (1U << 10)                      /*!< 0x0200 */
#define B_MLX16_ITC_PEND3_UART_TS               (1U << 11)                      /*!< 0x0208 */
#define B_MLX16_ITC_PEND3_UART_TR               (1U << 12)                      /*!< 0x0210 */
#define B_MLX16_ITC_PEND3_UART_TE               (1U << 13)                      /*!< 0x0218 */
#define B_MLX16_ITC_PEND3_UDFR                  (1U << 14)                      /*!< 0x0220 */
#define B_MLX16_ITC_PEND3_UDFT                  (1U << 15)                      /*!< 0x0228 */
#endif

#if defined (__MLX81332B01__) || defined (__MLX81332B02__)
extern volatile uint16_t IO_MLX16_ITC_PEND4_S __attribute__((nodp, addr(0x00058)));  /*!< IO_MLX16_ITC_PEND4_S (System) */
#define M_MLX16_ITC_PEND4                       (3U << 0)                       /*!< R: 1 If the interrupt[INT0_COUNT+xx:INT0_COUNT+64] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#define B_MLX16_ITC_PEND4_TX_TIMEROUT           (1U << 0)                       /*!< 0x0230 */
#define B_MLX16_ITC_PEND4_MLX16_SOFT            (1U << 1)                       /*!< 0x0238 */
#endif
...
#if defined (__MLX81332A01__)
#define M_MLX16_ITC_MASK3                       (511U << 0)                     /*!< RW: 1 to enable interrupt[INT0_COUNT+63:INT0_COUNT+48] */
#elif defined (__MLX81332B01__) || defined (__MLX81332B02__)
...
#define B_MLX16_ITC_MASK3_IO_IN4                (1U << 4)                       /*!< 0x01D0 */
#define B_MLX16_ITC_MASK3_IO_IN5                (1U << 5)                       /*!< 0x01D8 */
#define B_MLX16_ITC_MASK3_IO_IN6                (1U << 6)                       /*!< 0x01E0 */
#define B_MLX16_ITC_MASK3_IO_IN7                (1U << 7)                       /*!< 0x01E8 */
#if defined (__MLX81332A01__)
#define B_MLX16_ITC_MASK3_MLX16_SOFT            (1U << 8)                       /*!< 0x01F0 */
#elif defined (__MLX81332B01__) || defined (__MLX81332B02__)
#define B_MLX16_ITC_MASK3_UART_SB               (1U << 8)                       /*!< 0x01F0 */
#define B_MLX16_ITC_MASK3_UART_RS               (1U << 9)                       /*!< 0x01F8 */
#define B_MLX16_ITC_MASK3_UART_RR               (1U << 10)                      /*!< 0x0200 */
#define B_MLX16_ITC_MASK3_UART_TS               (1U << 11)                      /*!< 0x0208 */
#define B_MLX16_ITC_MASK3_UART_TR               (1U << 12)                      /*!< 0x0210 */
#define B_MLX16_ITC_MASK3_UART_TE               (1U << 13)                      /*!< 0x0218 */
#define B_MLX16_ITC_MASK3_UDFR                  (1U << 14)                      /*!< 0x0220 */
#define B_MLX16_ITC_MASK3_UDFT                  (1U << 15)                      /*!< 0x0228 */
#endif

#if defined (__MLX81332B01__) || defined (__MLX81332B02__)
extern volatile uint16_t IO_MLX16_ITC_MASK4_S __attribute__((nodp, addr(0x00074)));  /*!< IO_MLX16_ITC_MASK4_S (System) */
#define M_MLX16_ITC_MASK4                       (3U << 0)                       /*!< RW: 1 to enable interrupt[INT0_COUNT+79:INT0_COUNT+64]  */
#define B_MLX16_ITC_MASK4_TX_TIMEROUT           (1U << 0)                       /*!< 0x0230 */
#define B_MLX16_ITC_MASK4_MLX16_SOFT            (1U << 1)                       /*!< 0x0238 */
#endif
...
#if defined (__MLX81332A01__)
#define M_MLX16_ITC_PRIO4                       (255U << 0)                     /*!< RW: Configure priority for interrupt[INT0_COUNT+INT1_COUNT+INT2_COUNT+39:INT0_COUNT+INT1_COUNT+INT2_COUNT+32] */
#elif defined (__MLX81332B01__) || defined (__MLX81332B02__)
...
#endif
#define M_MLX16_ITC_PRIO4_IO_IN4                (3U << 0)                       /*!< RW: priority IO_IN4 */
#define C_MLX16_ITC_PRIO4_IO_IN4_PRIO3          (0U << 0)                       /*!< RW: priority 3 IO_IN4 */
#define C_MLX16_ITC_PRIO4_IO_IN4_PRIO4          (1U << 0)                       /*!< RW: priority 4 IO_IN4 */
#define C_MLX16_ITC_PRIO4_IO_IN4_PRIO5          (2U << 0)                       /*!< RW: priority 5 IO_IN4 */
#define C_MLX16_ITC_PRIO4_IO_IN4_PRIO6          (3U << 0)                       /*!< RW: priority 6 IO_IN4 */
#define M_MLX16_ITC_PRIO4_IO_IN5                (3U << 2)                       /*!< RW: priority IO_IN5 */
#define C_MLX16_ITC_PRIO4_IO_IN5_PRIO3          (0U << 2)                       /*!< RW: priority 3 IO_IN5 */
#define C_MLX16_ITC_PRIO4_IO_IN5_PRIO4          (1U << 2)                       /*!< RW: priority 4 IO_IN5 */
#define C_MLX16_ITC_PRIO4_IO_IN5_PRIO5          (2U << 2)                       /*!< RW: priority 5 IO_IN5 */
#define C_MLX16_ITC_PRIO4_IO_IN5_PRIO6          (3U << 2)                       /*!< RW: priority 6 IO_IN5 */
#define M_MLX16_ITC_PRIO4_IO_IN6                (3U << 4)                       /*!< RW: priority IO_IN6 */
#define C_MLX16_ITC_PRIO4_IO_IN6_PRIO3          (0U << 4)                       /*!< RW: priority 3 IO_IN6 */
#define C_MLX16_ITC_PRIO4_IO_IN6_PRIO4          (1U << 4)                       /*!< RW: priority 4 IO_IN6 */
#define C_MLX16_ITC_PRIO4_IO_IN6_PRIO5          (2U << 4)                       /*!< RW: priority 5 IO_IN6 */
#define C_MLX16_ITC_PRIO4_IO_IN6_PRIO6          (3U << 4)                       /*!< RW: priority 6 IO_IN6 */
#define M_MLX16_ITC_PRIO4_IO_IN7                (3U << 6)                       /*!< RW: priority IO_IN7 */
#define C_MLX16_ITC_PRIO4_IO_IN7_PRIO3          (0U << 6)                       /*!< RW: priority 3 IO_IN7 */
#define C_MLX16_ITC_PRIO4_IO_IN7_PRIO4          (1U << 6)                       /*!< RW: priority 4 IO_IN7 */
#define C_MLX16_ITC_PRIO4_IO_IN7_PRIO5          (2U << 6)                       /*!< RW: priority 5 IO_IN7 */
#define C_MLX16_ITC_PRIO4_IO_IN7_PRIO6          (3U << 6)                       /*!< RW: priority 6 IO_IN7 */
#if defined (__MLX81332B01__) || defined (__MLX81332B02__)
#define M_MLX16_ITC_PRIO4_UART_SB               (3U << 8)                       /*!< RW: priority UART SB */
#define C_MLX16_ITC_PRIO4_UART_SB_PRIO3         (0U << 8)                       /*!< RW: priority 3 UART SB */
#define C_MLX16_ITC_PRIO4_UART_SB_PRIO4         (1U << 8)                       /*!< RW: priority 4 UART SB */
#define C_MLX16_ITC_PRIO4_UART_SB_PRIO5         (2U << 8)                       /*!< RW: priority 5 UART SB */
#define C_MLX16_ITC_PRIO4_UART_SB_PRIO6         (3U << 8)                       /*!< RW: priority 6 UART SB */
#define M_MLX16_ITC_PRIO4_UART_RS               (3U << 10)                      /*!< RW: priority UART RS */
#define C_MLX16_ITC_PRIO4_UART_RS_PRIO3         (0U << 10)                      /*!< RW: priority 3 UART RS */
#define C_MLX16_ITC_PRIO4_UART_RS_PRIO4         (1U << 10)                      /*!< RW: priority 4 UART RS */
#define C_MLX16_ITC_PRIO4_UART_RS_PRIO5         (2U << 10)                      /*!< RW: priority 5 UART RS */
#define C_MLX16_ITC_PRIO4_UART_RS_PRIO6         (3U << 10)                      /*!< RW: priority 6 UART RS */
#define M_MLX16_ITC_PRIO4_UART_RR               (3U << 12)                      /*!< RW: priority UART RR */
#define C_MLX16_ITC_PRIO4_UART_RR_PRIO3         (0U << 12)                      /*!< RW: priority 3 UART RR */
#define C_MLX16_ITC_PRIO4_UART_RR_PRIO4         (1U << 12)                      /*!< RW: priority 4 UART RR */
#define C_MLX16_ITC_PRIO4_UART_RR_PRIO5         (2U << 12)                      /*!< RW: priority 5 UART RR */
#define C_MLX16_ITC_PRIO4_UART_RR_PRIO6         (3U << 12)                      /*!< RW: priority 6 UART RR */
#define M_MLX16_ITC_PRIO4_UART_TS               (3U << 14)                      /*!< RW: priority UART TS */
#define C_MLX16_ITC_PRIO4_UART_TS_PRIO3         (0U << 14)                      /*!< RW: priority 3 UART TS */
#define C_MLX16_ITC_PRIO4_UART_TS_PRIO4         (1U << 14)                      /*!< RW: priority 4 UART TS */
#define C_MLX16_ITC_PRIO4_UART_TS_PRIO5         (2U << 14)                      /*!< RW: priority 5 UART TS */
#define C_MLX16_ITC_PRIO4_UART_TS_PRIO6         (3U << 14)                      /*!< RW: priority 6 UART TS */
#endif

#if defined (__MLX81332B01__) || defined (__MLX81332B02__)
extern volatile uint16_t IO_MLX16_ITC_PRIO5_S __attribute__((nodp, addr(0x00092)));  /*!< IO_MLX16_ITC_PRIO5_S (System) */
#define M_MLX16_ITC_PRIO5                       (1023U << 0)                    /*!< RW: Configure priority for interrupt[INT0_COUNT+INT1_COUNT+INT2_COUNT+47:INT0_COUNT+INT1_COUNT+INT2_COUNT+40] */
#define M_MLX16_ITC_PRIO5_UART_TR               (3U << 0)                       /*!< RW: priority UART TR */
#define C_MLX16_ITC_PRIO5_UART_TR_PRIO3         (0U << 0)                       /*!< RW: priority 3 UART TR */
#define C_MLX16_ITC_PRIO5_UART_TR_PRIO4         (1U << 0)                       /*!< RW: priority 4 UART TR */
#define C_MLX16_ITC_PRIO5_UART_TR_PRIO5         (2U << 0)                       /*!< RW: priority 5 UART TR */
#define C_MLX16_ITC_PRIO5_UART_TR_PRIO6         (3U << 0)                       /*!< RW: priority 6 UART TR */
#define M_MLX16_ITC_PRIO5_UART_TE               (3U << 2)                       /*!< RW: priority UART TE */
#define C_MLX16_ITC_PRIO5_UART_TE_PRIO3         (0U << 2)                       /*!< RW: priority 3 UART TE */
#define C_MLX16_ITC_PRIO5_UART_TE_PRIO4         (1U << 2)                       /*!< RW: priority 4 UART TE */
#define C_MLX16_ITC_PRIO5_UART_TE_PRIO5         (2U << 2)                       /*!< RW: priority 5 UART TE */
#define C_MLX16_ITC_PRIO5_UART_TE_PRIO6         (3U << 2)                       /*!< RW: priority 6 UART TE */
#define M_MLX16_ITC_PRIO5_UDFR                  (3U << 4)                       /*!< RW: priority UDFR */
#define C_MLX16_ITC_PRIO5_UDFR_PRIO3            (0U << 4)                       /*!< RW: priority 3 UDFR */
#define C_MLX16_ITC_PRIO5_UDFR_PRIO4            (1U << 4)                       /*!< RW: priority 4 UDFR */
#define C_MLX16_ITC_PRIO5_UDFR_PRIO5            (2U << 4)                       /*!< RW: priority 5 UDFR */
#define C_MLX16_ITC_PRIO5_UDFR_PRIO6            (3U << 4)                       /*!< RW: priority 6 UDFR */
#define M_MLX16_ITC_PRIO5_UDFT                  (3U << 6)                       /*!< RW: priority UDTF */
#define C_MLX16_ITC_PRIO5_UDFT_PRIO3            (0U << 6)                       /*!< RW: priority 3 UDTF */
#define C_MLX16_ITC_PRIO5_UDFT_PRIO4            (1U << 6)                       /*!< RW: priority 4 UDTF */
#define C_MLX16_ITC_PRIO5_UDFT_PRIO5            (2U << 6)                       /*!< RW: priority 5 UDTF */
#define C_MLX16_ITC_PRIO5_UDFT_PRIO6            (3U << 6)                       /*!< RW: priority 6 UDTF */
#define M_MLX16_ITC_PRIO5_TX_TIMEOUT            (3U << 8)                       /*!< RW: priority TX TIMEROUT */
#define C_MLX16_ITC_PRIO5_TX_TIMEOUT_PRIO3      (0U << 8)                       /*!< RW: priority 3 TX TIMEROUT */
#define C_MLX16_ITC_PRIO5_TX_TIMEOUT_PRIO4      (1U << 8)                       /*!< RW: priority 4 TX TIMEROUT */
#define C_MLX16_ITC_PRIO5_TX_TIMEOUT_PRIO5      (2U << 8)                       /*!< RW: priority 5 TX TIMEROUT */
#define C_MLX16_ITC_PRIO5_TX_TIMEOUT_PRIO6      (3U << 8)                       /*!< RW: priority 6 TX TIMEROUT */
#endif
...
typedef enum
{
    ...
    C_ADC_CH21 = 21U,                                                           /*!< IO[4]/1.36 */
    C_ADC_IO4_LV = C_ADC_CH21,
    C_ADC_CH22 = 22U,                                                           /*!< IO[5]/1.36 */
    C_ADC_IO5_LV = C_ADC_CH22,
    C_ADC_CH23 = 23U,                                                           /*!< IO[6]/1.36 */
    C_ADC_IO6_LV = C_ADC_CH23,
    C_ADC_CH24 = 24U,                                                           /*!< IO[7]/1.36 */
    C_ADC_IO7_LV = C_ADC_CH24,
    C_ADC_CH25 = 25U,                                                           /*!< LIN */
...
#if defined (_OLD)
#define M_ADC_MARKER                            (3U << 0)                       /*!< ADC Marker Mask */
#define C_ADC_EOF                               (2U << 0)                       /*!< End-of-Frame */
#define C_ADC_EOS                               (3U << 0)                       /*!< End-of-Sequence */

/* Channels */
#define M_ADC_CH                                (31U << 2)                      /*!< ADC Channel Mask */
#define C_ADC_CH0                               (0U << 2)                       /*!< VS, Internal high ohmic divider 1:21 */
...
#define C_ADC_CH4                               (4U << 2)                       /*!< Bandgap voltage digital */
#define C_ADC_CH5                               (5U << 2)                       /*!< Vaux/4 */
#define C_ADC_CH6                               (6U << 2)                       /*!< LIN auto config amplifier output */
#define C_ADC_CH7                               (7U << 2)                       /*!< LIN auto config common mode */
...
#define C_ADC_CH21                              (21U << 2)                      /*!< IO[4]/1.36 */
#define C_ADC_CH22                              (22U << 2)                      /*!< IO[5]/1.36 */
#define C_ADC_CH23                              (23U << 2)                      /*!< IO[6]/1.36 */
#define C_ADC_CH24                              (24U << 2)                      /*!< IO[7]/1.36 */
#define C_ADC_CH25                              (25U << 2)                      /*!< LIN */

/* Reference voltage */
#define M_ADC_REF                               (7U << 7)                       /*!< ADC Reference Voltage Mask */
...
/* HW trigger source */
#define M_ADC_HW_TRIGGER                        (31U << 10)                     /*!< ADC HW-Trigger Mask */
#define C_ADC_HW_TRIGGER_MSTR1_CMP              (0U << 10)                      /*!< ADC HW-Trigger PWM_MASTER1_CMP */
#define C_ADC_HW_TRIGGER_MSTR1_CNT              (1U << 10)                      /*!< ADC HW-Trigger PWM_MASTER1_CNT */
#define C_ADC_HW_TRIGGER_SLV1_CMP               (2U << 10)                      /*!< ADC HW-Trigger PWM_SLAVE1_CMP */
#define C_ADC_HW_TRIGGER_SLV2_CMP               (3U << 10)                      /*!< ADC HW-Trigger PWM_SLAVE2_CMP */
#define C_ADC_HW_TRIGGER_SLV3_CMP               (4U << 10)                      /*!< ADC HW-Trigger PWM_SLAVE3_CMP */
#define C_ADC_HW_TRIGGER_MSTR2_CMP              (5U << 10)                      /*!< ADC HW-Trigger PWM_MASTER2_CMP */
#define C_ADC_HW_TRIGGER_MSTR2_CNT              (6U << 10)                      /*!< ADC HW-Trigger PWM_MASTER2_CNT */
#define C_ADC_HW_TRIGGER_IO0                    (7U << 10)                      /*!< ADC HW-Trigger IO0 */
#define C_ADC_HW_TRIGGER_IO1                    (8U << 10)                      /*!< ADC HW-Trigger IO1 */
#define C_ADC_HW_TRIGGER_IO2                    (9U << 10)                      /*!< ADC HW-Trigger IO2 */
#define C_ADC_HW_TRIGGER_IO3                    (10U << 10)                     /*!< ADC HW-Trigger IO3 */
#define C_ADC_HW_TRIGGER_CTIMER0_INT1           (11U << 10)                     /*!< ADC HW-Trigger CTIMER0_INT1 */
#define C_ADC_HW_TRIGGER_CTIMER0_INT2           (12U << 10)                     /*!< ADC HW-Trigger CTIMER0_INT2 */
#define C_ADC_HW_TRIGGER_CTIMER0_INT3           (13U << 10)                     /*!< ADC HW-Trigger CTIMER0_INT3 */
#define C_ADC_HW_TRIGGER_CTIMER1_INT1           (14U << 10)                     /*!< ADC HW-Trigger CTIMER1_INT1 */
#define C_ADC_HW_TRIGGER_CTIMER1_INT2           (15U << 10)                     /*!< ADC HW-Trigger CTIMER1_INT2 */
#define C_ADC_HW_TRIGGER_CTIMER1_INT3           (16U << 10)                     /*!< ADC HW-Trigger CTIMER1_INT3 */
#define C_ADC_HW_TRIGGER_IO4                    (17U << 10)                     /*!< ADC HW-Trigger IO4 */
#define C_ADC_HW_TRIGGER_IO5                    (18U << 10)                     /*!< ADC HW-Trigger IO5 */
#define C_ADC_HW_TRIGGER_IO6                    (19U << 10)                     /*!< ADC HW-Trigger IO6 */
#define C_ADC_HW_TRIGGER_IO7                    (20U << 10)                     /*!< ADC HW-Trigger IO7 */
...
#define C_ADC_IO4           (C_ADC_CH21 | (uint16_t)C_ADC_REF_2_50_V)           /*!< 21  2.5V  IO[4] (X-Y Resolver) */
#define C_ADC_IO5           (C_ADC_CH22 | (uint16_t)C_ADC_REF_2_50_V)           /*!< 22  2.5V  IO[5] (X-Y Resolver) */
#define C_ADC_IO6           (C_ADC_CH23 | (uint16_t)C_ADC_REF_2_50_V)           /*!< 23  2.5V  IO[6] (X-Y Resolver) */
#define C_ADC_IO7           (C_ADC_CH24 | (uint16_t)C_ADC_REF_2_50_V)           /*!< 24  2.5V  IO[7] (X-Y Resolver) */
#define C_ADC_LIN           (C_ADC_CH25 | (uint16_t)C_ADC_REF_2_50_V)           /*!< 25  2.5V  LIN */
#endif /* _OLD */

#define C_ADC_SBASE_MSW                         0x0000U                         /*!< SBASE MSW */
...
extern volatile uint16_t IO_EEPROM_FLASH_CMD_STS_S __attribute__((nodp, addr(0x0017C)));  /*!< IO_EEPROM_FLASH_CMD_STS_S (System) */
...
/* Block: PORT_LIN_XKEY */
/* ******************** */
extern volatile uint16_t IO_PORT_LIN_XKEY_S __attribute__((nodp, addr(0x001C6)));  /*!< IO_PORT_LIN_XKEY (System) */
...
#define B_PORT_SSCM_CONF_SSCM_CENTERED          (1U << 2)                       /*!< RW: 0: Low; 1: Centred */
...
#if defined (__MLX81332A01__)
#define M_PORT_SPARE_TEST_TEST_SUP              (7U << 5)                       /*!< RW: spare test control bits for supply system */
#elif defined (__MLX81332B01__) || defined (__MLX81332B02__)
#define M_PORT_SPARE_TEST_TST_FLASH_LV0_1       (1U << 7)                       /*!< Value for analogue */
#define M_PORT_SPARE_TEST_TST_HS_SHORT_DET      (3U << 5)                       /*!< Value for analogue */
#endif
...
#define M_PORT_IO_IN_IO_IN_SYNC                 (255U << 0)                     /*!< R: From Schmitt trigger I/O (after resynchro) */
...
#define M_PORT_SUPP_CFG_UV_VDDAF_FILT_SEL       (3U << 1)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-200us filtering */
...
#define M_PORT_IO_OUT_SOFT_IO_OUT_SOFT          (255U << 0)                     /*!< RW: To GPIO glue logic control */
...
#define B_PORT_IO_OUT_EN_IO7_OD_ENABLE          (1U << 9)                       /*!< RW: Open-Drain enable for IO[7] */
#define B_PORT_IO_OUT_EN_IO0_OD_ENABLE          (1U << 8)                       /*!< RW: Open-Drain enable for IO[0] */
#define B_PORT_IO_OUT_EN_IO0_LV_ENABLE          (1U << 7)                       /*!< RW: Low-Voltage enable for IO[0] */
...
#define M_PORT_COMM_CFG_SPI_SS_IN_SEL           (7U << 12)                      /*!< RW: IO selection for SPI_SS_IN */
...
#define M_PORT_COMM_CFG_SPI_SCK_IN_SEL          (7U << 8)                       /*!< RW: IO selection for SPI_SCK_IN */
...
#define M_PORT_COMM_CFG_SPI_MISO_IN_SEL         (7U << 4)                       /*!< RW: IO selection for SPI_MISO_IN */
...
#define M_PORT_COMM_CFG_SPI_MOSI_IN_SEL         (7U << 0)                       /*!< RW: IO selection for SPI_MOSI_IN */
...
#define B_PORT_MISC2_OUT_WU_IO_EN               (1U << 8)                       /*!< RW: Wake up enable for IO0 */
#define M_PORT_MISC2_OUT_AOUT_SUP               (15U << 4)                      /*!< RW: spare control output bits for supply system */
#define M_PORT_MISC2_OUT_ENA_OSD_DRV            (3U << 0)                       /*!< Off-State Diagnostic: Enable Current Source U & T */
#define C_PORT_MISC2_OUT_ENA_OSD_DRV1           (1U << 1)                       /*!< Off-State Diagnostic: Enable Current Source T */
#define C_PORT_MISC2_OUT_ENA_OSD_DRV0           (1U << 0)                       /*!< Off-State Diagnostic: Enable Current Source U */

/* *********************** */
/* Block: PORT_STOPMD_CTRL */
/* *********************** */
extern volatile uint16_t IO_PORT_STOPMD_CTRL_S __attribute__((nodp, addr(0x001F6)));  /*!< IO_PORT_STOPMD_CTRL (System) */
...
/* Block: PORT_LIN_XCFG */
/* ******************** */
extern volatile uint16_t IO_PORT_LIN_XCFG_S __attribute__((nodp, addr(0x001FC)));  /*!< IO_PORT_LIN_XCFG (System) */
...
#if defined (__MLX81332B01__) || defined (__MLX81332B02__)
#define B_PORT_LIN_XCFG_DIS_TX_TIMEOUT          (1U << 14)                      /*!< Disable timeout protection (10-20ms) on LIN_TX output */
...
/* ********************** */
extern volatile uint16_t IO_PORT_CLOCK_CTRL_S __attribute__((nodp, addr(0x00200)));  /*!< IO_PORT_CLOCK_CTRL (System) */
...
#if defined (__MLX81332A01__)
#define B_PORT_LINAA1_LINAA_CDOUTEN             (1U << 11)                      /*!< RW: Switch of the monitor current for LED monitoring or LINAA */
#define B_PORT_LINAA1_LINAA_EN                  (1U << 10)                      /*!< RW: Enable OpAmp of the LINAA amplifier */
#define B_PORT_LINAA1_LINAA_RST2                (1U << 9)                       /*!< RW: Reset second variable gain amplifier */
#define B_PORT_LINAA1_LINAA_RST1                (1U << 8)                       /*!< RW: Reset first amplifier gain = 40 */
#define M_PORT_LINAA1_LINAA_DIV                 (15U << 4)                      /*!< RW: Common mode suppression adjustments bits */
#elif defined (__MLX81332B01__) || defined (__MLX81332B02__)
...
#define M_TRIM2_DRV_TRIM_CP_SLWRT_DRV           (15U << 9)                      /*!< RW: Charge-Pump Slew-rate driver */
...
#define M_PORT_I2C_CONF_I2C_SCL_CLK_SEL         (7U << 9)                       /*!< RW: I2C Clock Selection */
#define C_PORT_I2C_CONF_I2C_SCL_CLK_SEL_IO1     (0U << 9)                       /*!< RW: I2C Clock Selection IO1 */
...
#define C_PORT_I2C_CONF_I2C_SCL_CLK_SEL_IO4     (4U << 9)                       /*!< RW: I2C Clock Selection IO4 */
#define C_PORT_I2C_CONF_I2C_SCL_CLK_SEL_IO5     (5U << 9)                       /*!< RW: I2C Clock Selection IO5 */
#define C_PORT_I2C_CONF_I2C_SCL_CLK_SEL_IO6     (6U << 9)                       /*!< RW: I2C Clock Selection IO6 */
#define C_PORT_I2C_CONF_I2C_SCL_CLK_SEL_IO7     (7U << 9)                       /*!< RW: I2C Clock Selection IO7 */
...
#if defined (__MLX81332B01__) || defined (__MLX81332B02__)
#define B_PORT_MISC_TEST_DIS_TX_TIMEOUT         (1U << 8)                       /*!< RW: Replaced in BB by LIN_XCFG[14] bit for disable timeout protection (10-20ms) on LIN_TX output */
#endif /* __MLX81332B01__ */
...
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO4          (5U << 11)                      /*!< RW: IO4 for PPM input */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO5          (6U << 11)                      /*!< RW: IO5 for PPM input */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO6          (7U << 11)                      /*!< RW: IO6 for PPM input */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO7          (8U << 11)                      /*!< RW: IO7 for PPM input */
...
#define C_PORT_PPM_CTRL_PPM_DAT_IT_NB_1         (0U << 8)                       /*!< RW: Interrupt every 8 pulses (1 Word) */
#define C_PORT_PPM_CTRL_PPM_DAT_IT_NB_2         (1U << 8)                       /*!< RW: Interrupt every 16 pulses (2 Words) */
#define C_PORT_PPM_CTRL_PPM_DAT_IT_NB_4         (2U << 8)                       /*!< RW: Interrupt every 32 pulses (4 Words) */
#define C_PORT_PPM_CTRL_PPM_DAT_IT_NB_8         (3U << 8)                       /*!< RW: Interrupt every 64 pulses (8 Words) */
...
#define C_PORT_PPM_CTRL_PPM_DMA_LEN             (1U << 2)                       /*!< RW: DMA buffer length */
...
#define M_PORT_IO_ENABLE_IO_DISREC              (255U << 8)                     /*!< Disable Receiver */
...
#define M_PORT_IO_ENABLE_IO_ENABLE              (255U << 0)                     /*!< Set the state of the IO interface */
#define B_PORT_IO_ENABLE_IO_ENABLE_7            (1U << 7)                       /*!< Enable IO[7] */
#define B_PORT_IO_ENABLE_IO_ENABLE_6            (1U << 6)                       /*!< Enable IO[6] */
#define B_PORT_IO_ENABLE_IO_ENABLE_5            (1U << 5)                       /*!< Enable IO[5] */
#define B_PORT_IO_ENABLE_IO_ENABLE_4            (1U << 4)                       /*!< Enable IO[4] */
...
/* Block: PORT_IO_CFG1 */
/* ******************* */
extern volatile uint16_t IO_PORT_IO_CFG1 __attribute__((nodp, addr(0x0023C)));  /*!< IO_PORT_IO_CFG1 */
...
/* ********************** */
extern volatile uint16_t IO_PORT_TIMER_CFG1 __attribute__((nodp, addr(0x0023E)));  /*!< IO_PORT_TIMER_CFG1 */
...
/* **************************** */
extern volatile uint16_t IO_PORT_IO_TRIG_EDGE_CFG __attribute__((nodp, addr(0x00240)));  /*!< IO_PORT_IO_TRIG_EDGE_CFG */
...
/* ********************* */
extern volatile uint16_t IO_PORT_COMM_CFG1 __attribute__((nodp, addr(0x00242)));  /*!< IO_PORT_COMM_CFG1 */
#define M_PORT_COMM_CFG1_UART_RX_SEL            (7U << 0)                       /*!< RW: IO selection for UART RX */
...
/* Block: PORT_UDMA_RDA */
/* ******************** */
extern volatile uint16_t IO_PORT_UDMA_RDA __attribute__((nodp, addr(0x00244)));  /*!< IO_PORT_UDMA_RDA */
#define M_PORT_UDMA_RDA_UDMA_RDA                (65535U << 0)                   /*!< RW: Receive Buffer A address */

/* ******************** */
/* Block: PORT_UDMA_RDB */
/* ******************** */
extern volatile uint16_t IO_PORT_UDMA_RDB __attribute__((nodp, addr(0x00246)));  /*!< IO_PORT_UDMA_RDB */
#define M_PORT_UDMA_RDB_UDMA_RDB                (65535U << 0)                   /*!< RW: Receive Buffer B address */

/* ******************* */
/* Block: PORT_UDMA_TX */
/* ******************* */
extern volatile uint16_t IO_PORT_UDMA_TX __attribute__((nodp, addr(0x00248)));  /*!< IO_PORT_UDMA_TX */
#define M_PORT_UDMA_TX_UDMA_TX                  (65535U << 0)                   /*!< RW: Transmit Buffer address */

/* ********************* */
/* Block: PORT_UDMA_SIZE */
/* ********************* */
extern volatile uint16_t IO_PORT_UDMA_SIZE __attribute__((nodp, addr(0x0024A)));  /*!< IO_PORT_UDMA_SIZE */
#define M_PORT_UDMA_SIZE_UDMA_SIZTX             (255U << 8)                     /*!< RW: Length transmit buffer in Bytes */
#define M_PORT_UDMA_SIZE_UDMA_SIZRX             (255U << 0)                     /*!< RW: length of receive buffer 'A' and 'B' in Bytes */

/* ********************* */
/* Block: PORT_UDMA_CTRL */
/* ********************* */
extern volatile uint16_t IO_PORT_UDMA_CTRL __attribute__((nodp, addr(0x0024C)));  /*!< IO_PORT_IO_TRIG_EDGE_CFG */
#define B_PORT_UDMA_CTRL_UART_STOP_MODE         (1U << 4)                       /*!< RW: Relaxed UART stop bit sampling is active when =1 (rising edge is allowed anywhere in the bit time) */
#define B_PORT_UDMA_CTRL_UDMA_LOWBYTE_FIRST     (1U << 3)                       /*!< RW: Data is sent/received high byte first (0), or low byte first (1) */
#define B_PORT_UDMA_CTRL_UDMA_LSB_FIRST         (1U << 2)                       /*!< RW: Data is sent/received most significant bit (MSB) first (0) or least significant bit (LSB) first (1) */
#define B_PORT_UDMA_CTRL_UDMA_TXSTART           (1U << 1)                       /*!< RW: A rising edge will begin the transmission of current buffer; The bit needed to be cleared by software prior to the next frame transfer. Clearing the bit during transmission will abort after the current byte has been sent. */
#define B_PORT_UDMA_CTRL_UDMA_EN                (1U << 0)                       /*!< RW: Block is disabled (0) or enabled (1) */

/* *********** */
/* Block: UART */
/* *********** */
extern volatile uint16_t IO_UART_BRRD __attribute__((nodp, addr(0x0024E)));     /*!< IO_UART_BRRD */
#define M_UART_BRRD                             (65535U << 0)                   /*!< RW: Baud rate register data */

extern volatile uint16_t IO_UART_TRD __attribute__((nodp, addr(0x00250)));      /*!< IO_UART_TRD */
#define M_UART_TRD                              (65535U << 0)                   /*!< RW: Transmit register data */

extern volatile uint16_t IO_UART_RRD __attribute__((nodp, addr(0x00252)));      /*!< IO_UART_RRD */
#define M_UART_RRD                              (65535U << 0)                   /*!< R: Receive register data */

extern volatile uint16_t IO_UART_LF __attribute__((nodp, addr(0x00254)));       /*!< IO_UART_LF */
#define M_UART_LFDD                             (255U << 8)                     /*!< RW: LIN frame duration data */
#define M_UART_LFCD                             (255U << 0)                     /*!< R: LIN frame bit counter data */

extern volatile uint16_t IO_UART_TRE __attribute__((nodp, addr(0x00256)));      /*!< IO_UART_TRE */
#define B_UART_LDC                              (1U << 15)                      /*!< RW: LIN duration control */
#define B_UART_LSC                              (1U << 14)                      /*!< RW: LIN start bit control Double buffer mechanism */
#define B_UART_LBC                              (1U << 13)                      /*!< RW: LIN bit control Double buffer mechanism */
#define M_UART_BSC                              (3U << 11)                      /*!< RW: Bit scrambler control */
#define C_UART_BSC_00                           (0U << 11)                      /*!<     Transmit default setting is NRZ, LSBit first */
#define C_UART_BSC_01                           (1U << 11)                      /*!<     Transmit default setting is NRZ, MSBit first */
#define M_UART_MLS                              (7U << 8)                       /*!< RW: Message length selector Double buffer mechanism */
#define C_UART_MLS_8N1                          (1U << 8)                       /*!<     Message length for 8N1 format (8+2 bits) */
#define B_UART_LTE                              (1U << 7)                       /*!< R: LIN time out error Set to 0 if TRE is asserted low Read and clear bit */
#define B_UART_LSE                              (1U << 6)                       /*!< R: LIN start error Set to 0 if TRE is asserted low Read and clear bit */
#define B_UART_LBE                              (1U << 5)                       /*!< R: LIN bit error Set to 0 if TRE is asserted low Read and clear bit */
#define B_UART_ISB                              (1U << 3)                       /*!< RW: Transmit IDLE state */
#define B_UART_REE                              (1U << 2)                       /*!< RW: Receiver enable */
#define B_UART_TRE                              (1U << 1)                       /*!< RW: Transmitter enable */

extern volatile uint16_t IO_UART_STS __attribute__((nodp, addr(0x00258)));     /*!< IO_UART_STS */
#define B_UART_SBE                              (1U << 15)                      /*!< R: Stop bit error Set to 0 if REE is asserted low Read and clear bit */
#define B_UART_NBR                              (1U << 14)                      /*!< R: Noisy bit reception Set to 0 if REE is asserted low Read and clear bit */
#define B_UART_RRF                              (1U << 13)                      /*!< R: Receive register full Set to 0 if REE is asserted low */
#define B_UART_RSB                              (1U << 12)                      /*!< R: Receive shifter busy Set to 0 if REE is asserted low */
#define B_UART_RSO                              (1U << 11)                      /*!< R: Receive shifter overrun Set to 0 if REE is asserted low Read and clear bit */
#define B_UART_TSB                              (1U << 10)                      /*!< R: Transmit shifter busyIn LIN mode, bit set to 0 if LSE = 1 or LBE = 1 Set to 0 if TRE is asserted low */
#define B_UART_TRB                              (1U << 9)                       /*!< R: Transmit register busy In LIN mode, bit set to 0 if read UCTRL Set to 0 if TRE is asserted low */
#define B_UART_TRO                              (1U << 8)                       /*!< R: Transmit register overrun In LIN mode, bit set to 0 if read UCTRL Set to 0 if TRE is asserted low Read and clear bit */

/* *********************** */
/* Block: PORT_UDMA_STATUS */
/* *********************** */
extern volatile uint16_t IO_PORT_UDMA_STATUS __attribute__((nodp, addr(0x0025A)));  /*!< IO_PORT_UDMA_STATUS */
#define B_PORT_UDMA_STATUS_CUSTOM_UART_DMA_ERR  (1U << 3)                       /*!< R: DMA error occurred during RAM buffer access */
#define B_PORT_UDMA_STATUS_UDMA_FTR             (1U << 2)                       /*!< R: Frame transmit ready (cleared at begin of transmission and set (1) after end of frame */
#define B_PORT_UDMA_STATUS_UDMA_FRC             (1U << 1)                       /*!< R: Frame received */
#define B_PORT_UDMA_STATUS_UDMA_RD_BUFFER_VALID (1U << 0)                       /*!< R: Read buffer 'A' is valid (1) or Read buffer 'B' is valid (0) */

/* ********************** */
/* Block: PORT_TX_TIMEOUT */
/* ********************** */
extern volatile uint16_t IO_PORT_TX_TIMEOUT __attribute__((nodp, addr(0x0025C)));  /*!< IO_PORT_TX_TIMEOUT */
#define B_PORT_TX_TIMEOUT_TX_TIMEOUT            (1U << 0)                       /*!< R: Value for digital read */

#endif /* defined (__MLX81332B01__) || defined (__MLX81332B02__) */
