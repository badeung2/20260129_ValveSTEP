/*!*************************************************************************** *
 * \file        mem_map_MLX81340.h
 * \brief       MLX81340 Memory-map
 *
...
#ifndef MEM_MAP_MLX81340_H
#define MEM_MAP_MLX81340_H
...
/*#define C_FLASH_START_ADDR        (uint16_t)(0x8800UL >> 1)*/                 /*!< Flash start address (after 2kB Bootloader) */
/*#define C_FLASH_START_ADDR        (uint16_t)(0x9000UL >> 1)*/                 /*!< Flash start address (after 4kB Bootloader) */
#define C_FLASH_START_ADDR          (uint16_t)(0x8000UL >> 1)                   /*!< Flash start address (No bootloader) */
...
#define C_ADDR_IO_END               0x02A6U                                     /*!< End-address I/O (included) */
