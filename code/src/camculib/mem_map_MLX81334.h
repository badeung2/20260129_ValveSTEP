/*!*************************************************************************** *
 * \file        mem_map_MLX81334.h
 * \brief       MLX81334 Memory-map
 *
...
#define C_RAM_MLX16_END_ADDR        0x01FFFUL                                   /*!< MLX16 RAM End-address */
...
#define C_FLASH_START_ADDR          (uint16_t)(FLASH_BIST_START >> 1)           /*!< Flash start address */
#define C_FLASH_CRC_ADDR            (uint16_t)(0x157FCUL >> 1)                  /*!< Flash CRC address */
#define C_FLASH_STOP_ADDR           (uint16_t)(0x15800UL >> 1)                  /*!< Flash end address */
...
#define C_ROM_MLX4_BIST_CRC         0x00CBB7ECUL                                /*!< MLX4 ROM BIST Checksum (V4.1.0.4) */
...
typedef struct
{
    ...
    uint16_t u8APP_TRIM32_TRIM3_DRV_HIGH    : 8;                                /**< 0x40: TRIM3_DRV - High Current level (dual phase parallel) (MMP130312-1) */
    uint16_t u8APP_TRIM32_TRIM3_DRV_LOW     : 8;                                /**< 0x41: TRIM3_DRV - Low Current level (single phase) (MMP130312-1) */
