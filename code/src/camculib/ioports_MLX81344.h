/*!*************************************************************************** *
 * \file        ioports_MLX81344.h
 * \brief       MLX81344A I/O-ports-map
 *
...
#ifndef __MLX81344A01__
#ifndef __MLX81344B01__
#error "Wrong ioports.h file"
#endif /* __MLX81344B01__ */
#endif /* __MLX81344A01__ */
...
#if defined __MLX81344A01__
#define M_MLX16_ITC_PEND5                       (1U << 0)                       /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#define B_MLX16_ITC_PEND5_MLX16_SOFT            (1U << 0)                       /*!< 0x02B0 */
#else /* defined __MLX81344B01__ */
...
#if defined __MLX81344A01__
#define M_MLX16_ITC_MASK5                       (1U << 0)                       /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#define B_MLX16_ITC_MASK5_MLX16_SOFT            (1U << 0)                       /*!< 0x02B0 */
#else  /* defined __MLX81344B01__ */
...
#if defined __MLX81344A01__
#define M_MLX16_ITC_PRIO7                       (63U << 0)                      /*!< RW: Configure priority for interrupt[INT0_COUNT+INT1_COUNT+INT2_COUNT+31:INT0_COUNT+INT1_COUNT+INT2_COUNT+24] */
#else /* defined __MLX81344B01__ */
...
#define B_PORT_LIN_TEST_DIS_TX_TIMEOUT          (1U << 1)                       /*!< RW: disable timeout protection (10-20ms) on TX output */
...
#define M_PORT_IO_ENABLE_IO_DISREC              (255U << 8)                     /*!< RW: Disable Receiver */
...
#define C_PORT_MISC2_OUT_VDSMON_VTH_SEL_00      (0U << 4)                       /*!< RW: VDS Monitor threshold selection: 0.5V */
#define C_PORT_MISC2_OUT_VDSMON_VTH_SEL_01      (1U << 4)                       /*!< RW: VDS Monitor threshold selection: 1.0V */
#define C_PORT_MISC2_OUT_VDSMON_VTH_SEL_10      (2U << 4)                       /*!< RW: VDS Monitor threshold selection: 1.5V */
#define C_PORT_MISC2_OUT_VDSMON_VTH_SEL_11      (3U << 4)                       /*!< RW: VDS Monitor threshold selection: 2.0V */
#else  /* defined __MLX81344B01__ */
...
/* ********************* */
extern volatile uint16_t IO_PORT_DRV2_PROT __attribute__((nodp, addr(0x0023C)));  /*!< IO_PORT_DRV2_PROT */
#define M_PORT_DRV2_PROT_FREEZE_HS              (7U << 5)                       /*!< RW: Freeze High Side */
#define M_PORT_DRV2_PROT_FREEZE_LS              (7U << 2)                       /*!< RW: Freeze Low Side */
...
#if defined __MLX81344A01__
#define M_PORT_I2C_CONF_I2C_SCL_CLK_SEL         (7U << 9)                       /*!< RW: Value for analogue */
#else  /* defined __MLX81344A01__ */
...
#define M_PORT_MISC2_TEST_VDDD_MONITOR_TEST     (3U << 5)                       /*!< RW: VDDD Monitor test*/
#endif /* defined __MLX81344B01__ */
...
#define M_PORT_UDMA1_SIZE_UDMA1_SIZTX           (255U << 8)                     /*!< RW: Value for analogue */
#define M_PORT_UDMA1_SIZE_UDMA1_SIZRX           (255U << 0)                     /*!< RW: Value for analogue */
...
#if defined __MLX81344B01__
#define B_PORT_CURR_SENS_CSA_BYPASS             (1U << 13)                      /*!< RW: bypasses the current sense amplifier and gives effectively gain 1 at the ADC */
#define B_PORT_CURR_SENS_CSA_CHOP               (1U << 12)                      /*!< RW: exchanges the IS_N and IS_P inputs at the current sensor amplifier for offset measurement */
