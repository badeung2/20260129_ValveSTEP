/*!*************************************************************************** *
 * \file        ioports_MLX81346.h
 * \brief       MLX81346A I/O-ports-map
 *
...
#ifndef __MLX81346A01__
#ifndef __MLX81346B01__
#error "Wrong ioports.h file"
#endif /* __MLX81346B01__ */
#endif /* __MLX81346A01__ */
...
#define B_TRIM_ADC_LOCK                         (1U << 15)                      /*!< RW: Lock the port. Write is invalid when set */
...
/* Block: MLX16 */
/* ************ */
extern volatile uint16_t IO_MLX16_DBG_DATA0 __attribute__((io, addr(0x38)));    /*!< IO_MLX16_DBG_DATA0 */
...
extern volatile uint16_t IO_MLX16_DBG_DATA1 __attribute__((io, addr(0x3A)));    /*!< IO_MLX16_DBG_DATA1 */
...
extern volatile uint16_t IO_MLX16_DBG_DATA2 __attribute__((io, addr(0x3C)));    /*!< IO_MLX16_DBG_DATA2 */
...
extern volatile uint16_t IO_MLX16_DBG_DATA3 __attribute__((io, addr(0x3E)));    /*!< IO_MLX16_DBG_DATA3 */
...
#define B_MLX16_ITC_PEND0_EE_SH_ECC             B_MLX16_ITC_PEND0_EE_ECC        /*!< Compatible name MLX8133x */
#define B_MLX16_ITC_PEND0_UV_VDDA               (1U << 6)                       /*!< 0x0060 */
#define B_MLX16_ITC_PEND0_UV_VSM                (1U << 7)                       /*!< 0x0068 */
#define B_MLX16_ITC_PEND0_UV_BOOST              (1U << 8)                       /*!< 0x0070 */
...
#define B_MLX16_ITC_PEND0_OC_VDDA               (1U << 12)                      /*!< 0x0090 */
#define B_MLX16_ITC_PEND0_OV_HS_IO3             (1U << 13)                      /*!< 0x0098 OV IO3 High-Side */
#define B_MLX16_ITC_PEND0_OV_HS_IO4             (1U << 14)                      /*!< 0x00A0 OV IO4 High-Side */
#define B_MLX16_ITC_PEND0_OV_HS_VDS0            (1U << 15)                      /*!< 0x00A8 OV VDS Phase U High-side */
...
#define B_MLX16_ITC_PEND1_OV_HS_VDS1            (1U << 0)                       /*!< 0x00B0 OV VDS Phase V High-side */
#define B_MLX16_ITC_PEND1_OV_HS_VDS2            (1U << 1)                       /*!< 0x00B8 OV VDS Phase W High-side */
#define B_MLX16_ITC_PEND1_OV_LS_VDS0            (1U << 2)                       /*!< 0x00C0 OV VDS Phase U Low-side */
#define B_MLX16_ITC_PEND1_OV_LS_VDS1            (1U << 3)                       /*!< 0x00C8 OV VDS Phase V Low-side */
#define B_MLX16_ITC_PEND1_OV_LS_VDS2            (1U << 4)                       /*!< 0x00D0 OV VDS Phase W Low-side */
#define B_MLX16_ITC_PEND1_STIMER                (1U << 5)                       /*!< 0x00D8 */
#define B_MLX16_ITC_PEND1_CTIMER0_1             (1U << 6)                       /*!< 0x00E0 */
#define B_MLX16_ITC_PEND1_CTIMER0_2             (1U << 7)                       /*!< 0x00E8 */
#define B_MLX16_ITC_PEND1_CTIMER0_3             (1U << 8)                       /*!< 0x00F0 */
#define B_MLX16_ITC_PEND1_CTIMER1_1             (1U << 9)                       /*!< 0x00F8 */
#define B_MLX16_ITC_PEND1_CTIMER1_2             (1U << 10)                      /*!< 0x0100 */
#define B_MLX16_ITC_PEND1_CTIMER1_3             (1U << 11)                      /*!< 0x0108 */
#define B_MLX16_ITC_PEND1_SPI_TE                (1U << 12)                      /*!< 0x0110 */
#define B_MLX16_ITC_PEND1_SPI_RF                (1U << 13)                      /*!< 0x0118 */
#define B_MLX16_ITC_PEND1_SPI_ER                (1U << 14)                      /*!< 0x0120 */
#define B_MLX16_ITC_PEND1_PWM_MASTER1_CMP       (1U << 15)                      /*!< 0x0128 */
...
#define B_MLX16_ITC_PEND2_PWM_MASTER1_END       (1U << 0)                       /*!< 0x0130 */
#define B_MLX16_ITC_PEND2_PWM_SLAVE1_CMP        (1U << 1)                       /*!< 0x0138 */
#define B_MLX16_ITC_PEND2_PWM_SLAVE2_CMP        (1U << 2)                       /*!< 0x0140 */
#define B_MLX16_ITC_PEND2_PWM_SLAVE3_CMP        (1U << 3)                       /*!< 0x0148 */
#define B_MLX16_ITC_PEND2_PWM_MASTER2_CMP       (1U << 4)                       /*!< 0x0150 */
#define B_MLX16_ITC_PEND2_PWM_MASTER2_END       (1U << 5)                       /*!< 0x0158 */
#define B_MLX16_ITC_PEND2_ADC_BLOCK             (1U << 6)                       /*!< 0x0160 */
#define B_MLX16_ITC_PEND2_EE_COMPLETE           (1U << 7)                       /*!< 0x0168 */
#define B_MLX16_ITC_PEND2_FL_COMPLETE           (1U << 8)                       /*!< 0x0170 */
#define B_MLX16_ITC_PEND2_COLIN_OWNMTX          (1U << 9)                       /*!< 0x0178 */
#define B_MLX16_ITC_PEND2_COLIN_LIN             (1U << 10)                      /*!< 0x0180 */
...
#define B_MLX16_ITC_PEND3_OV_VSM                (1U << 0)                       /*!< 0x01B0 */
#define B_MLX16_ITC_PEND3_OV_VDDA               (1U << 1)                       /*!< 0x01B8 */
#define B_MLX16_ITC_PEND3_OV_BOOST              (1U << 2)                       /*!< 0x01C0 */
#define B_MLX16_ITC_PEND3_IO_IN0                (1U << 3)                       /*!< 0x01C8 */
#define B_MLX16_ITC_PEND3_IO_IN1                (1U << 4)                       /*!< 0x01D0 */
#define B_MLX16_ITC_PEND3_IO_IN2                (1U << 5)                       /*!< 0x01D8 */
#define B_MLX16_ITC_PEND3_IO_IN3                (1U << 6)                       /*!< 0x01E0 */
#define B_MLX16_ITC_PEND3_IO_IN4                (1U << 7)                       /*!< 0x01E8 */
#define B_MLX16_ITC_PEND3_IO_IN5                (1U << 8)                       /*!< 0x01F0 */
#define B_MLX16_ITC_PEND3_IO_IN6                (1U << 9)                       /*!< 0x01F8 */
#define B_MLX16_ITC_PEND3_IO_IN7                (1U << 10)                      /*!< 0x0200 */
#define B_MLX16_ITC_PEND3_IO_IN8                (1U << 11)                      /*!< 0x0208 */
#define B_MLX16_ITC_PEND3_IO_IN9                (1U << 12)                      /*!< 0x0210 */
#define B_MLX16_ITC_PEND3_IO_IN10               (1U << 13)                      /*!< 0x0218 */
#define B_MLX16_ITC_PEND3_IO_IN11               (1U << 14)                      /*!< 0x0220 */
#define B_MLX16_ITC_PEND3_TX_TIMEOUT            (1U << 15)                      /*!< 0x0228 */

extern volatile uint16_t IO_MLX16_ITC_PEND4_S __attribute__((nodp, addr(0x00058)));  /*!< IO_MLX16_ITC_PEND4_S (System) */
#define M_MLX16_ITC_PEND4                       (65535U << 0)                   /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#define B_MLX16_ITC_PEND4_UART0_SB              (1U << 0)                       /*!< 0x0230 UART #0 Stop Bit Error */
#define B_MLX16_ITC_PEND4_UART0_RS              (1U << 1)                       /*!< 0x0238 UART #0 Receive Error */
#define B_MLX16_ITC_PEND4_UART0_RR              (1U << 2)                       /*!< 0x0240 UART #0 Receive */
#define B_MLX16_ITC_PEND4_UART0_TS              (1U << 3)                       /*!< 0x0248 UART #0 Transmit End */
#define B_MLX16_ITC_PEND4_UART0_TR              (1U << 4)                       /*!< 0x0250 UART #0 Transmit Begin */
#define B_MLX16_ITC_PEND4_UART0_TE              (1U << 5)                       /*!< 0x0258 UART #0 Transmit Error */
#define B_MLX16_ITC_PEND4_UDFR0                 (1U << 6)                       /*!< 0x0260 UART #0 DMA Frame Received */
#define B_MLX16_ITC_PEND4_UDFT0                 (1U << 7)                       /*!< 0x0268 UART #0 DMA Frame Transmitted */
#define B_MLX16_ITC_PEND4_UART1_SB              (1U << 8)                       /*!< 0x0270 UART #1 Stop Bit Error */
#define B_MLX16_ITC_PEND4_UART1_RS              (1U << 9)                       /*!< 0x0278 UART #1 Receive Error */
#define B_MLX16_ITC_PEND4_UART1_RR              (1U << 10)                      /*!< 0x0280 UART #1 Receive */
#define B_MLX16_ITC_PEND4_UART1_TS              (1U << 11)                      /*!< 0x0288 UART #1 Transmit End */
#define B_MLX16_ITC_PEND4_UART1_TR              (1U << 12)                      /*!< 0x0290 UART #1 Transmit Begin */
#define B_MLX16_ITC_PEND4_UART1_TE              (1U << 13)                      /*!< 0x0298 UART #1 Transmit Error */
#define B_MLX16_ITC_PEND4_UDFR1                 (1U << 14)                      /*!< 0x02A0 UART #1 DMA Frame Received */
#define B_MLX16_ITC_PEND4_UDFT1                 (1U << 15)                      /*!< 0x02A8 UART #1 DMA Frame Transmitted */
...
#define M_MLX16_ITC_PEND5                       (15U << 0)                      /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#else  /* defined __MLX81346A01__ */
#define M_MLX16_ITC_PEND5                       (31U << 0)                      /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#endif /* defined __MLX81346A01__ */
#define B_MLX16_ITC_PEND5_ACTIVE_CDI            (1U << 0)                       /*!< 0x02B0 */
#define B_MLX16_ITC_PEND5_I2C_EOW               (1U << 1)                       /*!< 0x02B8 */
#define B_MLX16_ITC_PEND5_I2C_EOR               (1U << 2)                       /*!< 0x02C0 */
#if defined __MLX81346A01__
#define B_MLX16_ITC_PEND5_MLX16_SOFT            (1U << 3)                       /*!< 0x02C8 */
#else  /* defined __MLX81346A01__ */
#define B_MLX16_ITC_PEND5_I2C_ERR               (1U << 3)                       /*!< 0x02C8 */
#define B_MLX16_ITC_PEND5_MLX16_SOFT            (1U << 4)                       /*!< 0x02D0 */
#endif /* defined __MLX81346A01__ */
...
#define B_MLX16_ITC_MASK0_UV_BOOST              (1U << 8)                       /*!< 0x0070 */
...
#define B_MLX16_ITC_MASK0_OC_VDDA               (1U << 12)                      /*!< 0x0090 */
#define B_MLX16_ITC_MASK0_OV_HS_IO3             (1U << 13)                      /*!< 0x0098 */
#define B_MLX16_ITC_MASK0_OV_HS_IO4             (1U << 14)                      /*!< 0x00A0 */
#define B_MLX16_ITC_MASK0_OV_HS_VDS0            (1U << 15)                      /*!< 0x00A8 */
...
#define B_MLX16_ITC_MASK1_OV_HS_VDS1            (1U << 0)                       /*!< 0x00B0 */
#define B_MLX16_ITC_MASK1_OV_HS_VDS2            (1U << 1)                       /*!< 0x00B8 */
#define B_MLX16_ITC_MASK1_OV_LS_VDS0            (1U << 2)                       /*!< 0x00C0 */
#define B_MLX16_ITC_MASK1_OV_LS_VDS1            (1U << 3)                       /*!< 0x00C8 */
#define B_MLX16_ITC_MASK1_OV_LS_VDS2            (1U << 4)                       /*!< 0x00D0 */
#define B_MLX16_ITC_MASK1_STIMER                (1U << 5)                       /*!< 0x00D8 */
#define B_MLX16_ITC_MASK1_CTIMER0_1             (1U << 6)                       /*!< 0x00E0 */
#define B_MLX16_ITC_MASK1_CTIMER0_2             (1U << 7)                       /*!< 0x00E8 */
#define B_MLX16_ITC_MASK1_CTIMER0_3             (1U << 8)                       /*!< 0x00F0 */
#define B_MLX16_ITC_MASK1_CTIMER1_1             (1U << 9)                       /*!< 0x00F8 */
#define B_MLX16_ITC_MASK1_CTIMER1_2             (1U << 10)                      /*!< 0x0100 */
#define B_MLX16_ITC_MASK1_CTIMER1_3             (1U << 11)                      /*!< 0x0108 */
#define B_MLX16_ITC_MASK1_SPI_TE                (1U << 12)                      /*!< 0x0110 */
#define B_MLX16_ITC_MASK1_SPI_RF                (1U << 13)                      /*!< 0x0118 */
#define B_MLX16_ITC_MASK1_SPI_ER                (1U << 14)                      /*!< 0x0120 */
#define B_MLX16_ITC_MASK1_PWM_MASTER1_CMP       (1U << 15)                      /*!< 0x0128 */
...
#define B_MLX16_ITC_MASK2_PWM_MASTER1_END       (1U << 0)                       /*!< 0x0130 */
#define B_MLX16_ITC_MASK2_PWM_SLAVE1_CMP        (1U << 1)                       /*!< 0x0138 */
#define B_MLX16_ITC_MASK2_PWM_SLAVE2_CMP        (1U << 2)                       /*!< 0x0140 */
#define B_MLX16_ITC_MASK2_PWM_SLAVE3_CMP        (1U << 3)                       /*!< 0x0148 */
#define B_MLX16_ITC_MASK2_PWM_MASTER2_CMP       (1U << 4)                       /*!< 0x0150 */
#define B_MLX16_ITC_MASK2_PWM_MASTER2_END       (1U << 5)                       /*!< 0x0158 */
#define B_MLX16_ITC_MASK2_ADC_BLOCK             (1U << 6)                       /*!< 0x0160 */
#define B_MLX16_ITC_MASK2_EE_COMPLETE           (1U << 7)                       /*!< 0x0168 */
#define B_MLX16_ITC_MASK2_FL_COMPLETE           (1U << 8)                       /*!< 0x0170 */
#define B_MLX16_ITC_MASK2_COLIN_OWNMTX          (1U << 9)                       /*!< 0x0178 */
#define B_MLX16_ITC_MASK2_COLIN_LIN             (1U << 10)                      /*!< 0x0180 */
...
#define B_MLX16_ITC_MASK3_OV_VSM                (1U << 0)                       /*!< 0x01B0 */
#define B_MLX16_ITC_MASK3_OV_VDDA               (1U << 1)                       /*!< 0x01B8 */
#define B_MLX16_ITC_MASK3_OV_BOOST              (1U << 2)                       /*!< 0x01C0 */
#define B_MLX16_ITC_MASK3_IO_IN0                (1U << 3)                       /*!< 0x01C8 */
#define B_MLX16_ITC_MASK3_IO_IN1                (1U << 4)                       /*!< 0x01D0 */
#define B_MLX16_ITC_MASK3_IO_IN2                (1U << 5)                       /*!< 0x01D8 */
#define B_MLX16_ITC_MASK3_IO_IN3                (1U << 6)                       /*!< 0x01E0 */
#define B_MLX16_ITC_MASK3_IO_IN4                (1U << 7)                       /*!< 0x01E8 */
#define B_MLX16_ITC_MASK3_IO_IN5                (1U << 8)                       /*!< 0x01F0 */
#define B_MLX16_ITC_MASK3_IO_IN6                (1U << 9)                       /*!< 0x01F8 */
#define B_MLX16_ITC_MASK3_IO_IN7                (1U << 10)                      /*!< 0x0200 */
#define B_MLX16_ITC_MASK3_IO_IN8                (1U << 11)                      /*!< 0x0208 */
#define B_MLX16_ITC_MASK3_IO_IN9                (1U << 12)                      /*!< 0x0210 */
#define B_MLX16_ITC_MASK3_IO_IN10               (1U << 13)                      /*!< 0x0218 */
#define B_MLX16_ITC_MASK3_IO_IN11               (1U << 14)                      /*!< 0x0220 */
#define B_MLX16_ITC_MASK3_TX_TIMEOUT            (1U << 15)                      /*!< 0x0228 */

extern volatile uint16_t IO_MLX16_ITC_MASK4_S __attribute__((nodp, addr(0x00074)));  /*!< IO_MLX16_ITC_MASK4_S (System) */
#define M_MLX16_ITC_MASK4                       (65535U << 0)                   /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#define B_MLX16_ITC_MASK4_UART0_SB              (1U << 0)                       /*!< 0x0230 UART #0 Stop Bit Error */
#define B_MLX16_ITC_MASK4_UART0_RS              (1U << 1)                       /*!< 0x0238 UART #0 Receive Error */
#define B_MLX16_ITC_MASK4_UART0_RR              (1U << 2)                       /*!< 0x0240 UART #0 Receive */
#define B_MLX16_ITC_MASK4_UART0_TS              (1U << 3)                       /*!< 0x0248 UART #0 Transmit End */
#define B_MLX16_ITC_MASK4_UART0_TR              (1U << 4)                       /*!< 0x0250 UART #0 Transmit Begin */
#define B_MLX16_ITC_MASK4_UART0_TE              (1U << 5)                       /*!< 0x0258 UART #0 Transmit Error */
#define B_MLX16_ITC_MASK4_UDFR0                 (1U << 6)                       /*!< 0x0260 UART #0 DMA Frame Received */
#define B_MLX16_ITC_MASK4_UDFT0                 (1U << 7)                       /*!< 0x0268 UART #0 DMA Frame Transmitted */
#define B_MLX16_ITC_MASK4_UART1_SB              (1U << 8)                       /*!< 0x0270 UART #1 Stop Bit Error */
#define B_MLX16_ITC_MASK4_UART1_RS              (1U << 9)                       /*!< 0x0278 UART #1 Receive Error */
#define B_MLX16_ITC_MASK4_UART1_RR              (1U << 10)                      /*!< 0x0280 UART #1 Receive */
#define B_MLX16_ITC_MASK4_UART1_TS              (1U << 11)                      /*!< 0x0288 UART #1 Transmit End */
#define B_MLX16_ITC_MASK4_UART1_TR              (1U << 12)                      /*!< 0x0290 UART #1 Transmit Begin */
#define B_MLX16_ITC_MASK4_UART1_TE              (1U << 13)                      /*!< 0x0298 UART #1 Transmit Error */
#define B_MLX16_ITC_MASK4_UDFR1                 (1U << 14)                      /*!< 0x02A0 UART #1 DMA Frame Received */
#define B_MLX16_ITC_MASK4_UDFT1                 (1U << 15)                      /*!< 0x02A8 UART #1 DMA Frame Transmitted */

extern volatile uint16_t IO_MLX16_ITC_MASK5_S __attribute__((nodp, addr(0x00076)));  /*!< IO_MLX16_ITC_MASK5_S (System) */
#if defined __MLX81346A01__
#define M_MLX16_ITC_MASK5                       (15U << 0)                      /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#else  /* defined __MLX81346A01__ */
#define M_MLX16_ITC_MASK5                       (31U << 0)                      /*!< R: 1 If the interrupt[INT0_COUNT+63:INT0_COUNT+48] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#endif /* defined __MLX81346A01__ */
#define B_MLX16_ITC_MASK5_ACTIVE_CDI            (1U << 0)                       /*!< 0x02B0 */
#define B_MLX16_ITC_MASK5_I2C_EOW               (1U << 1)                       /*!< 0x02B8 */
#define B_MLX16_ITC_MASK5_I2C_EOR               (1U << 2)                       /*!< 0x02C0 */
#if defined __MLX81346A01__
#define B_MLX16_ITC_MASK5_MLX16_SOFT            (1U << 3)                       /*!< 0x02C8 */
#else  /* defined __MLX81346B01__ */
#define B_MLX16_ITC_MASK5_I2C_ERR               (1U << 3)                       /*!< 0x02C8 */
#define B_MLX16_ITC_MASK5_MLX16_SOFT            (1U << 4)                       /*!< 0x02D0 */
...
#define M_MLX16_ITC_PRIO2_ADC_BLOCK             (3U << 2)                       /*!< RW: priority ADC_SAR */
#define C_MLX16_ITC_PRIO2_ADC_BLOCK_PRIO3       (0U << 2)                       /*!< RW: priority 3 ADC_SAR */
#define C_MLX16_ITC_PRIO2_ADC_BLOCK_PRIO4       (1U << 2)                       /*!< RW: priority 4 ADC_SAR */
#define C_MLX16_ITC_PRIO2_ADC_BLOCK_PRIO5       (2U << 2)                       /*!< RW: priority 5 ADC_SAR */
#define C_MLX16_ITC_PRIO2_ADC_BLOCK_PRIO6       (3U << 2)                       /*!< RW: priority 6 ADC_SAR */
...
#define M_MLX16_ITC_PRIO2_DIAG                  (3U << 12)                      /*!< RW: priority DIAG */
#define C_MLX16_ITC_PRIO2_DIAG_PRIO3            (0U << 12)                      /*!< RW: priority 3 DIAG */
#define C_MLX16_ITC_PRIO2_DIAG_PRIO4            (1U << 12)                      /*!< RW: priority 4 DIAG */
#define C_MLX16_ITC_PRIO2_DIAG_PRIO5            (2U << 12)                      /*!< RW: priority 5 DIAG */
#define C_MLX16_ITC_PRIO2_DIAG_PRIO6            (3U << 12)                      /*!< RW: priority 6 DIAG */
#define M_MLX16_ITC_PRIO2_I2C_GLOBAL_RESET      (3U << 14)                      /*!< RW: priority I2C_GLOBAL_RESET */
#define C_MLX16_ITC_PRIO2_I2C_GLOBAL_RESET_PRIO3 (0U << 14)                     /*!< RW: priority 3 I2C_GLOBAL_RESET */
#define C_MLX16_ITC_PRIO2_I2C_GLOBAL_RESET_PRIO4 (1U << 14)                     /*!< RW: priority 4 I2C_GLOBAL_RESET */
#define C_MLX16_ITC_PRIO2_I2C_GLOBAL_RESET_PRIO5 (2U << 14)                     /*!< RW: priority 5 I2C_GLOBAL_RESET */
#define C_MLX16_ITC_PRIO2_I2C_GLOBAL_RESET_PRIO6 (3U << 14)                     /*!< RW: priority 6 I2C_GLOBAL_RESET */
...
#define M_MLX16_ITC_PRIO3_PPM_RX                (3U << 0)                       /*!< RW: priority PPM_RX */
#define C_MLX16_ITC_PRIO3_PPM_RX_PRIO3          (0U << 0)                       /*!< RW: priority 3 PPM_RX */
#define C_MLX16_ITC_PRIO3_PPM_RX_PRIO4          (1U << 0)                       /*!< RW: priority 4 PPM_RX */
#define C_MLX16_ITC_PRIO3_PPM_RX_PRIO5          (2U << 0)                       /*!< RW: priority 5 PPM_RX */
#define C_MLX16_ITC_PRIO3_PPM_RX_PRIO6          (3U << 0)                       /*!< RW: priority 6 PPM_RX */
#define M_MLX16_ITC_PRIO3_PPM_TX                (3U << 2)                       /*!< RW: priority PPM_TX */
#define C_MLX16_ITC_PRIO3_PPM_TX_PRIO3          (0U << 2)                       /*!< RW: priority 3 PPM_TX */
#define C_MLX16_ITC_PRIO3_PPM_TX_PRIO4          (1U << 2)                       /*!< RW: priority 4 PPM_TX */
#define C_MLX16_ITC_PRIO3_PPM_TX_PRIO5          (2U << 2)                       /*!< RW: priority 5 PPM_TX */
#define C_MLX16_ITC_PRIO3_PPM_TX_PRIO6          (3U << 2)                       /*!< RW: priority 6 PPM_TX */
#define M_MLX16_ITC_PRIO3_PPM_ERR               (3U << 4)                       /*!< RW: priority PPM_ERR */
#define C_MLX16_ITC_PRIO3_PPM_ERR_PRIO3         (0U << 4)                       /*!< RW: priority 3 PPM_ERR */
#define C_MLX16_ITC_PRIO3_PPM_ERR_PRIO4         (1U << 4)                       /*!< RW: priority 4 PPM_ERR */
#define C_MLX16_ITC_PRIO3_PPM_ERR_PRIO5         (2U << 4)                       /*!< RW: priority 5 PPM_ERR */
#define C_MLX16_ITC_PRIO3_PPM_ERR_PRIO6         (3U << 4)                       /*!< RW: priority 6 PPM_ERR */
#define M_MLX16_ITC_PRIO3_OV_VSM                (3U << 6)                       /*!< RW: priority OV_VSM */
#define C_MLX16_ITC_PRIO3_OV_VSM_PRIO3          (0U << 6)                       /*!< RW: priority 3 OV_VSM */
#define C_MLX16_ITC_PRIO3_OV_VSM_PRIO4          (1U << 6)                       /*!< RW: priority 4 OV_VSM */
#define C_MLX16_ITC_PRIO3_OV_VSM_PRIO5          (2U << 6)                       /*!< RW: priority 5 OV_VSM */
#define C_MLX16_ITC_PRIO3_OV_VSM_PRIO6          (3U << 6)                       /*!< RW: priority 6 OV_VSM */
#define M_MLX16_ITC_PRIO3_OV_VDDA               (3U << 8)                       /*!< RW: priority OV_VDDA */
#define C_MLX16_ITC_PRIO3_OV_VDDA_PRIO3         (0U << 8)                       /*!< RW: priority 3 OV_VDDA */
#define C_MLX16_ITC_PRIO3_OV_VDDA_PRIO4         (1U << 8)                       /*!< RW: priority 4 OV_VDDA */
#define C_MLX16_ITC_PRIO3_OV_VDDA_PRIO5         (2U << 8)                       /*!< RW: priority 5 OV_VDDA */
#define C_MLX16_ITC_PRIO3_OV_VDDA_PRIO6         (3U << 8)                       /*!< RW: priority 6 OV_VDDA */
#define M_MLX16_ITC_PRIO3_OV_BOOST              (3U << 10)                      /*!< RW: priority OV_BOOST */
#define C_MLX16_ITC_PRIO3_OV_BOOST_PRIO3        (0U << 10)                      /*!< RW: priority 3 OV_BOOST */
#define C_MLX16_ITC_PRIO3_OV_BOOST_PRIO4        (1U << 10)                      /*!< RW: priority 4 OV_BOOST */
#define C_MLX16_ITC_PRIO3_OV_BOOST_PRIO5        (2U << 10)                      /*!< RW: priority 5 OV_BOOST */
#define C_MLX16_ITC_PRIO3_OV_BOOST_PRIO6        (3U << 10)                      /*!< RW: priority 6 OV_BOOST */
#define M_MLX16_ITC_PRIO3_IO_IN0                (3U << 12)                      /*!< RW: priority IO_IN0 */
#define C_MLX16_ITC_PRIO3_IO_IN0_PRIO3          (0U << 12)                      /*!< RW: priority 3 IO_IN0 */
#define C_MLX16_ITC_PRIO3_IO_IN0_PRIO4          (1U << 12)                      /*!< RW: priority 4 IO_IN0 */
#define C_MLX16_ITC_PRIO3_IO_IN0_PRIO5          (2U << 12)                      /*!< RW: priority 5 IO_IN0 */
#define C_MLX16_ITC_PRIO3_IO_IN0_PRIO6          (3U << 12)                      /*!< RW: priority 6 IO_IN0 */
#define M_MLX16_ITC_PRIO3_IO_IN1                (3U << 14)                      /*!< RW: priority IO_IN1 */
#define C_MLX16_ITC_PRIO3_IO_IN1_PRIO3          (0U << 14)                      /*!< RW: priority 3 IO_IN1 */
#define C_MLX16_ITC_PRIO3_IO_IN1_PRIO4          (1U << 14)                      /*!< RW: priority 4 IO_IN1 */
#define C_MLX16_ITC_PRIO3_IO_IN1_PRIO5          (2U << 14)                      /*!< RW: priority 5 IO_IN1 */
#define C_MLX16_ITC_PRIO3_IO_IN1_PRIO6          (3U << 14)                      /*!< RW: priority 6 IO_IN1 */

extern volatile uint16_t IO_MLX16_ITC_PRIO4_S __attribute__((nodp, addr(0x00090)));  /*!< IO_MLX16_ITC_PRIO4_S (System) */
#define M_MLX16_ITC_PRIO4                       (65535U << 0)                   /*!< RW: Configure priority for interrupt[INT0_COUNT+INT1_COUNT+INT2_COUNT+31:INT0_COUNT+INT1_COUNT+INT2_COUNT+24] */
#define M_MLX16_ITC_PRIO4_IO_IN2                (3U << 0)                       /*!< RW: priority IO_IN2 */
#define C_MLX16_ITC_PRIO4_IO_IN2_PRIO3          (0U << 0)                       /*!< RW: priority 3 IO_IN2 */
#define C_MLX16_ITC_PRIO4_IO_IN2_PRIO4          (1U << 0)                       /*!< RW: priority 4 IO_IN2 */
#define C_MLX16_ITC_PRIO4_IO_IN2_PRIO5          (2U << 0)                       /*!< RW: priority 5 IO_IN2 */
#define C_MLX16_ITC_PRIO4_IO_IN2_PRIO6          (3U << 0)                       /*!< RW: priority 6 IO_IN2 */
#define M_MLX16_ITC_PRIO4_IO_IN3                (3U << 2)                       /*!< RW: priority IO_IN3 */
#define C_MLX16_ITC_PRIO4_IO_IN3_PRIO3          (0U << 2)                       /*!< RW: priority 3 IO_IN3 */
#define C_MLX16_ITC_PRIO4_IO_IN3_PRIO4          (1U << 2)                       /*!< RW: priority 4 IO_IN3 */
#define C_MLX16_ITC_PRIO4_IO_IN3_PRIO5          (2U << 2)                       /*!< RW: priority 5 IO_IN3 */
#define C_MLX16_ITC_PRIO4_IO_IN3_PRIO6          (3U << 2)                       /*!< RW: priority 6 IO_IN3 */
#define M_MLX16_ITC_PRIO4_IO_IN4                (3U << 4)                       /*!< RW: priority IO_IN4 */
#define C_MLX16_ITC_PRIO4_IO_IN4_PRIO3          (0U << 4)                       /*!< RW: priority 3 IO_IN4 */
#define C_MLX16_ITC_PRIO4_IO_IN4_PRIO4          (1U << 4)                       /*!< RW: priority 4 IO_IN4 */
#define C_MLX16_ITC_PRIO4_IO_IN4_PRIO5          (2U << 4)                       /*!< RW: priority 5 IO_IN4 */
#define C_MLX16_ITC_PRIO4_IO_IN4_PRIO6          (3U << 4)                       /*!< RW: priority 6 IO_IN4 */
#define M_MLX16_ITC_PRIO4_IO_IN5                (3U << 6)                       /*!< RW: priority IO_IN5 */
#define C_MLX16_ITC_PRIO4_IO_IN5_PRIO3          (0U << 6)                       /*!< RW: priority 3 IO_IN5 */
#define C_MLX16_ITC_PRIO4_IO_IN5_PRIO4          (1U << 6)                       /*!< RW: priority 4 IO_IN5 */
#define C_MLX16_ITC_PRIO4_IO_IN5_PRIO5          (2U << 6)                       /*!< RW: priority 5 IO_IN5 */
#define C_MLX16_ITC_PRIO4_IO_IN5_PRIO6          (3U << 6)                       /*!< RW: priority 6 IO_IN5 */
#define M_MLX16_ITC_PRIO4_IO_IN6                (3U << 8)                       /*!< RW: priority IO_IN6 */
#define C_MLX16_ITC_PRIO4_IO_IN6_PRIO3          (0U << 8)                       /*!< RW: priority 3 IO_IN6 */
#define C_MLX16_ITC_PRIO4_IO_IN6_PRIO4          (1U << 8)                       /*!< RW: priority 4 IO_IN6 */
#define C_MLX16_ITC_PRIO4_IO_IN6_PRIO5          (2U << 8)                       /*!< RW: priority 5 IO_IN6 */
#define C_MLX16_ITC_PRIO4_IO_IN6_PRIO6          (3U << 8)                       /*!< RW: priority 6 IO_IN6 */
#define M_MLX16_ITC_PRIO4_IO_IN7                (3U << 10)                      /*!< RW: priority IO_IN7 */
#define C_MLX16_ITC_PRIO4_IO_IN7_PRIO3          (0U << 10)                      /*!< RW: priority 3 IO_IN7 */
#define C_MLX16_ITC_PRIO4_IO_IN7_PRIO4          (1U << 10)                      /*!< RW: priority 4 IO_IN7 */
#define C_MLX16_ITC_PRIO4_IO_IN7_PRIO5          (2U << 10)                      /*!< RW: priority 5 IO_IN7 */
#define C_MLX16_ITC_PRIO4_IO_IN7_PRIO6          (3U << 10)                      /*!< RW: priority 6 IO_IN7 */
#define M_MLX16_ITC_PRIO4_IO_IN8                (3U << 12)                      /*!< RW: priority IO_IN8 */
#define C_MLX16_ITC_PRIO4_IO_IN8_PRIO3          (0U << 12)                      /*!< RW: priority 3 IO_IN8 */
#define C_MLX16_ITC_PRIO4_IO_IN8_PRIO4          (1U << 12)                      /*!< RW: priority 4 IO_IN8 */
#define C_MLX16_ITC_PRIO4_IO_IN8_PRIO5          (2U << 12)                      /*!< RW: priority 5 IO_IN8 */
#define C_MLX16_ITC_PRIO4_IO_IN8_PRIO6          (3U << 12)                      /*!< RW: priority 6 IO_IN8 */
#define M_MLX16_ITC_PRIO4_IO_IN9                (3U << 14)                      /*!< RW: priority IO_IN9 */
#define C_MLX16_ITC_PRIO4_IO_IN9_PRIO3          (0U << 14)                      /*!< RW: priority 3 IO_IN9 */
#define C_MLX16_ITC_PRIO4_IO_IN9_PRIO4          (1U << 14)                      /*!< RW: priority 4 IO_IN9 */
#define C_MLX16_ITC_PRIO4_IO_IN9_PRIO5          (2U << 14)                      /*!< RW: priority 5 IO_IN9 */
#define C_MLX16_ITC_PRIO4_IO_IN9_PRIO6          (3U << 14)                      /*!< RW: priority 6 IO_IN9 */
...
#define M_MLX16_ITC_PRIO5_IO_IN10               (3U << 0)                       /*!< RW: priority IO_IN10 */
#define C_MLX16_ITC_PRIO5_IO_IN10_PRIO3         (0U << 0)                       /*!< RW: priority 3 IO_IN10 */
#define C_MLX16_ITC_PRIO5_IO_IN10_PRIO4         (1U << 0)                       /*!< RW: priority 4 IO_IN10 */
#define C_MLX16_ITC_PRIO5_IO_IN10_PRIO5         (2U << 0)                       /*!< RW: priority 5 IO_IN10 */
#define C_MLX16_ITC_PRIO5_IO_IN10_PRIO6         (3U << 0)                       /*!< RW: priority 6 IO_IN10 */
#define M_MLX16_ITC_PRIO5_IO_IN11               (3U << 2)                       /*!< RW: priority IO_IN11 */
#define C_MLX16_ITC_PRIO5_IO_IN11_PRIO3         (0U << 2)                       /*!< RW: priority 3 IO_IN11 */
#define C_MLX16_ITC_PRIO5_IO_IN11_PRIO4         (1U << 2)                       /*!< RW: priority 4 IO_IN11 */
#define C_MLX16_ITC_PRIO5_IO_IN11_PRIO5         (2U << 2)                       /*!< RW: priority 5 IO_IN11 */
#define C_MLX16_ITC_PRIO5_IO_IN11_PRIO6         (3U << 2)                       /*!< RW: priority 6 IO_IN11 */
#define M_MLX16_ITC_PRIO5_TX_TIMEOUT            (3U << 4)                       /*!< RW: priority TX_TIMEOUT */
#define C_MLX16_ITC_PRIO5_TX_TIMEOUT_PRIO3      (0U << 4)                       /*!< RW: priority 3 TX_TIMEOUT */
#define C_MLX16_ITC_PRIO5_TX_TIMEOUT_PRIO4      (1U << 4)                       /*!< RW: priority 4 TX_TIMEOUT */
#define C_MLX16_ITC_PRIO5_TX_TIMEOUT_PRIO5      (2U << 4)                       /*!< RW: priority 5 TX_TIMEOUT */
#define C_MLX16_ITC_PRIO5_TX_TIMEOUT_PRIO6      (3U << 4)                       /*!< RW: priority 6 TX_TIMEOUT */
#define M_MLX16_ITC_PRIO5_UART0_SB              (3U << 6)                       /*!< RW: priority UART0_SB */
#define C_MLX16_ITC_PRIO5_UART0_SB_PRIO3        (0U << 6)                       /*!< RW: priority 3 UART0_SB */
#define C_MLX16_ITC_PRIO5_UART0_SB_PRIO4        (1U << 6)                       /*!< RW: priority 4 UART0_SB */
#define C_MLX16_ITC_PRIO5_UART0_SB_PRIO5        (2U << 6)                       /*!< RW: priority 5 UART0_SB */
#define C_MLX16_ITC_PRIO5_UART0_SB_PRIO6        (3U << 6)                       /*!< RW: priority 6 UART0_SB */
#define M_MLX16_ITC_PRIO5_UART0_RS              (3U << 8)                       /*!< RW: priority UART0_RE */
#define C_MLX16_ITC_PRIO5_UART0_RS_PRIO3        (0U << 8)                       /*!< RW: priority 3 UART0_RE */
#define C_MLX16_ITC_PRIO5_UART0_RS_PRIO4        (1U << 8)                       /*!< RW: priority 4 UART0_RE */
#define C_MLX16_ITC_PRIO5_UART0_RS_PRIO5        (2U << 8)                       /*!< RW: priority 5 UART0_RE */
#define C_MLX16_ITC_PRIO5_UART0_RS_PRIO6        (3U << 8)                       /*!< RW: priority 6 UART0_RE */
#define M_MLX16_ITC_PRIO5_UART0_RR              (3U << 10)                      /*!< RW: priority UART0_RR */
#define C_MLX16_ITC_PRIO5_UART0_RR_PRIO3        (0U << 10)                      /*!< RW: priority 3 UART0_RR */
#define C_MLX16_ITC_PRIO5_UART0_RR_PRIO4        (1U << 10)                      /*!< RW: priority 4 UART0_RR */
#define C_MLX16_ITC_PRIO5_UART0_RR_PRIO5        (2U << 10)                      /*!< RW: priority 5 UART0_RR */
#define C_MLX16_ITC_PRIO5_UART0_RR_PRIO6        (3U << 10)                      /*!< RW: priority 6 UART0_RR */
#define M_MLX16_ITC_PRIO5_UART0_TS              (3U << 12)                      /*!< RW: priority UART0_TS */
#define C_MLX16_ITC_PRIO5_UART0_TS_PRIO3        (0U << 12)                      /*!< RW: priority 3 UART0_TS */
#define C_MLX16_ITC_PRIO5_UART0_TS_PRIO4        (1U << 12)                      /*!< RW: priority 4 UART0_TS */
#define C_MLX16_ITC_PRIO5_UART0_TS_PRIO5        (2U << 12)                      /*!< RW: priority 5 UART0_TS */
#define C_MLX16_ITC_PRIO5_UART0_TS_PRIO6        (3U << 12)                      /*!< RW: priority 6 UART0_TS */
#define M_MLX16_ITC_PRIO5_UART0_TR              (3U << 14)                      /*!< RW: priority UART0_TR */
#define C_MLX16_ITC_PRIO5_UART0_TR_PRIO3        (0U << 14)                      /*!< RW: priority 3 UART0_TR */
#define C_MLX16_ITC_PRIO5_UART0_TR_PRIO4        (1U << 14)                      /*!< RW: priority 4 UART0_TR */
#define C_MLX16_ITC_PRIO5_UART0_TR_PRIO5        (2U << 14)                      /*!< RW: priority 5 UART0_TR */
#define C_MLX16_ITC_PRIO5_UART0_TR_PRIO6        (3U << 14)                      /*!< RW: priority 6 UART0_TR */
...
#define M_MLX16_ITC_PRIO6_UART0_TE              (3U << 0)                       /*!< RW: priority UART0_TE */
#define C_MLX16_ITC_PRIO6_UART0_TE_PRIO3        (0U << 0)                       /*!< RW: priority 3 UART0_TE */
#define C_MLX16_ITC_PRIO6_UART0_TE_PRIO4        (1U << 0)                       /*!< RW: priority 4 UART0_TE */
#define C_MLX16_ITC_PRIO6_UART0_TE_PRIO5        (2U << 0)                       /*!< RW: priority 5 UART0_TE */
#define C_MLX16_ITC_PRIO6_UART0_TE_PRIO6        (3U << 0)                       /*!< RW: priority 6 UART0_TE */
#define M_MLX16_ITC_PRIO6_UDFR0                 (3U << 2)                       /*!< RW: priority UDFR0 */
#define C_MLX16_ITC_PRIO6_UDFR0_PRIO3           (0U << 2)                       /*!< RW: priority 3 UDFR0 */
#define C_MLX16_ITC_PRIO6_UDFR0_PRIO4           (1U << 2)                       /*!< RW: priority 4 UDFR0 */
#define C_MLX16_ITC_PRIO6_UDFR0_PRIO5           (2U << 2)                       /*!< RW: priority 5 UDFR0 */
#define C_MLX16_ITC_PRIO6_UDFR0_PRIO6           (3U << 2)                       /*!< RW: priority 6 UDFR0 */
#define M_MLX16_ITC_PRIO6_UDFT0                 (3U << 4)                       /*!< RW: priority UDRF0 */
#define C_MLX16_ITC_PRIO6_UDFT0_PRIO3           (0U << 4)                       /*!< RW: priority 3 UDRF0 */
#define C_MLX16_ITC_PRIO6_UDFT0_PRIO4           (1U << 4)                       /*!< RW: priority 4 UDRF0 */
#define C_MLX16_ITC_PRIO6_UDFT0_PRIO5           (2U << 4)                       /*!< RW: priority 5 UDRF0 */
#define C_MLX16_ITC_PRIO6_UDFT0_PRIO6           (3U << 4)                       /*!< RW: priority 6 UDRF0 */
#define M_MLX16_ITC_PRIO6_UART1_SB              (3U << 6)                       /*!< RW: priority UART1_SB */
#define C_MLX16_ITC_PRIO6_UART1_SB_PRIO3        (0U << 6)                       /*!< RW: priority 3 UART1_SB */
#define C_MLX16_ITC_PRIO6_UART1_SB_PRIO4        (1U << 6)                       /*!< RW: priority 4 UART1_SB */
#define C_MLX16_ITC_PRIO6_UART1_SB_PRIO5        (2U << 6)                       /*!< RW: priority 5 UART1_SB */
#define C_MLX16_ITC_PRIO6_UART1_SB_PRIO6        (3U << 6)                       /*!< RW: priority 6 UART1_SB */
#define M_MLX16_ITC_PRIO6_UART1_RS              (3U << 8)                       /*!< RW: priority UART1_RE */
#define C_MLX16_ITC_PRIO6_UART1_RS_PRIO3        (0U << 8)                       /*!< RW: priority 3 UART1_RE */
#define C_MLX16_ITC_PRIO6_UART1_RS_PRIO4        (1U << 8)                       /*!< RW: priority 4 UART1_RE */
#define C_MLX16_ITC_PRIO6_UART1_RS_PRIO5        (2U << 8)                       /*!< RW: priority 5 UART1_RE */
#define C_MLX16_ITC_PRIO6_UART1_RS_PRIO6        (3U << 8)                       /*!< RW: priority 6 UART1_RE */
#define M_MLX16_ITC_PRIO6_UART1_RR              (3U << 10)                      /*!< RW: priority UART1_RR */
#define C_MLX16_ITC_PRIO6_UART1_RR_PRIO3        (0U << 10)                      /*!< RW: priority 3 UART1_RR */
#define C_MLX16_ITC_PRIO6_UART1_RR_PRIO4        (1U << 10)                      /*!< RW: priority 4 UART1_RR */
#define C_MLX16_ITC_PRIO6_UART1_RR_PRIO5        (2U << 10)                      /*!< RW: priority 5 UART1_RR */
#define C_MLX16_ITC_PRIO6_UART1_RR_PRIO6        (3U << 10)                      /*!< RW: priority 6 UART1_RR */
#define M_MLX16_ITC_PRIO6_UART1_TS              (3U << 12)                      /*!< RW: priority UART1_TS */
#define C_MLX16_ITC_PRIO6_UART1_TS_PRIO3        (0U << 12)                      /*!< RW: priority 3 UART1_TS */
#define C_MLX16_ITC_PRIO6_UART1_TS_PRIO4        (1U << 12)                      /*!< RW: priority 4 UART1_TS */
#define C_MLX16_ITC_PRIO6_UART1_TS_PRIO5        (2U << 12)                      /*!< RW: priority 5 UART1_TS */
#define C_MLX16_ITC_PRIO6_UART1_TS_PRIO6        (3U << 12)                      /*!< RW: priority 6 UART1_TS */
#define M_MLX16_ITC_PRIO6_UART1_TR              (3U << 14)                      /*!< RW: priority UART1_TR */
#define C_MLX16_ITC_PRIO6_UART1_TR_PRIO3        (0U << 14)                      /*!< RW: priority 3 UART1_TR */
#define C_MLX16_ITC_PRIO6_UART1_TR_PRIO4        (1U << 14)                      /*!< RW: priority 4 UART1_TR */
#define C_MLX16_ITC_PRIO6_UART1_TR_PRIO5        (2U << 14)                      /*!< RW: priority 5 UART1_TR */
#define C_MLX16_ITC_PRIO6_UART1_TR_PRIO6        (3U << 14)                      /*!< RW: priority 6 UART1_TR */

extern volatile uint16_t IO_MLX16_ITC_PRIO7_S __attribute__((nodp, addr(0x00096)));  /*!< IO_MLX16_ITC_PRIO7_S (System) */
#if defined __MLX81346A01__
#define M_MLX16_ITC_PRIO7                       (2047U << 0)                    /*!< RW: Configure priority for interrupt[INT0_COUNT+INT1_COUNT+INT2_COUNT+63:INT0_COUNT+INT1_COUNT+INT2_COUNT+56] */
#else /* defined __MLX81346B01__ */
#define M_MLX16_ITC_PRIO7                       (16383U << 0)                   /*!< RW: Configure priority for interrupt[INT0_COUNT+INT1_COUNT+INT2_COUNT+31:INT0_COUNT+INT1_COUNT+INT2_COUNT+24] */
#endif /* defined __MLX81346B01__ */
#define M_MLX16_ITC_PRIO7_UART1_TE              (3U << 0)                       /*!< RW: priority UART1_TE */
#define C_MLX16_ITC_PRIO7_UART1_TE_PRIO3        (0U << 0)                       /*!< RW: priority 3 UART1_TE */
#define C_MLX16_ITC_PRIO7_UART1_TE_PRIO4        (1U << 0)                       /*!< RW: priority 4 UART1_TE */
#define C_MLX16_ITC_PRIO7_UART1_TE_PRIO5        (2U << 0)                       /*!< RW: priority 5 UART1_TE */
#define C_MLX16_ITC_PRIO7_UART1_TE_PRIO6        (3U << 0)                       /*!< RW: priority 6 UART1_TE */
#define M_MLX16_ITC_PRIO7_UDFR1                 (3U << 2)                       /*!< RW: priority UDFR1 */
#define C_MLX16_ITC_PRIO7_UDFR1_PRIO3           (0U << 2)                       /*!< RW: priority 3 UDFR1 */
#define C_MLX16_ITC_PRIO7_UDFR1_PRIO4           (1U << 2)                       /*!< RW: priority 4 UDFR1 */
#define C_MLX16_ITC_PRIO7_UDFR1_PRIO5           (2U << 2)                       /*!< RW: priority 5 UDFR1 */
#define C_MLX16_ITC_PRIO7_UDFR1_PRIO6           (3U << 2)                       /*!< RW: priority 6 UDFR1 */
#define M_MLX16_ITC_PRIO7_UDFT1                 (3U << 4)                       /*!< RW: priority UDRF1 */
#define C_MLX16_ITC_PRIO7_UDFT1_PRIO3           (0U << 4)                       /*!< RW: priority 3 UDRF1 */
#define C_MLX16_ITC_PRIO7_UDFT1_PRIO4           (1U << 4)                       /*!< RW: priority 4 UDRF1 */
#define C_MLX16_ITC_PRIO7_UDFT1_PRIO5           (2U << 4)                       /*!< RW: priority 5 UDRF1 */
#define C_MLX16_ITC_PRIO7_UDFT1_PRIO6           (3U << 4)                       /*!< RW: priority 6 UDRF1 */
#define M_MLX16_ITC_PRIO7_ACTIVE_CDI            (3U << 6)                       /*!< RW: priority ACTIVE_CDI */
#define C_MLX16_ITC_PRIO7_ACTIVE_CDI_PRIO3      (0U << 6)                       /*!< RW: priority 3 ACTIVE_CDI */
#define C_MLX16_ITC_PRIO7_ACTIVE_CDI_PRIO4      (1U << 6)                       /*!< RW: priority 4 ACTIVE_CDI */
#define C_MLX16_ITC_PRIO7_ACTIVE_CDI_PRIO5      (2U << 6)                       /*!< RW: priority 5 ACTIVE_CDI */
#define C_MLX16_ITC_PRIO7_ACTIVE_CDI_PRIO6      (3U << 6)                       /*!< RW: priority 6 ACTIVE_CDI */
#define M_MLX16_ITC_PRIO7_I2C_EOW               (3U << 8)                       /*!< RW: priority I2C_EOW */
#define C_MLX16_ITC_PRIO7_I2C_EOW_PRIO3         (0U << 8)                       /*!< RW: priority 3 I2C_EOW */
#define C_MLX16_ITC_PRIO7_I2C_EOW_PRIO4         (1U << 8)                       /*!< RW: priority 4 I2C_EOW */
#define C_MLX16_ITC_PRIO7_I2C_EOW_PRIO5         (2U << 8)                       /*!< RW: priority 5 I2C_EOW */
#define C_MLX16_ITC_PRIO7_I2C_EOW_PRIO6         (3U << 8)                       /*!< RW: priority 6 I2C_EOW */
#define M_MLX16_ITC_PRIO7_I2C_EOR               (3U << 10)                      /*!< RW: priority I2C_EOR */
#define C_MLX16_ITC_PRIO7_I2C_EOR_PRIO3         (0U << 10)                      /*!< RW: priority 3 I2C_EOR */
#define C_MLX16_ITC_PRIO7_I2C_EOR_PRIO4         (1U << 10)                      /*!< RW: priority 4 I2C_EOR */
#define C_MLX16_ITC_PRIO7_I2C_EOR_PRIO5         (2U << 10)                      /*!< RW: priority 5 I2C_EOR */
#define C_MLX16_ITC_PRIO7_I2C_EOR_PRIO6         (3U << 10)                      /*!< RW: priority 6 I2C_EOR */
#if defined (__MLX81346B01__)
#define M_MLX16_ITC_PRIO7_I2C_ERR               (3U << 12)                      /*!< RW: priority I2C_ERR */
#define C_MLX16_ITC_PRIO7_I2C_ERR_PRIO3         (0U << 12)                      /*!< RW: priority 3 I2C_ERR */
#define C_MLX16_ITC_PRIO7_I2C_ERR_PRIO4         (1U << 12)                      /*!< RW: priority 4 I2C_ERR */
#define C_MLX16_ITC_PRIO7_I2C_ERR_PRIO5         (2U << 12)                      /*!< RW: priority 5 I2C_ERR */
#define C_MLX16_ITC_PRIO7_I2C_ERR_PRIO6         (3U << 12)                      /*!< RW: priority 6 I2C_ERR */
#endif /* defined (__MLX81346B01__) */
...
/* Block: ADC_BLOCK */
/* **************** */
extern volatile uint16_t IO_ADC_BLOCK_CTRL __attribute__((nodp, addr(0x00166)));  /*!< IO_ADC_BLOCK_CTRL */
...
extern volatile uint16_t IO_ADC_BLOCK_SBASE __attribute__((nodp, addr(0x00168)));  /*!< IO_ADC_BLOCK_SBASE */
...
typedef enum
{
    ...
    C_ADC_CH6 = 6U,                                                             /*!< Reserved for LIN auto configure amplifier output */
    C_ADC_RES6 = C_ADC_CH6,
    C_ADC_CH7 = 7U,                                                             /*!< Reserved for LIN auto configure common mode */
    C_ADC_RES7 = C_ADC_CH7,
    C_ADC_CH8 = 8U,                                                             /*!< VSMF/26 Filtered motor supply voltage divided by 26 */
    C_ADC_VSMF_HV = C_ADC_CH8,
    C_ADC_CH9 = 9U,                                                             /*!< VBOOST/32 Filtered motor supply voltage divided by 32 */
    C_ADC_VBOOST_HV = C_ADC_CH9,
    C_ADC_CH10 = 10U,                                                           /*!< CSOUT - Current sense amplifier output voltage */
    C_ADC_MCUR = C_ADC_CH10,
    ...
    C_ADC_PH_U_HV = C_ADC_CH27,
    C_ADC_CH28 = 28U,                                                           /*!< Phase V/26 */
    C_ADC_PH_V_HV = C_ADC_CH28,
    C_ADC_CH29 = 29U,                                                           /*!< Phase W/26 */
    C_ADC_PH_W_HV = C_ADC_CH29,
    C_ADC_CH30 = 30U,                                                           /*!< TA0 */
    C_ADC_TA0_LV = C_ADC_CH30,
    C_ADC_CH31 = 31U,                                                           /*!< TA1 */
    C_ADC_TA1_LV = C_ADC_CH31,
    C_ADC_CH32 = 32U,                                                           /*!< VS, Internal high ohmic divider 1:52 */
    C_ADC_VS_DIV52 = C_ADC_CH32,
    C_ADC_CH33 = 33U,                                                           /*!< Analogue Ground */
    C_ADC_AGND = C_ADC_CH33,
    C_ADC_CH41 = 41U,                                                           /*!< VBOOST/64 Filtered motor supply voltage divided by 64 */
    C_ADC_VBOOST_DIV64 = C_ADC_CH41,
    C_ADC_CH59 = 59U,                                                           /*!< Phase U/52 */
    C_ADC_PH_U_DIV52 = C_ADC_CH59,
    C_ADC_CH60 = 60U,                                                           /*!< Phase V/52 */
    C_ADC_PH_V_DIV52 = C_ADC_CH60,
    C_ADC_CH61 = 61U,                                                           /*!< Phase W/52 */
    C_ADC_PH_W_DIV52 = C_ADC_CH61
} AdcChannel_t;
...
typedef enum
{
    ...
    C_ADC_HW_TRIGGER_IO4 = 17U,                                                 /*!< ADC HW-Trigger IO4 */
    C_ADC_HW_TRIGGER_IO5 = 18U,                                                 /*!< ADC HW-Trigger IO5 */
    C_ADC_HW_TRIGGER_IO6 = 19U,                                                 /*!< ADC HW-Trigger IO6 */
    C_ADC_HW_TRIGGER_IO7 = 20U,                                                 /*!< ADC HW-Trigger IO7 */
    C_ADC_HW_TRIGGER_IO8 = 21U,                                                 /*!< ADC HW-Trigger IO8 */
    C_ADC_HW_TRIGGER_IO9 = 22U,                                                 /*!< ADC HW-Trigger IO9 */
    C_ADC_HW_TRIGGER_IO10 = 23U,                                                /*!< ADC HW-Trigger IO10 */
    C_ADC_HW_TRIGGER_IO11 = 24U,                                                /*!< ADC HW-Trigger IO11 */
    /* In line with Data-sheet V0.8 and newer (MMP230510-1) */
...
#define C_ADC_HW_TRIGGER_MSTR2_CMP              (5U << 10)                      /*!< PWM Master #2, CMP IT */
#define C_ADC_HW_TRIGGER_MSTR2_CNT              (6U << 10)                      /*!< PWM Master #2, CNT IT */
#define C_ADC_HW_TRIGGER_IO0                    (7U << 10)                      /*!< IO[0] */
#define C_ADC_HW_TRIGGER_IO1                    (8U << 10)                      /*!< IO[1] */
#define C_ADC_HW_TRIGGER_IO2                    (9U << 10)                      /*!< IO[2] */
#define C_ADC_HW_TRIGGER_IO3                    (10U << 10)                     /*!< IO[3] */
#define C_ADC_HW_TRIGGER_CTIMER0_INT1           (11U << 10)                     /*!< CTimer #0, INT #1 */
#define C_ADC_HW_TRIGGER_CTIMER0_INT2           (12U << 10)                     /*!< CTimer #0, INT #2 */
#define C_ADC_HW_TRIGGER_CTIMER0_INT3           (13U << 10)                     /*!< CTimer #0, INT #3 */
#define C_ADC_HW_TRIGGER_CTIMER1_INT1           (14U << 10)                     /*!< CTimer #1, INT #1 */
#define C_ADC_HW_TRIGGER_CTIMER1_INT2           (15U << 10)                     /*!< CTimer #1, INT #2 */
#define C_ADC_HW_TRIGGER_CTIMER1_INT3           (16U << 10)                     /*!< CTimer #1, INT #3 */
#define C_ADC_HW_TRIGGER_IO4                    (17U << 10)                     /*!< IO[4] */
#define C_ADC_HW_TRIGGER_IO5                    (18U << 10)                     /*!< IO[5] */
#define C_ADC_HW_TRIGGER_IO6                    (19U << 10)                     /*!< IO[6] */
#define C_ADC_HW_TRIGGER_IO7                    (20U << 10)                     /*!< IO[7] */
#define C_ADC_HW_TRIGGER_IO8                    (21U << 10)                     /*!< IO[8] */
#define C_ADC_HW_TRIGGER_IO9                    (22U << 10)                     /*!< IO[9] */
#define C_ADC_HW_TRIGGER_IO10                   (23U << 10)                     /*!< IO[10] */
#define C_ADC_HW_TRIGGER_IO11                   (24U << 10)                     /*!< IO[11] */
#define C_ADC_HW_TRIGGER_EOCpls1xADC_CLOCK      (32U << 10)                     /*!< End of Conversion +  1x ADC-Clock */
#define C_ADC_HW_TRIGGER_EOCpls3xADC_CLOCK      (33U << 10)                     /*!< End of Conversion +  3x ADC-Clock */
#define C_ADC_HW_TRIGGER_EOCpls5xADC_CLOCK      (34U << 10)                     /*!< End of Conversion +  5x ADC-Clock */
#define C_ADC_HW_TRIGGER_EOCpls7xADC_CLOCK      (35U << 10)                     /*!< End of Conversion +  7x ADC-Clock */
#define C_ADC_HW_TRIGGER_EOCpls9xADC_CLOCK      (36U << 10)                     /*!< End of Conversion +  9x ADC-Clock */
#define C_ADC_HW_TRIGGER_EOCpls11xADC_CLOCK     (37U << 10)                     /*!< End of Conversion + 11x ADC-Clock */
#define C_ADC_HW_TRIGGER_EOCpls13xADC_CLOCK     (38U << 10)                     /*!< End of Conversion + 13x ADC-Clock */
#define C_ADC_HW_TRIGGER_EOCpls15xADC_CLOCK     (39U << 10)                     /*!< End of Conversion + 15x ADC-Clock */
#define C_ADC_HW_TRIGGER_EOCpls1xMCU_CLOCK      (48U << 10)                     /*!< End of Conversion +  1x MCU-Clock */
#define C_ADC_HW_TRIGGER_EOCpls3xMCU_CLOCK      (49U << 10)                     /*!< End of Conversion +  3x MCU-Clock */
#define C_ADC_HW_TRIGGER_EOCpls5xMCU_CLOCK      (50U << 10)                     /*!< End of Conversion +  5x MCU-Clock */
#define C_ADC_HW_TRIGGER_EOCpls7xMCU_CLOCK      (51U << 10)                     /*!< End of Conversion +  7x MCU-Clock */
#define C_ADC_HW_TRIGGER_EOCpls9xMCU_CLOCK      (52U << 10)                     /*!< End of Conversion +  9x MCU-Clock */
#define C_ADC_HW_TRIGGER_EOCpls11xMCU_CLOCK     (53U << 10)                     /*!< End of Conversion + 11x MCU-Clock */
#define C_ADC_HW_TRIGGER_EOCpls13xMCU_CLOCK     (54U << 10)                     /*!< End of Conversion + 13x MCU-Clock */
#define C_ADC_HW_TRIGGER_EOCpls15xMCU_CLOCK     (55U << 10)                     /*!< End of Conversion + 15x MCU-Clock */
...
#define M_ADC_SIN                               (63U << 3)                      /*!< ADC Channel selection */
#define C_ADC_TYPE_EC                           (0U << 9)                       /*!< Extended Count Mode */
#define C_ADC_TYPE_CYCLIC                       (1U << 9)                       /*!< Cyclic Mode */
#define M_ADC_TRIG                              (63U << 10)                     /*!< ADC Trigger selection */
...
#define C_ADC_CH4                               (4U << 3)                       /*!< Bandgap voltage digital */
...
#define C_ADC_CH9                               (9U << 3)                       /*!< VBOOST/32 Filtered motor supply voltage divided by 32 */
#define C_ADC_CH10                              (10U << 3)                      /*!< CSOUT - Current sense amplifier output voltage */
#define C_ADC_CH11                              (11U << 3)                      /*!< LIN Voltage divided by 3 */
#define C_ADC_CH12                              (12U << 3)                      /*!< IO[0]/2.5 */
#define C_ADC_CH13                              (13U << 3)                      /*!< IO[1]/2.5 */
#define C_ADC_CH14                              (14U << 3)                      /*!< IO[2]/2.5 */
#define C_ADC_CH15                              (15U << 3)                      /*!< IO[3]/2.5 */
#define C_ADC_CH16                              (16U << 3)                      /*!< IO[4]/2.5 */
#define C_ADC_CH17                              (17U << 3)                      /*!< IO[5]/2.5 */
#define C_ADC_CH18                              (18U << 3)                      /*!< IO[6]/2.5 */
#define C_ADC_CH19                              (19U << 3)                      /*!< IO[7]/2.5 */
#define C_ADC_CH20                              (20U << 3)                      /*!< IO[8]/2.5 */
#define C_ADC_CH21                              (21U << 3)                      /*!< IO[9]/2.5 */
#define C_ADC_CH22                              (22U << 3)                      /*!< IO[10]/2.5 */
#define C_ADC_CH23                              (23U << 3)                      /*!< IO[11]/2.5 */
#define C_ADC_CH24                              (24U << 3)                      /*!< IO[0]/26 */
#define C_ADC_CH25                              (25U << 3)                      /*!< IO[1]/26 */
#define C_ADC_CH26                              (26U << 3)                      /*!< IO[2]/26 */
#define C_ADC_CH27                              (27U << 3)                      /*!< Phase U/26 */
#define C_ADC_CH28                              (28U << 3)                      /*!< Phase V/26 */
#define C_ADC_CH29                              (29U << 3)                      /*!< Phase W/26 */
#define C_ADC_CH30                              (30U << 3)                      /*!< TA0 */
#define C_ADC_CH31                              (31U << 3)                      /*!< TA1 */
#define C_ADC_CH32                              (32U << 3)                      /*!< VS, Internal high ohmic divider 1:52 */
#define C_ADC_CH33                              (33U << 3)                      /*!< Analogue Ground */
#define C_ADC_CH41                              (41U << 3)                      /*!< VBOOST/64 Filtered motor supply voltage divided by 64 */
#define C_ADC_CH59                              (59U << 3)                      /*!< Phase U/52 */
#define C_ADC_CH60                              (60U << 3)                      /*!< Phase V/52 */
#define C_ADC_CH61                              (61U << 3)                      /*!< Phase W/52 */
...
#define C_ADC_BGD           (C_ADC_TYPE_CYCLIC | C_ADC_CH4 | C_ADC_SIN_SDATA)   /*!<  4           1.5V    VBGD voltage */
#define C_ADC_VAUX          (C_ADC_TYPE_CYCLIC | C_ADC_CH5 | C_ADC_SIN_SDATA)   /*!<  5           1.5V    VAUX voltage (divided by 4) */
#define C_ADC_RES6          (C_ADC_TYPE_CYCLIC | C_ADC_CH6 | C_ADC_SIN_SDATA)   /*!<  6           1.5V    Reserved (for LIN-AA Differential-mode) */
#define C_ADC_RES7          (C_ADC_TYPE_CYCLIC | C_ADC_CH7 | C_ADC_SIN_SDATA)   /*!<  7           1.5V    Reserved (for LIN-AA Common-mode) */
#define C_ADC_VSMF          (C_ADC_TYPE_CYCLIC | C_ADC_CH8 | C_ADC_SIN_SDATA)   /*!<  8           1.5V    VSM-Filtered (divided by 26) */
#define C_ADC_VBOOST        (C_ADC_TYPE_CYCLIC | C_ADC_CH9 | C_ADC_SIN_SDATA)   /*!<  9           1.5V    VBOOST-unfiltered (divided by 32) */
#define C_ADC_MCUR          (C_ADC_TYPE_CYCLIC | C_ADC_CH10 | C_ADC_SIN_SDATA)  /*!< 10           1.5V    CSOUT - Current sense amplifier output voltage */
...
#define C_ADC_VPHU          (C_ADC_TYPE_CYCLIC | C_ADC_CH27 | C_ADC_SIN_SDATA)  /*!< 27           1.5V    Phase U voltage (divided by 26) */
#define C_ADC_VPHV          (C_ADC_TYPE_CYCLIC | C_ADC_CH28 | C_ADC_SIN_SDATA)  /*!< 28           1.5V    Phase U voltage (divided by 26) */
#define C_ADC_VPHW          (C_ADC_TYPE_CYCLIC | C_ADC_CH29 | C_ADC_SIN_SDATA)  /*!< 29           1.5V    Phase U voltage (divided by 26) */
#define C_ADC_TA0           (C_ADC_TYPE_CYCLIC | C_ADC_CH30 | C_ADC_SIN_SDATA)  /*!< 30           1.5V    VSMF-Offset (divided by 26) */
#define C_ADC_VS_DIV52      (C_ADC_TYPE_CYCLIC | C_ADC_CH32 | C_ADC_SIN_SDATA)  /*!< 30           1.5V    Vs-unfiltered (divided by 52) */
#define C_ADC_VSSA          (C_ADC_TYPE_CYCLIC | C_ADC_CH33 | C_ADC_SIN_SDATA)  /*!< 31           1.5V    Analogue Ground */
#define C_ADC_VBOOST_DIV64  (C_ADC_TYPE_CYCLIC | C_ADC_CH41 | C_ADC_SIN_SDATA)  /*!< 41           1.5V    VBOOST-unfiltered (divided by 64) */
#define C_ADC_VPHU_DIV52    (C_ADC_TYPE_CYCLIC | C_ADC_CH59 | C_ADC_SIN_SDATA)  /*!< 59           1.5V    Phase U voltage (divided by 52) */
#define C_ADC_VPHV_DIV52    (C_ADC_TYPE_CYCLIC | C_ADC_CH60 | C_ADC_SIN_SDATA)  /*!< 60           1.5V    Phase U voltage (divided by 52) */
#define C_ADC_VPHW_DIV52    (C_ADC_TYPE_CYCLIC | C_ADC_CH61 | C_ADC_SIN_SDATA)  /*!< 61           1.5V    Phase U voltage (divided by 52) */
#endif

extern volatile uint16_t IO_ADC_BLOCK_STATUS __attribute__((nodp, addr(0x0016A)));  /*!< IO_ADC_BLOCK_STATUS */
...
#define M_ADC_BLOCK_STATE                       (3U << 6)                       /*!< R: See below; W: No effect */
...
#define B_ADC_BLOCK_READY                       (1U << 3)                       /*!< R: READY signal from ADC; W: No effect */
...
extern volatile uint16_t IO_ADC_BLOCK_CLK __attribute__((nodp, addr(0x0016C)));  /*!< IO_ADC_BLOCK_CLK */
...
#define M_ADC_BLOCK_CM_PRCHRG_TIME              (7U << 10)                      /*!< Pre-Charge Time: T_PRECHARGE = 2^CM_PRCHRG_TIME */
#define M_ADC_BLOCK_CLK_TO_INT                  (3U << 8)                       /*!< Number of MCU_CLK between MS_PHIx_CLK and MS_PHIx_INT */
#define M_ADC_BLOCK_ADC_CLK_DIV                 (127U << 0)                     /*!< RW: ADC_CLK = MCU_CLK / ( ADC_CLK_DIV + 1 ) */

extern volatile uint16_t IO_ADC_BLOCK_X __attribute__((nodp, addr(0x0016E)));   /*!< IO_ADC_BLOCK_X */
...
#define B_ADC_BLOCK_MODE                        (1U << 4)                       /*!< RW: Defines the operation mode 0 : normal mode 1 : test mode */
...
extern volatile uint16_t IO_ADC_BLOCK_TEST __attribute__((nodp, addr(0x00170)));  /*!< IO_ADC_BLOCK_TEST */
...
#define M_ADC_BLOCK_SRC                         (63U << 0)                      /*!< R: COME FROM SDATA Signal source 000000 : regular input of the ADC Others: the input signal source is a subdivision of +/- VREF */

extern volatile uint16_t IO_ADC_BLOCK_CORR_LSW __attribute__((nodp, addr(0x00172)));  /*!< IO_ADC_BLOCK_CORR_LSW */
#define M_ADC_BLOCK_CORR_15_0                   (65535U << 0)                   /*!< RW: Bit [15:0] of the vector of correction */

extern volatile uint16_t IO_ADC_BLOCK_CORR_MSW __attribute__((nodp, addr(0x00174)));  /*!< IO_ADC_BLOCK_CORR_MSW */
#define M_ADC_BLOCK_CORR_31_16                  (65535U << 0)                   /*!< RW: Bit [31:16] of the vector of correction */

extern volatile uint16_t IO_ADC_BLOCK_CORR_XSW __attribute__((nodp, addr(0x00176)));  /*!< IO_ADC_BLOCK_CORR_XSW */
#define M_ADC_BLOCK_CORR_46_32                  (32767U << 0)                   /*!< RW: Bit [46:32] of the vector of correction */

/* ******************* */
/* Block: EEPROM_FLASH */
/* ******************* */
extern volatile uint16_t IO_EEPROM_FLASH_T __attribute__((nodp, addr(0x00196)));  /*!< IO_EEPROM_FLASH_T */
...
extern volatile uint16_t IO_EEPROM_FLASH_T_1US __attribute__((nodp, addr(0x00198)));  /*!< IO_EEPROM_FLASH_T_1US */
...
extern volatile uint16_t IO_EEPROM_FLASH_DMA __attribute__((nodp, addr(0x0019A)));  /*!< IO_EEPROM_FLASH_DMA */
...
extern volatile uint16_t IO_EEPROM_FLASH_CMD_STS __attribute__((nodp, addr(0x0019C)));  /*!< IO_EEPROM_FLASH_CMD_STS */
...
extern volatile uint16_t IO_EEPROM_FLASH_FL_TIME __attribute__((nodp, addr(0x0019E)));  /*!< IO_EEPROM_FLASH_FL_TIME */
...
extern volatile uint16_t IO_EEPROM_FLASH_FL_CTRL __attribute__((nodp, addr(0x001A0)));  /*!< IO_EEPROM_FLASH_FL_CTRL */
...
extern volatile uint16_t IO_EEPROM_FLASH_FL __attribute__((nodp, addr(0x001A2)));  /*!< IO_EEPROM_FLASH_FL */
...
extern volatile uint16_t IO_EEPROM_FLASH_FL_SEC_PG __attribute__((nodp, addr(0x001A4)));  /*!< IO_EEPROM_FLASH_FL_SEC_PG */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_CTRL_S __attribute__((nodp, addr(0x001A6)));  /*!< IO_EEPROM_FLASH_EE_CTRL_S (System) */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_DATA_ERROR __attribute__((nodp, addr(0x001A8)));  /*!< IO_EEPROM_FLASH_EE_DATA_ERROR */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_WTIME __attribute__((nodp, addr(0x001AA)));  /*!< IO_EEPROM_FLASH_EE_WTIME */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_ERTIME __attribute__((nodp, addr(0x001AC)));  /*!< IO_EEPROM_FLASH_EE_ERTIME */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_PROG_CYCLE __attribute__((nodp, addr(0x001AE)));  /*!< IO_EEPROM_FLASH_EE_PROG_CYCLE */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_WS __attribute__((nodp, addr(0x001B0)));  /*!< IO_EEPROM_FLASH_EE_WS */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_INT_INV_SRC __attribute__((nodp, addr(0x001B2)));  /*!< IO_EEPROM_FLASH_EE_INT_INV_SRC */
...
extern volatile uint16_t IO_EEPROM_FLASH __attribute__((nodp, addr(0x001BC)));  /*!< IO_EEPROM_FLASH */
...
extern volatile uint16_t IO_EEPROM_FLASH_FL_BITS_ERROR __attribute__((nodp, addr(0x001BE)));  /*!< IO_EEPROM_FLASH_FL_BITS_ERROR */
#define M_EEPROM_FLASH_FL_BITS_ERRORS           (511U << 0)                     /*!< RW: Saturing count of bit mismatching pattern defined by FL_PATTERN_ID */

extern volatile uint16_t IO_EEPROM_FLASH_FL_SIG_L __attribute__((nodp, addr(0x001C0)));  /*!< IO_EEPROM_FLASH_FL_SIG_L */
...
extern volatile uint16_t IO_EEPROM_FLASH_FL_SIG_H __attribute__((nodp, addr(0x001C2)));  /*!< IO_EEPROM_FLASH_FL_SIG_H */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_CTRL2 __attribute__((nodp, addr(0x001C4)));  /*!< IO_EEPROM_FLASH_EE_CTRL2 */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_BITS_ERROR __attribute__((nodp, addr(0x001C6)));  /*!< IO_EEPROM_FLASH_EE_BITS_ERROR */
#define M_EEPROM_FLASH_EE_BITS_ERRORS           (511U << 0)                     /*!< RW: Saturing count of bit mismatching pattern defined by EE_PATTERN_ID */

extern volatile uint16_t IO_EEPROM_FLASH_EE_SIG_L __attribute__((nodp, addr(0x001C8)));  /*!< IO_EEPROM_FLASH_EE_SIG_L */
...
extern volatile uint16_t IO_EEPROM_FLASH_EE_SIG_H __attribute__((nodp, addr(0x001CA)));  /*!< IO_EEPROM_FLASH_EE_SIG_H */
...
/* Block: COLIN */
/* ************ */
extern volatile uint16_t IO_COLIN_ADDR_PATCH0 __attribute__((nodp, addr(0x001CC)));  /*!< IO_COLIN_ADDR_PATCH0 */
...
extern volatile uint16_t IO_COLIN_DATA_PATCH0 __attribute__((nodp, addr(0x001CE)));  /*!< IO_COLIN_DATA_PATCH0 */
...
extern volatile uint16_t IO_COLIN_ADDR_PATCH1 __attribute__((nodp, addr(0x001D0)));  /*!< IO_COLIN_ADDR_PATCH1 */
...
extern volatile uint16_t IO_COLIN_DATA_PATCH1 __attribute__((nodp, addr(0x001D2)));  /*!< IO_COLIN_DATA_PATCH1 */
...
extern volatile uint16_t IO_COLIN_ADDR_PATCH2 __attribute__((nodp, addr(0x001D4)));  /*!< IO_COLIN_ADDR_PATCH2 */
...
extern volatile uint16_t IO_COLIN_DATA_PATCH2 __attribute__((nodp, addr(0x001D6)));  /*!< IO_COLIN_DATA_PATCH2 */
...
extern volatile uint16_t IO_COLIN_ADDR_PATCH3 __attribute__((nodp, addr(0x001D8)));  /*!< IO_COLIN_ADDR_PATCH3 */
...
extern volatile uint16_t IO_COLIN_DATA_PATCH3 __attribute__((nodp, addr(0x001DA)));  /*!< IO_COLIN_DATA_PATCH3 */
...
extern volatile uint8_t IO_COLIN_CFG __attribute__((nodp, addr(0x001DC)));      /*!< IO_COLIN_CFG */
...
extern volatile uint8_t IO_COLIN_STS __attribute__((nodp, addr(0x001DD)));      /*!< IO_COLIN_STS */
...
extern volatile uint16_t IO_COLIN_CMD_SLVIT __attribute__((nodp, addr(0x001DE)));  /*!< IO_COLIN_CMD_SLVIT */
...
extern volatile uint16_t IO_COLIN_ROM_RAM __attribute__((nodp, addr(0x001E0)));  /*!< IO_COLIN_ROM_RAM */
...
extern volatile uint16_t IO_COLIN_LPWR_ROM_RAM __attribute__((nodp, addr(0x001E2)));  /*!< IO_COLIN_LPWR_ROM_RAM */
...
extern volatile uint16_t IO_COLIN_RAM_PROT __attribute__((nodp, addr(0x001E4)));  /*!< IO_COLIN_RAM_PROT */
...
/* Block: TRIM_BG_BIAS */
/* ******************* */
extern volatile uint16_t IO_TRIM_BG_BIAS __attribute__((nodp, addr(0x001E6)));  /*!< IO_TRIM_BG_BIAS */
...
/* Block: TRIM_VDD */
/* *************** */
extern volatile uint16_t IO_TRIM_VDD __attribute__((nodp, addr(0x001E8)));      /*!< IO_TRIM_VDD */
...
#define M_TRIM_VDD_TR_SUP                       (255U << 6)                     /*!< RW: spare control output bits for supply system */
...
/* Block: TRIM_RCO32M */
/* ****************** */
extern volatile uint16_t IO_TRIM_RCO32M __attribute__((nodp, addr(0x001EA)));   /*!< IO_TRIM_RCO32M */
...
/* Block: TRIM_RCO1M */
/* ***************** */
extern volatile uint16_t IO_TRIM_RCO1M __attribute__((nodp, addr(0x001EC)));    /*!< IO_TRIM_RCO1M */
...
/* ********************* */
extern volatile uint16_t IO_PORT_SSCM_CONF __attribute__((nodp, addr(0x001EE)));  /*!< IO_PORT_SSCM_CONF */
...
/* ********************* */
extern volatile uint16_t IO_PORT_STEP_CONF __attribute__((nodp, addr(0x001F0)));  /*!< IO_PORT_STEP_CONF */
...
/* ********************* */
extern volatile uint16_t IO_PORT_SUPP_TEST __attribute__((nodp, addr(0x001F2)));  /*!< IO_PORT_SUPP_TEST */
...
/* ********************** */
extern volatile uint16_t IO_PORT_SUPP2_TEST __attribute__((nodp, addr(0x001F4)));  /*!< IO_PORT_SUPP2_TEST */
...
/* Block: PORT_LIN_TEST */
/* ******************** */
extern volatile uint16_t IO_PORT_LIN_TEST __attribute__((nodp, addr(0x001F6)));  /*!< IO_PORT_LIN_TEST */
...
/* ********************** */
extern volatile uint16_t IO_PORT_SPARE_TEST __attribute__((nodp, addr(0x001F8)));  /*!< IO_PORT_SPARE_TEST */
#define M_PORT_SPARE_TEST_TEST_SUP              (255U << 0)                     /*!< RW: spare test control bits for supply system */

/* ***************** */
/* Block: PORT_IO_IN */
/* ***************** */
extern volatile uint16_t IO_PORT_IO_IN __attribute__((nodp, addr(0x001FA)));    /*!< IO_PORT_IO_IN */
#define M_PORT_IO_IN_IO_IN_SYNC                 (4095U << 0)                    /*!< R: From Schmitt trigger I/O (after re-synchronisation) */
...
/* Block: PORT_SUPP_IN */
/* ******************* */
extern volatile uint16_t IO_PORT_SUPP_IN __attribute__((nodp, addr(0x001FC)));  /*!< IO_PORT_SUPP_IN */
#define B_PORT_SUPP_IN_OV_BOOST_SYNC            (1U << 15)                      /*!< R: Before digital filtering */
#define B_PORT_SUPP_IN_OV_BOOST_IT              (1U << 14)                      /*!< R: over voltage at VBOOST */
#define B_PORT_SUPP_IN_UV_BOOST_SYNC            (1U << 13)                      /*!< R: Before digital filtering */
#define B_PORT_SUPP_IN_UV_BOOST_IT              (1U << 12)                      /*!< R: Under voltage at VBOOST */
#define B_PORT_SUPP_IN_OVC_SYNC                 (1U << 11)                      /*!< R: Before digital filtering */
#define B_PORT_SUPP_IN_OVC_IT                   (1U << 10)                      /*!< R: Over current detection */
#define B_PORT_SUPP_IN_OVT_SYNC                 (1U << 9)                       /*!< R: Before digital filtering */
#define B_PORT_SUPP_IN_OVT_IT                   (1U << 8)                       /*!< R: Over temperature interrupt flag */
#define B_PORT_SUPP_IN_OV_VSM_SYNC              (1U << 7)                       /*!< R: Before digital filtering */
#define B_PORT_SUPP_IN_OV_VSM_IT                (1U << 6)                       /*!< R: Over voltage at VSM */
#define B_PORT_SUPP_IN_UV_VSM_SYNC              (1U << 5)                       /*!< R: Before digital filtering */
#define B_PORT_SUPP_IN_UV_VSM_IT                (1U << 4)                       /*!< R: Under voltage at VSM */
#define B_PORT_SUPP_IN_OV_VDDA_SYNC             (1U << 3)                       /*!< R: Before digital filtering */
#define B_PORT_SUPP_IN_OV_VDDA_IT               (1U << 2)                       /*!< R: Over voltage condition at VDDA */
...
/* Block: PORT_SUPP2_IN */
/* ******************** */
extern volatile uint16_t IO_PORT_SUPP2_IN __attribute__((nodp, addr(0x001FE)));  /*!< IO_PORT_SUPP2_IN */
#define B_PORT_SUPP2_IN_OV_HS_IO4_SYNC          (1U << 5)                       /*!< R: Value for digital read */
#define B_PORT_SUPP2_IN_OV_HS_IO4_IT            (1U << 4)                       /*!< R: Value for digital read */
#define B_PORT_SUPP2_IN_OV_HS_IO3_SYNC          (1U << 3)                       /*!< R: Value for digital read */
#define B_PORT_SUPP2_IN_OV_HS_IO3_IT            (1U << 2)                       /*!< R: Value for digital read */
#define B_PORT_SUPP2_IN_OC_VDDA_SYNC            (1U << 1)                       /*!< R: Value for digital read */
#define B_PORT_SUPP2_IN_OC_VDDA_IT              (1U << 0)                       /*!< R: Value for digital read */

/* ******************* */
/* Block: PORT_MISC_IN */
/* ******************* */
extern volatile uint16_t IO_PORT_MISC_IN __attribute__((nodp, addr(0x00200)));  /*!< IO_PORT_MISC_IN */
...
/* Block: PORT_SUPP_CFG */
/* ******************** */
extern volatile uint16_t IO_PORT_SUPP_CFG __attribute__((nodp, addr(0x00202)));  /*!< IO_PORT_SUPP_CFG */
#define B_PORT_SUPP_CFG_OV_HS_IO4_FILT_SEL      (1U << 9)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_OV_HS_IO3_FILT_SEL      (1U << 8)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_OVT_FILT_SEL            (1U << 7)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_OV_VSM_FILT_SEL         (1U << 6)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_UV_VSM_FILT_SEL         (1U << 5)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_OV_BOOST_FILT_SEL       (1U << 4)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_UV_BOOST_FILT_SEL       (1U << 3)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_OC_VDDA_FILT_SEL        (1U << 2)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_OV_VDDA_FILT_SEL        (1U << 1)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */
#define B_PORT_SUPP_CFG_UV_VDDA_FILT_SEL        (1U << 0)                       /*!< RW: 0 : 1-2us filtering, 1 : 100-110us filtering */

/* ****************** */
/* Block: PORT_OC_DEB */
/* ****************** */
extern volatile uint16_t IO_PORT_OC_DEB __attribute__((nodp, addr(0x00204)));   /*!< IO_PORT_OC_DEB */
#define M_PORT_OC_DEB_DIV_OC                    (7U << 4)                       /*!< RW: OC debounce pre-divider */
#define M_PORT_OC_DEB_CNT_OC                    (15U << 0)                      /*!< RW: OC debounce counter setting */

/* ************************* */
/* Block: PORT_MASK_OV_HS_IO */
/* ************************* */
extern volatile uint16_t IO_PORT_MASK_OV_HS_IO __attribute__((nodp, addr(0x00206)));  /*!< IO_PORT_MASK_OV_HS_IO */
#define M_PORT_MASK_OV_HS_IO_DIV_MASK_OV_HS_IO  (15U << 8)                      /*!< RW: HS OV mask for IO[4:3], pre-divider setting */
#define M_PORT_MASK_OV_HS_IO_CNT_MASK4_OV_HS_IO (15U << 4)                      /*!< RW: HS OV mask for IO4, counter setting */
#define M_PORT_MASK_OV_HS_IO_CNT_MASK3_OV_HS_IO (15U << 0)                      /*!< RW: HS OV mask for IO3, counter setting */

/* *********************** */
/* Block: PORT_IO_OUT_SOFT */
/* *********************** */
extern volatile uint16_t IO_PORT_IO_OUT_SOFT __attribute__((nodp, addr(0x00208)));  /*!< IO_PORT_IO_OUT_SOFT */
...
/* ********************* */
extern volatile uint16_t IO_PORT_IO_OUT_EN __attribute__((nodp, addr(0x0020A)));  /*!< IO_PORT_IO_OUT_EN */
#if defined (__MLX81346A01__)
#define M_PORT_IO_OUT_EN_IO_HV_ENABLE           (31U << 10)                     /*!< RW: Set IO[4:0] High Voltage */
#define B_PORT_IO_OUT_EN_IO_HV_ENABLE_4         (1U << 14)                      /*!< RW: Set IO[4] High Voltage */
#define B_PORT_IO_OUT_EN_IO_HV_ENABLE_3         (1U << 13)                      /*!< RW: Set IO[3] High Voltage */
#define B_PORT_IO_OUT_EN_IO_HV_ENABLE_2         (1U << 12)                      /*!< RW: Set IO[2] High Voltage */
#define B_PORT_IO_OUT_EN_IO_HV_ENABLE_1         (1U << 11)                      /*!< RW: Set IO[1] High Voltage */
#define B_PORT_IO_OUT_EN_IO_HV_ENABLE_0         (1U << 10)                      /*!< RW: Set IO[0] High Voltage */
#elif defined (__MLX81346B01__)
#define M_PORT_IO_OUT_EN_IO_LV_ENABLE           (31U << 10)                     /*!< RW: Set IO[4:0] Low Voltage */
#define B_PORT_IO_OUT_EN_IO_LV_ENABLE_4         (1U << 14)                      /*!< RW: Set IO[4] Low Voltage */
#define B_PORT_IO_OUT_EN_IO_LV_ENABLE_3         (1U << 13)                      /*!< RW: Set IO[3] Low Voltage */
#define B_PORT_IO_OUT_EN_IO_LV_ENABLE_2         (1U << 12)                      /*!< RW: Set IO[2] Low Voltage */
#define B_PORT_IO_OUT_EN_IO_LV_ENABLE_1         (1U << 11)                      /*!< RW: Set IO[1] Low Voltage */
#define B_PORT_IO_OUT_EN_IO_LV_ENABLE_0         (1U << 10)                      /*!< RW: Set IO[0] Low Voltage */
#endif
#define M_PORT_IO_OUT_EN_IO_HS_ENABLE           (31U << 5)                      /*!< RW: Set IO[4:0] High Side */
#define B_PORT_IO_OUT_EN_IO_HS_ENABLE_4         (1U << 9)                       /*!< RW: Set IO[4] High Side */
#define B_PORT_IO_OUT_EN_IO_HS_ENABLE_3         (1U << 8)                       /*!< RW: Set IO[3] High Side */
#define B_PORT_IO_OUT_EN_IO_HS_ENABLE_2         (1U << 7)                       /*!< RW: Set IO[2] High Side */
#define B_PORT_IO_OUT_EN_IO_HS_ENABLE_1         (1U << 6)                       /*!< RW: Set IO[1] High Side */
#define B_PORT_IO_OUT_EN_IO_HS_ENABLE_0         (1U << 5)                       /*!< RW: Set IO[0] High Side */
#define M_PORT_IO_OUT_EN_IO_OD_ENABLE           (31U << 0)                      /*!< RW: Set IO[4:0] in open drain */
#define B_PORT_IO_OUT_EN_IO_OD_ENABLE_4         (1U << 4)                       /*!< RW: Set IO[4] in open-drain */
#define B_PORT_IO_OUT_EN_IO_OD_ENABLE_3         (1U << 3)                       /*!< RW: Set IO[3] in open-drain */
...
/* ********************* */
extern volatile uint16_t IO_PORT_IO_ENABLE __attribute__((nodp, addr(0x0020C)));  /*!< IO_PORT_IO_ENABLE */
...
/* ********************** */
extern volatile uint16_t IO_PORT_IO_ENABLE1 __attribute__((nodp, addr(0x0020E)));  /*!< IO_PORT_IO_ENABLE1 */
...
/* Block: PORT_IO_CFG0 */
/* ******************* */
extern volatile uint16_t IO_PORT_IO_CFG0 __attribute__((nodp, addr(0x00210)));  /*!< IO_PORT_IO_CFG0 */
...
/* Block: PORT_IO_CFG1 */
/* ******************* */
extern volatile uint16_t IO_PORT_IO_CFG1 __attribute__((nodp, addr(0x00212)));  /*!< IO_PORT_IO_CFG1 */
...
#define C_PORT_IO_CFG1_IO7_OUT_SEL_PWM_SLV3     (3U << 12)                      /*!< RW: Output selection PWM_SLAVE3 for IO[7] */
#define C_PORT_IO_CFG1_IO7_OUT_SEL_PWM_MSTR2    (4U << 12)                      /*!< RW: Output selection PWM_MASTER2 for IO[7] */
...
#define C_PORT_IO_CFG1_IO7_OUT_SEL_SPI_MOSI     (10U << 12)                     /*!< RW: Output selection SPI_MOSI for IO[7] */
#define C_PORT_IO_CFG1_IO7_OUT_SEL_SPI_MISO     (11U << 12)                     /*!< RW: Output selection SPI_MISO for IO[7] */
...
#define C_PORT_IO_CFG1_IO6_OUT_SEL_PWM_SLV3     (3U << 8)                       /*!< RW: Output selection PWM_SLAVE3 for IO[6] */
#define C_PORT_IO_CFG1_IO6_OUT_SEL_PWM_MSTR2    (4U << 8)                       /*!< RW: Output selection PWM_MASTER2 for IO[6] */
...
#define C_PORT_IO_CFG1_IO6_OUT_SEL_SPI_MOSI     (10U << 8)                      /*!< RW: Output selection SPI_MOSI for IO[6] */
#define C_PORT_IO_CFG1_IO6_OUT_SEL_SPI_MISO     (11U << 8)                      /*!< RW: Output selection SPI_MISO for IO[6] */
...
#define C_PORT_IO_CFG1_IO5_OUT_SEL_PWM_SLV3     (3U << 4)                       /*!< RW: Output selection PWM_SLAVE3 for IO[5] */
#define C_PORT_IO_CFG1_IO5_OUT_SEL_PWM_MSTR2    (4U << 4)                       /*!< RW: Output selection PWM_MASTER2 for IO[5] */
...
#define C_PORT_IO_CFG1_IO5_OUT_SEL_SPI_MOSI     (10U << 4)                      /*!< RW: Output selection SPI_MOSI for IO[5] */
#define C_PORT_IO_CFG1_IO5_OUT_SEL_SPI_MISO     (11U << 4)                      /*!< RW: Output selection SPI_MISO for IO[5] */
...
#define C_PORT_IO_CFG1_IO4_OUT_SEL_PWM_SLV3     (3U << 0)                       /*!< RW: Output selection PWM_SLAVE3 for IO[4] */
#define C_PORT_IO_CFG1_IO4_OUT_SEL_PWM_MSTR2    (4U << 0)                       /*!< RW: Output selection PWM_MASTER2 for IO[4] */
...
#define C_PORT_IO_CFG1_IO4_OUT_SEL_SPI_MOSI     (10U << 0)                      /*!< RW: Output selection SPI_MOSI for IO[4] */
#define C_PORT_IO_CFG1_IO4_OUT_SEL_SPI_MISO     (11U << 0)                      /*!< RW: Output selection SPI_MISO for IO[4] */
...
/* Block: PORT_IO_CFG2 */
/* ******************* */
extern volatile uint16_t IO_PORT_IO_CFG2 __attribute__((nodp, addr(0x00214)));  /*!< IO_PORT_IO_CFG2 */
...
#define C_PORT_IO_CFG2_IO11_OUT_SEL_PWM_SLV3    (3U << 12)                      /*!< RW: Output selection PWM_SLAVE3 for IO[11] */
#define C_PORT_IO_CFG2_IO11_OUT_SEL_PWM_MSTR2   (4U << 12)                      /*!< RW: Output selection PWM_MASTER2 for IO[11] */
...
#define C_PORT_IO_CFG2_IO11_OUT_SEL_SPI_MOSI    (10U << 12)                     /*!< RW: Output selection SPI_MOSI for IO[11] */
#define C_PORT_IO_CFG2_IO11_OUT_SEL_SPI_MISO    (11U << 12)                     /*!< RW: Output selection SPI_MISO for IO[11] */
...
#define C_PORT_IO_CFG2_IO10_OUT_SEL_PWM_SLV3    (3U << 8)                       /*!< RW: Output selection PWM_SLAVE3 for IO[10] */
#define C_PORT_IO_CFG2_IO10_OUT_SEL_PWM_MSTR2   (4U << 8)                       /*!< RW: Output selection PWM_MASTER2 for IO[10] */
...
#define C_PORT_IO_CFG2_IO10_OUT_SEL_SPI_MOSI    (10U << 8)                      /*!< RW: Output selection SPI_MOSI for IO[10] */
#define C_PORT_IO_CFG2_IO10_OUT_SEL_SPI_MISO    (11U << 8)                      /*!< RW: Output selection SPI_MISO for IO[10] */
...
#define C_PORT_IO_CFG2_IO9_OUT_SEL_PWM_SLV3     (3U << 4)                       /*!< RW: Output selection PWM_SLAVE3 for IO[9] */
#define C_PORT_IO_CFG2_IO9_OUT_SEL_PWM_MSTR2    (4U << 4)                       /*!< RW: Output selection PWM_MASTER2 for IO[9] */
...
#define C_PORT_IO_CFG2_IO9_OUT_SEL_SPI_MOSI     (10U << 4)                      /*!< RW: Output selection SPI_MOSI for IO[9] */
#define C_PORT_IO_CFG2_IO9_OUT_SEL_SPI_MISO     (11U << 4)                      /*!< RW: Output selection SPI_MISO for IO[9] */
...
#define C_PORT_IO_CFG2_IO8_OUT_SEL_PWM_SLV3     (3U << 0)                       /*!< RW: Output selection PWM_SLAVE3 for IO[8] */
#define C_PORT_IO_CFG2_IO8_OUT_SEL_PWM_MSTR2    (4U << 0)                       /*!< RW: Output selection PWM_MASTER2 for IO[8] */
...
#define C_PORT_IO_CFG2_IO8_OUT_SEL_SPI_MOSI     (10U << 0)                      /*!< RW: Output selection SPI_MOSI for IO[8] */
#define C_PORT_IO_CFG2_IO8_OUT_SEL_SPI_MISO     (11U << 0)                      /*!< RW: Output selection SPI_MISO for IO[8] */
...
/* *********************** */
extern volatile uint16_t IO_PORT_IO_UART_SEL __attribute__((nodp, addr(0x00216)));  /*!< IO_PORT_IO_UART_SEL */
...
/* **************************** */
extern volatile uint16_t IO_PORT_IO_TRIG_EDGE_CFG __attribute__((nodp, addr(0x00218)));  /*!< IO_PORT_IO_TRIG_EDGE_CFG */
...
/* ***************************** */
extern volatile uint16_t IO_PORT_IO_TRIG_EDGE_CFG1 __attribute__((nodp, addr(0x0021A)));  /*!< IO_PORT_IO_TRIG_EDGE_CFG1 */
...
/* *********************** */
extern volatile uint16_t IO_PORT_LIN_XTX_CFG __attribute__((nodp, addr(0x0021C)));  /*!< IO_PORT_LIN_XTX_CFG */
...
#define C_PORT_LIN_XTX_CFG_LIN_COLIN_RX_SEL_IO0 (0U << 5)                       /*!< RW: Input selection IO0 for Colin RX input */
#define C_PORT_LIN_XTX_CFG_LIN_COLIN_RX_SEL_IO1 (1U << 5)                       /*!< RW: Input selection IO1 for Colin RX input */
#define C_PORT_LIN_XTX_CFG_LIN_COLIN_RX_SEL_IO2 (2U << 5)                       /*!< RW: Input selection IO2 for Colin RX input */
#define C_PORT_LIN_XTX_CFG_LIN_COLIN_RX_SEL_IO3 (3U << 5)                       /*!< RW: Input selection IO3 for Colin RX input */
...
/* ********************* */
extern volatile uint16_t IO_PORT_TIMER_CFG __attribute__((nodp, addr(0x0021E)));  /*!< IO_PORT_TIMER_CFG */
...
#define M_PORT_TIMER_CFG_UNUSED                 (7U << 5)                       /*!< RW: hole to align on byte */
...
/* ********************** */
extern volatile uint16_t IO_PORT_TIMER_CFG1 __attribute__((nodp, addr(0x00220)));  /*!< IO_PORT_TIMER_CFG1 */
...
#define M_PORT_TIMER_CFG1_UNUSED                (7U << 5)                       /*!< RW: hole to align on byte */
...
/* Block: PORT_COMM_CFG */
/* ******************** */
extern volatile uint16_t IO_PORT_COMM_CFG __attribute__((nodp, addr(0x00222)));  /*!< IO_PORT_COMM_CFG */
...
/* ********************* */
extern volatile uint16_t IO_PORT_COMM_CFG1 __attribute__((nodp, addr(0x00224)));  /*!< IO_PORT_COMM_CFG1 */
...
/* Block: PORT_MISC_OUT */
/* ******************** */
extern volatile uint16_t IO_PORT_MISC_OUT __attribute__((nodp, addr(0x00226)));  /*!< IO_PORT_MISC_OUT */
#define M_PORT_MISC_OUT_SEL_TEMP                (15U << 12)                     /*!< RW: select the temperature diode input for the temp. sensor */
#define C_PORT_MISC_OUT_SEL_TEMP_VBGA           (0U << 12)                      /*!< RW: Diode inside bandgap VDDA */
#define C_PORT_MISC_OUT_SEL_TEMP_VBGD           (1U << 12)                      /*!< RW: Diode inside bandgap VDDD */
#define C_PORT_MISC_OUT_SEL_TEMP_VDDA           (2U << 12)                      /*!< RW: Diode inside regulator VDDA */
#define C_PORT_MISC_OUT_SEL_TEMP_VDDD           (3U << 12)                      /*!< RW: Diode inside regulator VDDD */
#define C_PORT_MISC_OUT_SEL_TEMP_DEIM           (4U << 12)                      /*!< No temperature diode, monitor integrity of die edge */
#define C_PORT_MISC_OUT_SEL_TEMP_ADCMUX         (11U << 12)                     /*!< Diode inside ADC multiplexer */
...
/* ********************* */
extern volatile uint16_t IO_PORT_MISC2_OUT __attribute__((nodp, addr(0x00228)));  /*!< IO_PORT_MISC2_OUT */
#define B_PORT_MISC2_OUT_VSM_LOWGAIN            (1U << 12)                      /*!< RW: Enable divisor 52 for VSM sensor (divisor 26 if the bit is zero) */
#define B_PORT_MISC2_OUT_DIS_TEMPSENSE          (1U << 11)                      /*!< RW: Value for analogue */
#define B_PORT_MISC2_OUT_VSM_FILT_ON            (1U << 10)                      /*!< RW: Enable VSM Filter */
...
#elif defined (__MLX81346B01__)
#define M_PORT_MISC2_OUT_AOUT_SUP               (3U << 6)                       /*!< RW: spare control output bits for supply system */
#define M_PORT_MISC2_OUT_VDSMON_VTH_SEL         (3U << 4)                       /*!< RW: VDS Monitor threshold selection */
#define C_PORT_MISC2_OUT_VDSMON_VTH_SEL_0       (0U << 4)                       /*!< RW: VDS Monitor threshold selection: 0.5V */
#define C_PORT_MISC2_OUT_VDSMON_VTH_SEL_1       (1U << 4)                       /*!< RW: VDS Monitor threshold selection: 1.0V */
#define C_PORT_MISC2_OUT_VDSMON_VTH_SEL_2       (2U << 4)                       /*!< RW: VDS Monitor threshold selection: 1.5V */
#define C_PORT_MISC2_OUT_VDSMON_VTH_SEL_3       (3U << 4)                       /*!< RW: VDS Monitor threshold selection: 2.0V */
#endif
#define M_PORT_MISC2_OUT_UNUSED                 (3U << 2)                       /*!< RW: Value for analogue */
#define M_PORT_MISC2_OUT_ENABLE_OSD_DRV         (3U << 0)                       /*!< RW: Enable Off-State Diagnostics Driver */

/* *********************** */
/* Block: PORT_STOPMD_CTRL */
/* *********************** */
extern volatile uint16_t IO_PORT_STOPMD_CTRL_S __attribute__((nodp, addr(0x0022A)));  /*!< IO_PORT_STOPMD_CTRL_S (System) */
#define B_PORT_STOPMD_CTRL_SEL_STOP_MODE        (1U << 0)                       /*!< RW: CPU HALT will enter STOPMODE, not SLEEP */

/* ********************** */
/* Block: PORT_STOPMD_CFG */
/* ********************** */
extern volatile uint16_t IO_PORT_STOPMD_CFG __attribute__((nodp, addr(0x0022C)));  /*!< IO_PORT_STOPMD_CFG */
...
/* Block: PORT_DIS_GTSM */
/* ******************** */
extern volatile uint16_t IO_PORT_DIS_GTSM __attribute__((nodp, addr(0x0022E)));  /*!< IO_PORT_DIS_GTSM */
#define B_PORT_DIS_GTSM_DIS_GTSM                (1U << 0)                       /*!< RW: disable GTSM, if set, HALTED will not trigger a GTSM signal */

/* ******************** */
/* Block: PORT_LIN_XCFG */
/* ******************** */
extern volatile uint16_t IO_PORT_LIN_XCFG_S __attribute__((nodp, addr(0x00230)));  /*!< IO_PORT_LIN_XCFG_S (System) */
...
/* ************************** */
extern volatile uint16_t IO_PORT_LIN_XCFG_VALID __attribute__((nodp, addr(0x00232)));  /*!< IO_PORT_LIN_XCFG_VALID */
#define M_PORT_LIN_XCFG_VALID_LIN_XCFG_VALID    (65535U << 0)                   /*!< R: Value for digital read */

/* ********************** */
/* Block: PORT_CLOCK_CTRL */
/* ********************** */
extern volatile uint16_t IO_PORT_CLOCK_CTRL_S __attribute__((nodp, addr(0x00234)));  /*!< IO_PORT_CLOCK_CTRL_S (System) */
#define B_PORT_CLOCK_CTRL_AC_SEL                (1U << 0)                       /*!< RW: switch to 16 MHz clock if set */

/* **************** */
/* Block: TRIM_MISC */
/* **************** */
extern volatile uint16_t IO_TRIM_MISC __attribute__((nodp, addr(0x00236)));     /*!< IO_TRIM_MISC */
...
/* Block: PORT_DRV_CTRL */
/* ******************** */
extern volatile uint16_t IO_PORT_DRV_CTRL __attribute__((nodp, addr(0x00238)));  /*!< IO_PORT_DRV_CTRL */
#define M_PORT_DRV_CTRL_DRV2_CTRL               (15U << 8)                      /*!< RW: Control of PWM output for phase W */
...
#define M_PORT_DRV_CTRL_DRV1_CTRL               (15U << 4)                      /*!< RW: Control of PWM output for phase V */
...
#define M_PORT_DRV_CTRL_DRV0_CTRL               (15U << 0)                      /*!< RW: Control of PWM output for phase U */
...
/* ********************* */
extern volatile uint16_t IO_PORT_DRV1_PROT __attribute__((nodp, addr(0x0023A))); /*!< IO_PORT_DRV1_PROT */
#define B_PORT_DRV1_PROT_DIS_OV_LS_VDS          (1U << 13)                      /*!< RW: Disable Low Side VDS Over-voltage HW-protection */
#define B_PORT_DRV1_PROT_OV_LS_VDS_PM           (1U << 12)                      /*!< RW: Protection mode: 0: Switch HS; 1: Tri-state */
#define B_PORT_DRV1_PROT_DIS_OV_HS_VDS          (1U << 11)                      /*!< RW: Disable High Side VDS Over-voltage HW-protection */
#define B_PORT_DRV1_PROT_OV_HS_VDS_PM           (1U << 10)                      /*!< RW: Protection mode: 0: Switch LS; 1: Tri-state */
#define B_PORT_DRV1_PROT_DIS_OC                 (1U << 9)                       /*!< RW: Disable Over Current HW-protection */
#define B_PORT_DRV1_PROT_OC_PM                  (1U << 8)                       /*!< RW: Protection mode: 0: Switch LS; 1: Tri-state */
...
/* ********************* */
extern volatile uint16_t IO_PORT_DRV2_PROT __attribute__((nodp, addr(0x0023C)));  /*!< IO_PORT_DRV2_PROT */
#define B_PORT_DRV2_PROT_FREEZE_HS              (1U << 3)                       /*!< RW: Value for analogue */
#define B_PORT_DRV2_PROT_FREEZE_LS              (1U << 2)                       /*!< RW: Value for analogue */
#define B_PORT_DRV2_PROT_EN_DRV                 (1U << 1)                       /*!< RW: Activate the driver */
#define B_PORT_DRV2_PROT_DIS_DRV                (1U << 0)                       /*!< RW: Disable drivers */

/* ********************* */
/* Block: PORT_DRV3_PROT */
/* ********************* */
extern volatile uint16_t IO_PORT_DRV3_PROT __attribute__((nodp, addr(0x0023E)));  /*!< IO_PORT_DRV3_PROT */
#define B_PORT_DRV3_PROT_DIS_OC_VDDA            (1U << 7)                       /*!< RW: Disable Over Current VDDA HW-protection */
#define B_PORT_DRV3_PROT_OC_VDDA_PM             (1U << 6)                       /*!< RW: Protection mode: 0: Switch LS; 1: Tri-state */
#define B_PORT_DRV3_PROT_DIS_OV_VDDA            (1U << 5)                       /*!< RW: Disable Over Voltage VDDA HW-protection */
#define B_PORT_DRV3_PROT_OV_VDDA_PM             (1U << 4)                       /*!< RW: Protection mode: 0: Switch LS; 1: Tri-state */
#define B_PORT_DRV3_PROT_DIS_UV_BOOST           (1U << 3)                       /*!< RW: Disable Under Voltage VBOOST HW-protection */
#define B_PORT_DRV3_PROT_UV_BOOST_PM            (1U << 2)                       /*!< RW: Protection mode: 0: Switch LS; 1: Tri-state */
#define B_PORT_DRV3_PROT_DIS_OV_BOOST           (1U << 1)                       /*!< RW: Disable Over Voltage VBOOST HW-protection */
#define B_PORT_DRV3_PROT_OV_BOOST_PM            (1U << 0)                       /*!< RW: Protection mode: 0: Switch LS; 1: Tri-state */
...
extern volatile uint16_t IO_PORT_DRV1_PROT __attribute__((nodp, addr(0x0023A))); /*!< IO_PORT_DRV1_PROT */
#define B_PORT_DRV1_PROT_DIS_OV_LS_VDS          (1U << 13)                      /*!< RW: Disable Low Side VDS Over-voltage HW-protection */
#define B_PORT_DRV1_PROT_OV_LS_VDS_PM           (1U << 12)                      /*!< RW: Protection mode: 0: Tri-state; 1: Switch HS */
#define B_PORT_DRV1_PROT_DIS_OV_HS_VDS          (1U << 11)                      /*!< RW: Disable High Side VDS Over-voltage HW-protection */
#define B_PORT_DRV1_PROT_OV_HS_VDS_PM           (1U << 10)                      /*!< RW: Protection mode: 0: Tri-state; 1: Switch LS */
#define B_PORT_DRV1_PROT_DIS_OC                 (1U << 9)                       /*!< RW: Disable Over Current HW-protection */
#define B_PORT_DRV1_PROT_OC_PM                  (1U << 8)                       /*!< RW: Protection mode: 0: Tri-state; 1: Switch HS */
#define B_PORT_DRV1_PROT_DIS_UV_VDDA            (1U << 7)                       /*!< RW: Disable Under Voltage VDDA HW-protection */
...
/* ********************* */
extern volatile uint16_t IO_PORT_DRV2_PROT __attribute__((nodp, addr(0x0023C)));  /*!< IO_PORT_DRV2_PROT */
#define M_PORT_DRV2_PROT_FREEZE_HS              (7U << 5)                       /*!< RW: Freeze HS to inactive (in analogue interlock logic), PWM applies to LS only */
#define M_PORT_DRV2_PROT_FREEZE_LS              (7U << 2)                       /*!< RW: Freeze LS to inactive (in analogue interlock logic), PWM applies to HS only */
#define B_PORT_DRV2_PROT_EN_DRV                 (1U << 1)                       /*!< RW: Value for analogue */
#define B_PORT_DRV2_PROT_DIS_DRV                (1U << 0)                       /*!< RW: Disable drivers */
...
extern volatile uint16_t IO_PORT_DRV3_PROT __attribute__((nodp, addr(0x0023E)));  /*!< IO_PORT_DRV3_PROT */
#define B_PORT_DRV3_PROT_DIS_OC_VDDA            (1U << 7)                       /*!< RW: Disable Over Current VDDA HW-protection */
#define B_PORT_DRV3_PROT_OC_VDDA_PM             (1U << 6)                       /*!< RW: Protection mode: 0: Tri-state; 1: Switch LS */
#define B_PORT_DRV3_PROT_DIS_OV_VDDA            (1U << 5)                       /*!< RW: Disable Over Voltage VDDA HW-protection */
#define B_PORT_DRV3_PROT_OV_VDDA_PM             (1U << 4)                       /*!< RW: Protection mode: 0: Tri-state; 1: Switch LS */
#define B_PORT_DRV3_PROT_DIS_UV_BOOST           (1U << 3)                       /*!< RW: Disable Under Voltage VBOOST HW-protection */
#define B_PORT_DRV3_PROT_UV_BOOST_PM            (1U << 2)                       /*!< RW: Protection mode: 0: Tri-state; 1: Switch LS */
#define B_PORT_DRV3_PROT_DIS_OV_BOOST           (1U << 1)                       /*!< RW: Disable Over Voltage VBOOST HW-protection */
#define B_PORT_DRV3_PROT_OV_BOOST_PM            (1U << 0)                       /*!< RW: Protection mode: 0: Tri-state; 1: Switch LS */
#endif

/* ****************** */
/* Block: PORT_DRV_IN */
/* ****************** */
extern volatile uint16_t IO_PORT_DRV_IN __attribute__((nodp, addr(0x00240)));   /*!< IO_PORT_DRV_IN */
#define B_PORT_DRV_IN_OV_LS_VDS2_IT             (1U << 11)                      /*!< R: After filtering and masking */
#define B_PORT_DRV_IN_OV_LS_VDS1_IT             (1U << 10)                      /*!< R: After filtering and masking */
#define B_PORT_DRV_IN_OV_LS_VDS0_IT             (1U << 9)                       /*!< R: After filtering and masking */
#define M_PORT_DRV_IN_OV_LS_VDS_SYNC            (7U << 6)                       /*!< R: Before digital filtering */
#define B_PORT_DRV_IN_OV_HS_VDS2_IT             (1U << 5)                       /*!< R: After filtering and masking */
#define B_PORT_DRV_IN_OV_HS_VDS1_IT             (1U << 4)                       /*!< R: After filtering and masking */
#define B_PORT_DRV_IN_OV_HS_VDS0_IT             (1U << 3)                       /*!< R: After filtering and masking */
#define M_PORT_DRV_IN_OV_HS_VDS_SYNC            (7U << 0)                       /*!< R: Before digital filtering */

/* ******************* */
/* Block: PORT_DIAG_IN */
/* ******************* */
extern volatile uint16_t IO_PORT_DIAG_IN __attribute__((nodp, addr(0x00242)));  /*!< IO_PORT_DIAG_IN */
#define M_PORT_DIAG_IN_OV_LS_VDS_MEM            (7U << 12)                      /*!< R: Cleared if dis_ov_ls_vds */
#define M_PORT_DIAG_IN_OV_HS_VDS_MEM            (7U << 9)                       /*!< R: Cleared if dis_ov_hs_vds */
#define B_PORT_DIAG_IN_OV_BOOST_MEM             (1U << 8)                       /*!< R: Cleared if dis_ov_boost */
#define B_PORT_DIAG_IN_UV_BOOST_MEM             (1U << 7)                       /*!< R: Cleared if dis_uv_boost */
#define B_PORT_DIAG_IN_OC_VDDA_MEM              (1U << 6)                       /*!< R: Cleared if dis_oc_vdda */
#define B_PORT_DIAG_IN_OVC_MEM                  (1U << 5)                       /*!< R: Cleared if dis_oc */
#define B_PORT_DIAG_IN_OV_VDDA_MEM              (1U << 4)                       /*!< R: Cleared if dis_ov_vdda */
...
/* *********************** */
/* Block: PORT_DIV_VDS_DEB */
/* *********************** */
extern volatile uint16_t IO_PORT_DIV_VDS_DEB __attribute__((nodp, addr(0x00244)));  /*!< IO_PORT_DIV_VDS_DEB */
#define M_PORT_DIV_VDS_DEB_DIV_VDS              (7U << 0)                       /*!< RW: VDS debounce pre-divider; time = system clock period * 2^DIV*CNT */

/* *********************** */
/* Block: PORT_CNT_VDS_DEB */
/* *********************** */
extern volatile uint16_t IO_PORT_CNT_VDS_DEB __attribute__((nodp, addr(0x00246)));  /*!< IO_PORT_CNT_VDS_DEB */
#define M_PORT_CNT_VDS_DEB_CNT2_VDS             (15U << 8)                      /*!< RW: VDS debounce for phase W, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_VDS_DEB_CNT1_VDS             (15U << 4)                      /*!< RW: VDS debounce for phase V, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_VDS_DEB_CNT0_VDS             (15U << 0)                      /*!< RW: VDS debounce for phase U, counter setting; time = system clock period * 2^DIV*CNT */

/* ************************ */
/* Block: PORT_DIV_MASK_VDS */
/* ************************ */
extern volatile uint16_t IO_PORT_DIV_MASK_VDS __attribute__((nodp, addr(0x00248)));  /*!< IO_PORT_DIV_MASK_VDS */
#define M_PORT_DIV_MASK_VDS_DIV_MASK_VDS        (15U << 0)                      /*!< RW: VDS mask pre-divider; time = system clock period * 2^DIV*CNT */

/* *************************** */
/* Block: PORT_CNT_MASK_VDS_LS */
/* *************************** */
extern volatile uint16_t IO_PORT_CNT_MASK_VDS_LS __attribute__((nodp, addr(0x0024A)));  /*!< IO_PORT_CNT_MASK_VDS_LS */
#define M_PORT_CNT_MASK_VDS_LS_CNT_MASK2_VDS_LS (15U << 8)                      /*!< RW: VDS LS mask for W, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_MASK_VDS_LS_CNT_MASK1_VDS_LS (15U << 4)                      /*!< RW: VDS LS mask for V, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_MASK_VDS_LS_CNT_MASK0_VDS_LS (15U << 0)                      /*!< RW: VDS LS mask for U, counter setting; time = system clock period * 2^DIV*CNT */

/* *************************** */
/* Block: PORT_CNT_MASK_VDS_HS */
/* *************************** */
extern volatile uint16_t IO_PORT_CNT_MASK_VDS_HS __attribute__((nodp, addr(0x0024C)));  /*!< IO_PORT_CNT_MASK_VDS_HS */
#define M_PORT_CNT_MASK_VDS_HS_CNT_MASK2_VDS_HS (15U << 8)                      /*!< RW: VDS HS mask for W, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_MASK_VDS_HS_CNT_MASK1_VDS_HS (15U << 4)                      /*!< RW: VDS HS mask for V, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_MASK_VDS_HS_CNT_MASK0_VDS_HS (15U << 0)                      /*!< RW: VDS HS mask for U, counter setting; time = system clock period * 2^DIV*CNT */

/* ******************** */
/* Block: PORT_DIV_EILD */
/* ******************** */
extern volatile uint16_t IO_PORT_DIV_EILD __attribute__((nodp, addr(0x0024E)));  /*!< IO_PORT_DIV_EILD */
#define M_PORT_DIV_EILD_DIV_EILD                (7U << 0)                       /*!< RW: External interlock delay pre-divider; time = system clock period * 2^DIV*CNT */

/* ************************** */
/* Block: PORT_CNT_EILD_LSOFF */
/* ************************** */
extern volatile uint16_t IO_PORT_CNT_EILD_LSOFF __attribute__((nodp, addr(0x00250)));  /*!< IO_PORT_CNT_EILD_LSOFF */
#define M_PORT_CNT_EILD_LSOFF_CNT_EILD2_LSOFF   (15U << 8)                      /*!< RW: EIDL for phase W, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_EILD_LSOFF_CNT_EILD1_LSOFF   (15U << 4)                      /*!< RW: EIDL for phase V, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_EILD_LSOFF_CNT_EILD0_LSOFF   (15U << 0)                      /*!< RW: EIDL for phase U, counter setting; time = system clock period * 2^DIV*CNT */

/* ************************** */
/* Block: PORT_CNT_EILD_HSOFF */
/* ************************** */
extern volatile uint16_t IO_PORT_CNT_EILD_HSOFF __attribute__((nodp, addr(0x00252)));  /*!< IO_PORT_CNT_EILD_HSOFF */
#define M_PORT_CNT_EILD_HSOFF_CNT_EILD2_HSOFF   (15U << 8)                      /*!< RW: EIDL for phase W, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_EILD_HSOFF_CNT_EILD1_HSOFF   (15U << 4)                      /*!< RW: EIDL for phase V, counter setting; time = system clock period * 2^DIV*CNT */
#define M_PORT_CNT_EILD_HSOFF_CNT_EILD0_HSOFF   (15U << 0)                      /*!< RW: EIDL for phase U, counter setting; time = system clock period * 2^DIV*CNT */

/* **************** */
/* Block: TRIM_IILD */
/* **************** */
extern volatile uint16_t IO_TRIM_IILD __attribute__((nodp, addr(0x00254)));     /*!< IO_TRIM_IILD */
#define B_TRIM_IILD_LOCK                        (1U << 15)                      /*!< RW: Lock the port. Write is invalid when set */
#define M_TRIM_IILD_CNT_IILD                    (15U << 0)                      /*!< RW: Calibration. Write is invalid if LOCK is set */

/* ****************** */
/* Block: PORT_CDI_IN */
/* ****************** */
extern volatile uint16_t IO_PORT_CDI_IN __attribute__((nodp, addr(0x00256)));   /*!< IO_PORT_CDI_IN */
#define M_PORT_CDI_IN_CDI                       (7U << 0)                       /*!< R: Current direction indicator bits */

/* ******************** */
/* Block: PORT_I2C_CONF */
/* ******************** */
extern volatile uint16_t IO_PORT_I2C_CONF __attribute__((nodp, addr(0x00258)));  /*!< IO_PORT_I2C_CONF */
...
/* ************************** */
extern volatile uint16_t IO_PORT_I2C_DMA_OFFSET __attribute__((nodp, addr(0x0025A)));  /*!< IO_PORT_I2C_DMA_OFFSET */
...
/* *************************** */
extern volatile uint16_t IO_PORT_I2C_READ_OFFSET __attribute__((nodp, addr(0x0025C)));  /*!< IO_PORT_I2C_READ_OFFSET */
...
/* ********************* */
extern volatile uint16_t IO_PORT_MISC_TEST __attribute__((nodp, addr(0x0025E)));  /*!< IO_PORT_MISC_TEST */
#define B_PORT_MISC_TEST_TST_CS_DAC             (1U << 12)                      /*!< RW: switch the current sensor DAC to TA0 */
...
/* ********************** */
extern volatile uint16_t IO_PORT_MISC2_TEST __attribute__((nodp, addr(0x00260)));  /*!< IO_PORT_MISC2_TEST */
#if defined __MLX81346B01__
#define B_PORT_MISC2_TEST_ADC_BLOCK_TOGGLE      (1U << 7)                       /*!< RW: ADC Block toggle test */
#endif /* defined __MLX81346B01__ */
#define M_PORT_MISC2_TEST_VDDD_VT_MONITOR_TEST  (1U << 6)                       /*!< RW: Add for 81346 */
#define M_PORT_MISC2_TEST_VDDD_VT_MONITOR_NOTEST (1U << 5)                      /*!< RW: Add for 81346 */
...
/* ************************* */
extern volatile uint16_t IO_PORT_PPM_RBASE_ADD __attribute__((nodp, addr(0x00262)));  /*!< IO_PORT_PPM_RBASE_ADD */
...
/* ************************* */
extern volatile uint16_t IO_PORT_PPM_TBASE_ADD __attribute__((nodp, addr(0x00264)));  /*!< IO_PORT_PPM_TBASE_ADD */
...
/* *********************** */
extern volatile uint16_t IO_PORT_PPM_TIMEOUT __attribute__((nodp, addr(0x00266)));  /*!< IO_PORT_PPM_TIMEOUT */
#define M_PORT_PPM_TIMEOUT_PPM_TIMEOUT          (65535U << 0)                   /*!< RW: Timeout value */

/* ******************** */
/* Block: PORT_PPM_CTRL */
/* ******************** */
extern volatile uint16_t IO_PORT_PPM_CTRL __attribute__((nodp, addr(0x00268)));  /*!< IO_PORT_PPM_CTRL */
#define M_PORT_PPM_CTRL_PPM_IN_SEL              (15U << 11)                     /*!< RW: IO or LIN_XRX for PPM input */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO11         (12U << 11)                     /*!< IO_IN[11] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO10         (11U << 11)                     /*!< IO_IN[10] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO9          (10U << 11)                     /*!< IO_IN[9] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO8          (9U << 11)                      /*!< IO_IN[8] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO7          (8U << 11)                      /*!< IO_IN[7] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO6          (7U << 11)                      /*!< IO_IN[6] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO5          (6U << 11)                      /*!< IO_IN[5] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO4          (5U << 11)                      /*!< IO_IN[4] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO3          (4U << 11)                      /*!< IO_IN[3] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO2          (3U << 11)                      /*!< IO_IN[2] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO1          (2U << 11)                      /*!< IO_IN[1] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_IO0          (1U << 11)                      /*!< IO_IN[0] */
#define C_PORT_PPM_CTRL_PPM_IN_SEL_LIN_XRX      (0U << 11)                      /*!< LIN_XRX */
...
/* ************************ */
extern volatile uint16_t IO_PORT_PPM_BUF_DATA __attribute__((nodp, addr(0x0026A)));  /*!< IO_PORT_PPM_BUF_DATA */
#define M_PORT_PPM_BUF_DATA_PPM_BUF_DATA        (65535U << 0)                   /*!< R: Value for digital read */

/* **************** */
/* Block: PPM_TIMER */
/* **************** */
extern volatile uint16_t IO_PPM_TIMER __attribute__((nodp, addr(0x0026C)));     /*!< IO_PPM_TIMER */
#define M_PPM_TIMER_PPM_ON_TIME                 (65535U << 0)                   /*!< RW: PPM On Time for TX mode */

/* ********************* */
/* Block: PORT_PPM_FLAGS */
/* ********************* */
extern volatile uint16_t IO_PORT_PPM_FLAGS __attribute__((nodp, addr(0x0026E)));  /*!< IO_PORT_PPM_FLAGS */
...
#define B_PORT_UDMA0_CTRL_UART0_STOP_MODE       (1U << 4)                       /*!< RW: Relaxed UART stop bit sampling is active when =1 (rising edge is allowed anywhere in the bit time) */
...
#define B_PORT_UDMA0_STATUS_UDMA0_FTR           (1U << 2)                       /*!< R: Frame transmit ready (cleared at begin of transmission and set (1) after end of frame */
#define B_PORT_UDMA0_STATUS_UDMA0_FRC           (1U << 1)                       /*!< R: Frame received */
...
#define B_PORT_UDMA1_CTRL_UART1_STOP_MODE       (1U << 4)                       /*!< RW: Relaxed UART stop bit sampling is active when =1 (rising edge is allowed anywhere in the bit time) */
...
#define B_PORT_UDMA1_STATUS_UDMA1_FTR           (1U << 2)                       /*!< R: Frame transmit ready (cleared at begin of transmission and set (1) after end of frame */
#define B_PORT_UDMA1_STATUS_UDMA1_FRC           (1U << 1)                       /*!< R: Frame received */
#define B_PORT_UDMA1_STATUS_UDMA1_RD_BUFFER_VALID (1U << 0)                     /*!< R: Read buffer 'A' is valid (1) or Read buffer 'B' is valid (0) */

/* ********************* */
/* Block: PORT_CURR_SENS */
/* ********************* */
extern volatile uint16_t IO_PORT_CURR_SENS __attribute__((nodp, addr(0x002A2)));  /*!< IO_PORT_CURR_SENS */
#if defined (__MLX81346B01__)
#define B_PORT_CURR_SENS_CSA_BYPASS             (1U << 13)                      /*!< RW: bypasses the current sense amplifier and gives effectively gain 1 */
#define B_PORT_CURR_SENS_CSA_CHOP               (1U  < 12)                      /*!< RW: exchanges the IS_N and IS_P inputs at the current sensor amplfier for offset measurement */
#endif
#define B_PORT_CURR_SENS_EN_OC                  (1U << 11)                      /*!< RW: enable the over-current comparator */
#define B_PORT_CURR_SENS_CSA_HIGHGAIN           (1U << 10)                      /*!< RW: enable gain 20 of the current sensor amplifier (gain 10 if bit is 0) */
#define B_PORT_CURR_SENS_CSA_ZERO               (1U << 9)                       /*!< RW: set the current sensor to 0 */
#define B_PORT_CURR_SENS_EN_CSA                 (1U << 8)                       /*!< RW: current sensor enable */
#define M_PORT_CURR_SENS_SET_CS                 (255U << 0)                     /*!< RW: set the level of the current sensor */

/* ************** */
/* Block: PORT_CP */
/* ************** */
extern volatile uint16_t IO_PORT_CP __attribute__((nodp, addr(0x002A4)));       /*!< IO_PORT_CP */
#define B_PORT_CP_CP_TRI                        (1U << 2)                       /*!< RW: Tri-state CP output (0 = Normal, 1 = Tri-state) */
#define B_PORT_CP_SET_CPDRV                     (1U << 1)                       /*!< RW: Software-Clock (toggling) */
#define B_PORT_CP_EN_CP                         (1U << 0)                       /*!< RW: Enable Charge Pump (0 = Disabled, 1 = Enabled) */

/* ************** */
/* Block: TRIM_CP */
/* ************** */
extern volatile uint16_t IO_TRIM_CP __attribute__((nodp, addr(0x002A6)));       /*!< IO_TRIM_CP */
#define B_TRIM_CP_LOCK                          (1U << 15)                      /*!< RW: Lock the port. Write is invalid when set */
#define M_TRIM_CP_TR_CP                         (15U << 4)                      /*!< RW: CP Level calibration */
#define M_TRIM_CP_TR_RCO50K                     (15U << 0)                      /*!< RW: CP clock calibration (7 = Software-clock selection) */

/* ***************** */
/* Block: ACTIVE_CDI */
/* ***************** */
extern volatile uint16_t IO_ACTIVE_CDI __attribute__((nodp, addr(0x002A8)));    /*!< IO_ACTIVE_CDI */
#define B_IO_ACTIVE_CDI_CDI_FET_SWITCH_ALL      (1U << 15)                      /*!< RW: The phase selection can be overwritten by a bit CDI_FET_SWITCH_ALL. When this bit is set, every rising edge at any HSON[x]/LSON[x] control signal will restart the mask window */
#define B_IO_ACTIVE_CDI_ACTIVE_CDI_CLK_PREDIV2  (1U << 14)                      /*!< RW: Clock pre-divider for Active CDI, Active CDI clock period=2*(2^ACTIVE_CDI_PREDIV2 * (ACTIVE_CDI_CLK_DIV+1) * MCU period */
#define M_IO_ACTIVE_CDI_ACTIVE_CDI_EDGE_SEL     (3U << 12)                      /*!< RW: Edge selection for the ACTIVE CDI interrupt */
#define C_IO_ACTIVE_CDI_ACTIVE_CDI_EDGE_SEL_RISE (0U << 12)                     /*!< RW: Rising edge selection for the ACTIVE CDI interrupt */
#define C_IO_ACTIVE_CDI_ACTIVE_CDI_EDGE_SEL_FALL (1U << 12)                     /*!< RW: Falling edge selection for the ACTIVE CDI interrupt */
#define C_IO_ACTIVE_CDI_ACTIVE_CDI_EDGE_SEL_BOTH (2U << 12)                     /*!< RW: Both edge selection for the ACTIVE CDI interrupt */
#define M_IO_ACTIVE_CDI_ACTIVE_CDI_MSK          (15U << 8)                      /*!< RW: Active CDI masking time in periods of active CDI clock from 0 to 15 */
#define M_IO_ACTIVE_CDI_ACTIVE_CDI_DEB          (3U << 6)                       /*!< RW: Active CDI debounce time in periods of active CDI clock (0x=0, 01=1..2, 10=2..3 periods) */
#define M_IO_ACTIVE_CDI_ACTIVE_CDI_CLK_DIV      (15U << 2)                      /*!< RW: Clock divider for Active CDI, Active CDI clock period=2*(2^ACTIVE_CDI_PREDIV2 * (ACTIVE_CDI_CLK_DIV+1) * MCU period */
#define M_IO_ACTIVE_CDI_ACTIVE_CDI_PHASE        (3U << 0)                       /*!< RW: Select the phase for the Active CDI measurement */
#define C_IO_ACTIVE_CDI_ACTIVE_CDI_PHASE_DIS    (0U << 0)                       /*!< RW: Disabled */
#define C_IO_ACTIVE_CDI_ACTIVE_CDI_PHASE_U      (1U << 0)                       /*!< RW: Phase U */
#define C_IO_ACTIVE_CDI_ACTIVE_CDI_PHASE_V      (2U << 0)                       /*!< RW: Phase V */
#define C_IO_ACTIVE_CDI_ACTIVE_CDI_PHASE_W      (3U << 0)                       /*!< RW: Phase W */

/* ******************** */
/* Block: ACTIVE_CDI_IN */
/* ******************** */
extern volatile uint16_t IO_ACTIVE_CDI_IN __attribute__((nodp, addr(0x002AA)));  /*!< IO_ACTIVE_CDI_IN */
#define B_ACTIVE_CDI_IN_VALID                   (1U << 1)                       /*!< R: After filtering and masking */
#define B_ACTIVE_CDI_IN_COMP_SYNC               (1U << 0)                       /*!< R: Before digital filtering */

#endif /* defined (__MLX81346__) */
