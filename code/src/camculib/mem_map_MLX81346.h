/*!*************************************************************************** *
 * \file        mem_map_MLX81346.h
 * \brief       MLX81346 Memory-map
 *
...
#ifndef MEM_MAP_MLX81346_H
#define MEM_MAP_MLX81346_H
...
#define C_ROM_MLX4_BIST_CRC         0x00CBB7ECUL                                /*!< MLX4 ROM BIST Checksum */
#endif
...
typedef struct
{
    ...
    uint16_t u8App_TRIM06_Unused            : 8;                                /**< 0x0C: Reserved */
    uint16_t u8App_TRIM06_O_VBOOST64_MSB    : 8;                                /**< 0x0D: Offset of VBOOST/64 input at mid temperature [12 bit unsigned] (MSB) */
    ...
    int8_t i8App_TRIM12_GainLo_VPHASE52     : 8;                                /**< 0x18: Gain-change of Vphase/52 input over low temperature [8bit signed] */
    int8_t i8App_TRIM12_GainHi_VPHASE52     : 8;                                /**< 0x19: Gain-change of Vphase/52 input over high temperature [8bit signed] */
    uint16_t u12App_TRIM13_Gain_VPHASE52    : 12;                               /**< 0x1A: Gain of Vphase/52 input [12 bit unsigned] */
    uint16_t u4App_TRIM13_O_VPHASE52_LSB    : 4;                                /**< 0x1B: Offset of Vphase/52 input [12 bit unsigned] (LSB) */
    uint16_t u8App_TRIM14_O_VPHASE52_MSB    : 8;                                /**< 0x1C: Offset of Vphase/52 input [12 bit unsigned] (MSB) */
    int8_t i8App_TRIM14_GainLo_VSMF52       : 8;                                /**< 0x1D: Gain-change of VSMF/52 input over low temperature [8bit signed] */
    int8_t i8App_TRIM15_GainHi_VSMF52       : 8;                                /**< 0x1E: Gain-change of VSMF/52 input over high temperature [8bit signed] */
    uint16_t u8App_TRIM15_Gain_VSMF52_LSB   : 8;                                /**< 0x1F: Gain of VSMF/52 at mid temperature [12 bit unsigned] (LSB) */
    uint16_t u4App_TRIM16_Gain_VSMF52_MSB   : 4;                                /**< 0x20: Gain of VSMF/52 at mid temperature [12 bit unsigned] (MSB) */
    uint16_t u12App_TRIM16_O_VSMF52         : 12;                               /**< 0x21: Offset of VSMF/52 at mid temperature [12 bit unsigned] */
    uint16_t u16App_TRIM17_Reserved;                                            /**< 0x22: Reserved */
    ...
    int8_t i8App_TRIM36_GainLo_VBOOST64     : 8;                                /**< 0x48: Gain-change of VBOOST/64 input over low temperature range [8 bit unsigned] */
    int8_t i8App_TRIM36_GainHi_VBOOST64     : 8;                                /**< 0x49: Gain-change of VBOOST/64 input over high temperature range [8 bit unsigned] */
    uint16_t u12App_TRIM37_Gain_VBOOST64    : 12;                               /**< 0x4A: Gain of VBOOST/64 input at mid temperature [12 bit unsigned] */
    uint16_t u4App_TRIM37_O_VBOOST64_LSB    : 4;                                /**< 0x4B: Offset of VBOOST/64 input at mid temperature [12 bit unsigned] (LSB) */
