/*!*************************************************************************** *
 * \file        ioports_MLX81334.h
 * \brief       MLX81334A I/O-ports-map
 *
 * \note        project MLX81334
 *
 * \author      Marcel Braat
 *
 * \date        2021-12-02
...
#ifndef __MLX81334A01__
#error "Wrong ioports.h file"
#endif /* __MLX81334A01__ */
...
/* Block: MLX16 */
/* ************ */
extern volatile uint16_t IO_MLX16_DBG_DATA0_S __attribute__((nodp, addr(0x00038)));  /*!< IO_MLX16_DBG_DATA0 */
...
#define M_MLX16_ITC_PEND4                       (15U << 0)                       /*!< R: 1 If the interrupt[INT0_COUNT+xx:INT0_COUNT+64] is pending; W: Write 1 to clear pending interrupt, 0 does nothing */
#define B_MLX16_ITC_PEND4_TX_TIMEROUT           (1U << 0)                       /*!< 0x0230 */
#define B_MLX16_ITC_PEND4_I2C_EOW               (1U << 1)                       /*!< 0x0238 */
#define B_MLX16_ITC_PEND4_I2C_EOR               (1U << 2)                       /*!< 0x0240 */
#define B_MLX16_ITC_PEND4_MLX16_SOFT            (1U << 3)                       /*!< 0x0248 */
...
#define M_MLX16_ITC_MASK4                       (15U << 0)                      /*!< RW: 1 to enable interrupt[INT0_COUNT+79:INT0_COUNT+64]  */
#define B_MLX16_ITC_MASK4_TX_TIMEROUT           (1U << 0)                       /*!< 0x0230 */
#define B_MLX16_ITC_MASK4_I2C_EOW               (1U << 1)                       /*!< 0x0238 */
#define B_MLX16_ITC_MASK4_I2C_EOR               (1U << 2)                       /*!< 0x0240 */
#define B_MLX16_ITC_MASK4_MLX16_SOFT            (1U << 3)                       /*!< 0x0248 */
...
#define M_MLX16_ITC_PRIO5                       (16383U << 0)                   /*!< RW: Configure priority for interrupt[INT0_COUNT+INT1_COUNT+INT2_COUNT+47:INT0_COUNT+INT1_COUNT+INT2_COUNT+40] */
...
#define M_MLX16_ITC_PRIO5_I2C_EOW               (3U << 10)                      /*!< RW: priority I2C EOW */
#define C_MLX16_ITC_PRIO5_I2C_EOW_PRIO3         (0U << 10)                      /*!< RW: priority 3 I2C EOW */
#define C_MLX16_ITC_PRIO5_I2C_EOW_PRIO4         (1U << 10)                      /*!< RW: priority 4 I2C EOW */
#define C_MLX16_ITC_PRIO5_I2C_EOW_PRIO5         (2U << 10)                      /*!< RW: priority 5 I2C EOW */
#define C_MLX16_ITC_PRIO5_I2C_EOW_PRIO6         (3U << 10)                      /*!< RW: priority 6 I2C EOW */
#define M_MLX16_ITC_PRIO5_I2C_EOR               (3U << 12)                      /*!< RW: priority I2C EOR */
#define C_MLX16_ITC_PRIO5_I2C_EOR_PRIO3         (0U << 12)                      /*!< RW: priority 3 I2C EOR */
#define C_MLX16_ITC_PRIO5_I2C_EOR_PRIO4         (1U << 12)                      /*!< RW: priority 4 I2C EOR */
#define C_MLX16_ITC_PRIO5_I2C_EOR_PRIO5         (2U << 12)                      /*!< RW: priority 5 I2C EOR */
#define C_MLX16_ITC_PRIO5_I2C_EOR_PRIO6         (3U << 12)                      /*!< RW: priority 6 I2C EOR */
...
/* ADC Calibrated channel & reference combinations */
...
#define M_PORT_LIN_XCFG_VALID_LIN_XCFG_VALID    (65535U << 0)                   /*!< R: mirrors the port LIN_XCFG as long as the LIN_XKEY is valid, else it is cleared to all 0 */
...
#define B_PORT_LINAA2_LCD_DIS_LINAA             (1U << 4)                       /*!< RW: Disable LINAA diagnosis current source to avoid DC current out of VDDA (testmode) */
#define B_PORT_LINAA2_LCD_ON_LINAA              (1U << 3)                       /*!< RW: Activate the LINAA diagnosis current source */
...
#define M_PORT_PPM_BUF_DATA_PPM_BUF_DATA        (65535U << 0)                   /*!< R: PPM buffer data */
...
/* ********************* */
extern volatile uint16_t IO_PORT_UDMA_CTRL __attribute__((nodp, addr(0x0024C)));  /*!< IO_PORT_UDMA_CTRL */
