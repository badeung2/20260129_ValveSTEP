...
typedef struct io_mlx16_s {
    ...
    union {
        ...
        struct {
            ...
            uint16_t OVT_PEND : 1;
            uint16_t OVC1_PEND : 1;
            uint16_t OVC2_PEND : 1;
    ...
    union {
        ...
        struct {
            ...
            uint16_t PWM_SLAVE4_CMP_PEND : 1;
        };
    };
    union {
        uint16_t ITC_PEND2;
    ...
    union {
        ...
        struct {
            ...
            uint16_t PH_IN0_PEND : 1;
            uint16_t PH_IN1_PEND : 1;
            uint16_t PH_IN2_PEND : 1;
            uint16_t PH_IN3_PEND : 1;
        };
    };
    union {
        uint16_t ITC_PEND5 : 4;
        struct {
            uint16_t PH_IN4_PEND : 1;
            uint16_t PH_IN5_PEND : 1;
            uint16_t I2C_MST_PEND : 1;
            uint16_t MLX16_SOFT_PEND : 1;
            uint16_t reserved_276 : 12;
        };
    };
    ...
    union {
        ...
        struct {
            ...
            uint16_t PH_IN0_ITC : 1;
            uint16_t PH_IN1_ITC : 1;
            uint16_t PH_IN2_ITC : 1;
            uint16_t PH_IN3_ITC : 1;
        };
    };
    union {
        uint16_t ITC_MASK5 : 4;
        struct {
            uint16_t PH_IN4_ITC : 1;
            uint16_t PH_IN5_ITC : 1;
            uint16_t I2C_MST_ITC : 1;
            uint16_t MLX16_SOFT_ITC : 1;
            uint16_t reserved_500 : 12;
        };
    };
    ...
    union {
        ...
        struct {
            ...
            uint16_t PWM_SLAVE4_CMP_PRIO : 2;
    ...
    union {
        ...
        struct {
            ...
            uint16_t PH_IN0_PRIO : 2;
            uint16_t PH_IN1_PRIO : 2;
        };
    };
    union {
        uint16_t ITC_PRIO8 : 10;
        struct {
            uint16_t PH_IN2_PRIO : 2;
            uint16_t PH_IN3_PRIO : 2;
            uint16_t PH_IN4_PRIO : 2;
            uint16_t PH_IN5_PRIO : 2;
            uint16_t I2C_MST_PRIO : 2;
            uint16_t reserved_778 : 6;
        };
    };
...
extern volatile io_pwm_master2_t PWM_MASTER2 __attribute__((nodp, addr(0x152)));
...
extern volatile io_pwm_slave3_t PWM_SLAVE3 __attribute__((nodp, addr(0x15c)));

typedef struct io_pwm_slave4_s {
    uint16_t CMP;
    uint16_t HT;
    uint16_t LT;
    const uint16_t PER;
...
extern volatile io_pwm_slave4_t PWM_SLAVE4 __attribute__((nodp, addr(0x166)));
...
extern volatile io_adc_block_t ADC_BLOCK __attribute__((nodp, addr(0x170)));
...
extern volatile io_eeprom_flash_t EEPROM_FLASH __attribute__((nodp, addr(0x1a0)));
...
extern volatile io_colin_t COLIN __attribute__((nodp, addr(0x1d6)));
...
extern volatile io_trim_bg_bias_t TRIM_BG_BIAS __attribute__((nodp, addr(0x1f0)));

typedef struct io_trim_vdd_s {
    uint16_t TR_VDDA : 3;
    uint16_t TR_VDDD : 3;
    uint16_t TR_SUP : 4;
    uint16_t reserved_10 : 5;
    uint16_t LOCK : 1;
} io_trim_vdd_t;

extern volatile io_trim_vdd_t TRIM_VDD __attribute__((nodp, addr(0x1f2)));
...
extern volatile io_trim_rco32m_t TRIM_RCO32M __attribute__((nodp, addr(0x1f4)));
...
extern volatile io_trim_rco1m_t TRIM_RCO1M __attribute__((nodp, addr(0x1f6)));
...
extern volatile io_port_sscm_conf_t PORT_SSCM_CONF __attribute__((nodp, addr(0x1f8)));
...
extern volatile io_port_step_conf_t PORT_STEP_CONF __attribute__((nodp, addr(0x1fa)));
...
extern volatile io_port_supp_test_t PORT_SUPP_TEST __attribute__((nodp, addr(0x1fc)));
...
extern volatile io_port_supp2_test_t PORT_SUPP2_TEST __attribute__((nodp, addr(0x1fe)));

typedef struct io_port_lin_test_s {
    uint16_t TEST_2U8_BIASLIN : 1;
} io_port_lin_test_t;

extern volatile io_port_lin_test_t PORT_LIN_TEST __attribute__((nodp, addr(0x200)));

typedef struct io_port_spare_test_s {
    uint16_t TST_CPCLK_SEL : 3;
    uint16_t TEST_SUP : 5;
} io_port_spare_test_t;

extern volatile io_port_spare_test_t PORT_SPARE_TEST __attribute__((nodp, addr(0x202)));

typedef struct io_port_io_in_s {
    const uint16_t IO_IN_SYNC : 12;
} io_port_io_in_t;

extern volatile io_port_io_in_t PORT_IO_IN __attribute__((nodp, addr(0x204)));
...
typedef struct io_port_supp_in_s {
    ...
    const uint16_t OVC1_IT : 1;
    const uint16_t OVC2_IT : 1;
    const uint16_t OVC1_SYNC : 1;
    const uint16_t OVC2_SYNC : 1;
...
extern volatile io_port_supp_in_t PORT_SUPP_IN __attribute__((nodp, addr(0x206)));
...
extern volatile io_port_supp2_in_t PORT_SUPP2_IN __attribute__((nodp, addr(0x208)));
...
extern volatile io_port_misc_in_t PORT_MISC_IN __attribute__((nodp, addr(0x20a)));
...
extern volatile io_port_supp_cfg_t PORT_SUPP_CFG __attribute__((nodp, addr(0x20c)));

typedef struct io_port_io_out_soft_s {
    uint16_t IO_OUT_SOFT : 12;
} io_port_io_out_soft_t;

extern volatile io_port_io_out_soft_t PORT_IO_OUT_SOFT __attribute__((nodp, addr(0x20e)));

typedef struct io_port_io_out_en_s {
    uint16_t IO_OD_ENABLE : 3;
    uint16_t reserved_3 : 2;
    uint16_t IO_HS_ENABLE : 3;
    uint16_t reserved_8 : 2;
    uint16_t IO_LV_ENABLE : 3;
} io_port_io_out_en_t;

extern volatile io_port_io_out_en_t PORT_IO_OUT_EN __attribute__((nodp, addr(0x210)));
...
extern volatile io_port_io_enable_t PORT_IO_ENABLE __attribute__((nodp, addr(0x212)));

typedef struct io_port_io_enable1_s {
    uint16_t IO_ENABLE : 4;
    uint16_t IO_DISREC : 4;
    uint16_t PH_IN_ENABLE : 6;
} io_port_io_enable1_t;

extern volatile io_port_io_enable1_t PORT_IO_ENABLE1 __attribute__((nodp, addr(0x214)));
...
extern volatile io_port_io_cfg0_t PORT_IO_CFG0 __attribute__((nodp, addr(0x216)));
...
extern volatile io_port_io_cfg1_t PORT_IO_CFG1 __attribute__((nodp, addr(0x218)));
...
extern volatile io_port_io_cfg2_t PORT_IO_CFG2 __attribute__((nodp, addr(0x21a)));

typedef struct io_port_io_uart_sel_s {
    uint16_t IO_UART_SEL : 12;
} io_port_io_uart_sel_t;

extern volatile io_port_io_uart_sel_t PORT_IO_UART_SEL __attribute__((nodp, addr(0x21c)));
...
extern volatile io_port_io_trig_edge_cfg_t PORT_IO_TRIG_EDGE_CFG __attribute__((nodp, addr(0x21e)));
...
extern volatile io_port_io_trig_edge_cfg1_t PORT_IO_TRIG_EDGE_CFG1 __attribute__((nodp, addr(0x220)));
...
extern volatile io_port_lin_xtx_cfg_t PORT_LIN_XTX_CFG __attribute__((nodp, addr(0x222)));
...
extern volatile io_port_timer_cfg_t PORT_TIMER_CFG __attribute__((nodp, addr(0x224)));
...
extern volatile io_port_timer_cfg1_t PORT_TIMER_CFG1 __attribute__((nodp, addr(0x226)));
...
extern volatile io_port_comm_cfg_t PORT_COMM_CFG __attribute__((nodp, addr(0x228)));
...
extern volatile io_port_comm_cfg1_t PORT_COMM_CFG1 __attribute__((nodp, addr(0x22a)));
...
extern volatile io_port_misc_out_t PORT_MISC_OUT __attribute__((nodp, addr(0x22c)));
...
extern volatile io_port_misc2_out_t PORT_MISC2_OUT __attribute__((nodp, addr(0x22e)));

typedef struct io_port_stopmd_ctrl_s {
    uint16_t SEL_STOP_MODE : 1;
} io_port_stopmd_ctrl_t;

extern volatile io_port_stopmd_ctrl_t PORT_STOPMD_CTRL __attribute__((nodp, addr(0x230)));
...
extern volatile io_port_stopmd_cfg_t PORT_STOPMD_CFG __attribute__((nodp, addr(0x232)));

typedef struct io_port_dis_gtsm_s {
    uint16_t DIS_GTSM : 1;
} io_port_dis_gtsm_t;

extern volatile io_port_dis_gtsm_t PORT_DIS_GTSM __attribute__((nodp, addr(0x234)));

typedef struct io_port_lin_xcfg_s {
    uint16_t LIN_XCFG;
} io_port_lin_xcfg_t;

extern volatile io_port_lin_xcfg_t PORT_LIN_XCFG __attribute__((nodp, addr(0x236)));

typedef struct io_port_lin_xcfg_valid_s {
    const uint16_t LIN_XCFG_VALID;
} io_port_lin_xcfg_valid_t;

extern volatile io_port_lin_xcfg_valid_t PORT_LIN_XCFG_VALID __attribute__((nodp, addr(0x238)));

typedef struct io_port_clock_ctrl_s {
    uint16_t AC_SEL : 1;
} io_port_clock_ctrl_t;

extern volatile io_port_clock_ctrl_t PORT_CLOCK_CTRL __attribute__((nodp, addr(0x23a)));

typedef struct io_trim_misc_s {
    uint16_t TRIM_OTD : 6;
    uint16_t TRIM_SDAFILT_IO : 2;
    uint16_t ENA_IO5_RESETB : 1;
    uint16_t reserved_9 : 6;
    uint16_t LOCK : 1;
} io_trim_misc_t;

extern volatile io_trim_misc_t TRIM_MISC __attribute__((nodp, addr(0x23c)));
...
extern volatile io_trim1_drv_t TRIM1_DRV __attribute__((nodp, addr(0x23e)));
...
typedef struct io_port_drv2_test_s {
    ...
    uint16_t TST_OUT_LV0 : 6;
} io_port_drv2_test_t;

extern volatile io_port_drv2_test_t PORT_DRV2_TEST __attribute__((nodp, addr(0x246)));

typedef struct io_port_drv3_test_s {
    uint16_t TST_GHS_NOCURR : 6;
    uint16_t TST_HS_GHS_IBOOST_HRDOFFSW : 1;
    uint16_t TST_DRVMOD_CPCLK_DAC : 1;
} io_port_drv3_test_t;

extern volatile io_port_drv3_test_t PORT_DRV3_TEST __attribute__((nodp, addr(0x248)));

typedef struct io_port_drv1_ctrl_s {
...
extern volatile io_port_drv1_ctrl_t PORT_DRV1_CTRL __attribute__((nodp, addr(0x24a)));

typedef struct io_port_drv2_ctrl_s {
    uint16_t DRV4_CTRL : 4;
    uint16_t DRV5_CTRL : 4;
} io_port_drv2_ctrl_t;

extern volatile io_port_drv2_ctrl_t PORT_DRV2_CTRL __attribute__((nodp, addr(0x24c)));
...
extern volatile io_port_drv1_prot_t PORT_DRV1_PROT __attribute__((nodp, addr(0x24e)));

typedef struct io_port_drv2_prot_s {
    uint16_t DIS_DRV : 1;
} io_port_drv2_prot_t;

extern volatile io_port_drv2_prot_t PORT_DRV2_PROT __attribute__((nodp, addr(0x250)));
...
typedef struct io_port_diag_in_s {
    ...
    const uint16_t OVC1_MEM : 1;
    const uint16_t OVC2_MEM : 1;
    const uint16_t OV_VDDA_MEM : 1;
    const uint16_t OC_VDDA_MEM : 1;
} io_port_diag_in_t;

extern volatile io_port_diag_in_t PORT_DIAG_IN __attribute__((nodp, addr(0x252)));
...
extern volatile io_port_i2c_conf_t PORT_I2C_CONF __attribute__((nodp, addr(0x254)));

typedef struct io_port_i2c_dma_offset_s {
    uint16_t I2C_DMA_OFFSET;
} io_port_i2c_dma_offset_t;

extern volatile io_port_i2c_dma_offset_t PORT_I2C_DMA_OFFSET __attribute__((nodp, addr(0x256)));

typedef struct io_port_i2c_read_offset_s {
    uint16_t I2C_READ_OFFSET : 8;
} io_port_i2c_read_offset_t;

extern volatile io_port_i2c_read_offset_t PORT_I2C_READ_OFFSET __attribute__((nodp, addr(0x258)));
...
typedef struct io_port_misc_test_s {
    ...
    uint16_t TST_CS1_DAC : 1;
    uint16_t TST_CS2_DAC : 1;
} io_port_misc_test_t;

extern volatile io_port_misc_test_t PORT_MISC_TEST __attribute__((nodp, addr(0x25a)));

typedef struct io_port_misc2_test_s {
    uint16_t TST_ADC_IN : 2;
    uint16_t TA_CTRL_ADC : 3;
    uint16_t VDDD_VT_MONITOR_TEST : 2;
    uint16_t ADC_BLOCK_TOGGLE : 1;
} io_port_misc2_test_t;

extern volatile io_port_misc2_test_t PORT_MISC2_TEST __attribute__((nodp, addr(0x25c)));

typedef struct io_port_ppm_rbase_add_s {
    uint16_t PPM_RBASE_ADD;
} io_port_ppm_rbase_add_t;

extern volatile io_port_ppm_rbase_add_t PORT_PPM_RBASE_ADD __attribute__((nodp, addr(0x25e)));

typedef struct io_port_ppm_tbase_add_s {
    uint16_t PPM_TBASE_ADD;
} io_port_ppm_tbase_add_t;

extern volatile io_port_ppm_tbase_add_t PORT_PPM_TBASE_ADD __attribute__((nodp, addr(0x260)));

typedef struct io_port_ppm_timeout_s {
    uint16_t PPM_TIMEOUT;
} io_port_ppm_timeout_t;

extern volatile io_port_ppm_timeout_t PORT_PPM_TIMEOUT __attribute__((nodp, addr(0x262)));
...
extern volatile io_port_ppm_ctrl_t PORT_PPM_CTRL __attribute__((nodp, addr(0x264)));

typedef struct io_port_ppm_buf_data_s {
    const uint16_t PPM_BUF_DATA;
} io_port_ppm_buf_data_t;

extern volatile io_port_ppm_buf_data_t PORT_PPM_BUF_DATA __attribute__((nodp, addr(0x266)));

typedef struct io_ppm_timer_s {
    uint16_t PPM_ON_TIME;
} io_ppm_timer_t;

extern volatile io_ppm_timer_t PPM_TIMER __attribute__((nodp, addr(0x268)));
...
extern volatile io_port_ppm_flags_t PORT_PPM_FLAGS __attribute__((nodp, addr(0x26a)));
...
extern volatile io_port_sscm2_conf_t PORT_SSCM2_CONF __attribute__((nodp, addr(0x26c)));
...
extern volatile io_port_step2_conf_t PORT_STEP2_CONF __attribute__((nodp, addr(0x26e)));
...
typedef struct io_port_i2c_mst_add_buffer_s {
    uint16_t I2C_MST_ADD_BUFFER;
} io_port_i2c_mst_add_buffer_t;

extern volatile io_port_i2c_mst_add_buffer_t PORT_I2C_MST_ADD_BUFFER __attribute__((nodp, addr(0x2a2)));

typedef struct io_port_i2c_mst_ctrl_s {
    uint16_t I2C_MST_EN : 1;
    uint16_t I2C_MST_NO_STOP_BIT : 1;
} io_port_i2c_mst_ctrl_t;

extern volatile io_port_i2c_mst_ctrl_t PORT_I2C_MST_CTRL __attribute__((nodp, addr(0x2a4)));

typedef struct io_port_i2c_mst_per_s {
    uint16_t I2C_MST_HALF_PERIOD : 8;
    uint16_t I2C_MST_SDA_DELAY : 8;
} io_port_i2c_mst_per_t;

extern volatile io_port_i2c_mst_per_t PORT_I2C_MST_PER __attribute__((nodp, addr(0x2a6)));

typedef struct io_port_i2c_mst_stat_s {
    const uint16_t I2C_MST_END : 1;
    const uint16_t ADDR_ACK_NOK : 1;
    const uint16_t DATA_ACK_NOK : 1;
    const uint16_t I2C_MST_DMA_ERR : 1;
    const uint16_t I2C_MST_CURRENT_STATE : 4;
    const uint16_t I2C_MST_SIZE_CNT : 8;
} io_port_i2c_mst_stat_t;

extern volatile io_port_i2c_mst_stat_t PORT_I2C_MST_STAT __attribute__((nodp, addr(0x2a8)));

typedef struct io_port_curr_sens1_s {
    uint16_t SET_CS1 : 8;
    uint16_t EN_CSA1 : 1;
    uint16_t CSA1_ZERO : 1;
    uint16_t CSA1_HIGHGAIN : 1;
    uint16_t CSA1_EN_OC : 1;
    uint16_t CSA1_CHOP : 1;
    uint16_t CSA1_BYPASS : 1;
} io_port_curr_sens1_t;

extern volatile io_port_curr_sens1_t PORT_CURR_SENS1 __attribute__((nodp, addr(0x2aa)));

typedef struct io_port_curr_sens2_s {
    uint16_t SET_CS2 : 8;
    uint16_t EN_CSA2 : 1;
    uint16_t CSA2_ZERO : 1;
    uint16_t CSA2_HIGHGAIN : 1;
    uint16_t CSA2_EN_OC : 1;
    uint16_t CSA2_CHOP : 1;
    uint16_t CSA2_BYPASS : 1;
} io_port_curr_sens2_t;

extern volatile io_port_curr_sens2_t PORT_CURR_SENS2 __attribute__((nodp, addr(0x2ac)));

typedef struct io_port_ph_trig_edge_cfg_s {
    uint16_t PH0_TRIG_EDGE_SEL : 2;
    uint16_t PH1_TRIG_EDGE_SEL : 2;
    uint16_t PH2_TRIG_EDGE_SEL : 2;
    uint16_t PH3_TRIG_EDGE_SEL : 2;
    uint16_t PH4_TRIG_EDGE_SEL : 2;
    uint16_t PH5_TRIG_EDGE_SEL : 2;
} io_port_ph_trig_edge_cfg_t;

extern volatile io_port_ph_trig_edge_cfg_t PORT_PH_TRIG_EDGE_CFG __attribute__((nodp, addr(0x2ae)));

typedef struct io_port_ph_in_s {
    const uint16_t PH_IN_SYNC : 6;
} io_port_ph_in_t;

extern volatile io_port_ph_in_t PORT_PH_IN __attribute__((nodp, addr(0x2b0)));
