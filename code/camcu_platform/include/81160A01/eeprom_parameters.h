...
/** GAINDIFF_CURR1_G20 : Gain difference between 10x and 20x gain settings */
#define EE_GAINDIFF_CURR1_G20_GET() \
    (int8_t)((ee0x5d2 & 0xff00u) >> 8U)
/** GAINDIFF_CURR2_G20 : Gain difference between 10x and 20x gain settings */
#define EE_GAINDIFF_CURR2_G20_GET() \
    (int8_t)((ee0x5d2 & 0x00ffu) >> 0U)
...
/** TRIM_DRVSUP : Trim setting driver supply */
#define EE_TRIM_DRVSUP_GET() \
    (uint8_t)((ee0x5d6 & 0x3000u) >> 12U)
...
/** GAINHI_CURR2 : Gain-change of motor current over high-temperature range */
#define EE_GAINHI_CURR2_GET() \
    (int8_t)((ee0x5dc & 0xff00u) >> 8U)
/** GAINLO_CURR2 : Gain-change of motor current over low-temperature range */
#define EE_GAINLO_CURR2_GET() \
...
/** O_CURR2_L : Offset of motor current at mid temp */
#define EE_O_CURR2_L_GET() \
    (uint8_t)((ee0x5de & 0xf000u) >> 12U)
/** GAIN_CURR2 : Gain of motor current at mid temp */
#define EE_GAIN_CURR2_GET() \
...
/** GAINLO_CURR1 : Gain-change of motor current over low-temperature range */
#define EE_GAINLO_CURR1_GET() \
    (int8_t)((ee0x5e0 & 0xff00u) >> 8U)
/** O_CURR2_H : Offset of motor current at mid temp */
#define EE_O_CURR2_H_GET() \
...
/** GAIN_CURR1_L : Gain of motor current at mid temp */
#define EE_GAIN_CURR1_L_GET() \
    (uint8_t)((ee0x5e2 & 0xff00u) >> 8U)
/** GAINHI_CURR1 : Gain-change of motor current over high-temperature range */
#define EE_GAINHI_CURR1_GET() \
...
/** O_CURR1 : Offset of motor current at mid temp */
#define EE_O_CURR1_GET() \
    (uint16_t)((ee0x5e4 & 0xfff0u) >> 4U)
/** GAIN_CURR1_H : Gain of motor current at mid temp */
#define EE_GAIN_CURR1_H_GET() \
...
/** GAINHI_HVI : Gain-change of HVI voltage over high-temperature range */
#define EE_GAINHI_HVI_GET() \
    (int8_t)((ee0x5e6 & 0xff00u) >> 8U)
/** GAINLO_HVI : Gain-change of HVI voltage over low-temperature range */
...
/** O_HVI_L : Offset of high-voltage input HVI/26 at mid temp */
...
/** TRIM_CPCLK : Trim setting charge pump clock */
#define EE_TRIM_CPCLK_GET() \
    (uint16_t)((ee0x5f0 & 0xffc0u) >> 6U)
...
/** OOCS2 : Offset of over-current DAC 2 */
#define EE_OOCS2_GET() \
    (uint8_t)((ee0x5f2 & 0xff00u) >> 8U)
/** GOCS2 : Gain of over-current DAC 2 */
#define EE_GOCS2_GET() \
    (uint8_t)((ee0x5f2 & 0x00ffu) >> 0U)
/** APP_TRIM34 : application specific calibration information */
#define EE_APP_TRIM34_GET() \
    (uint16_t)((ee0x5f4 & 0xffffu) >> 0U)
/** OOCS1 : Offset of over-current DAC 1 */
#define EE_OOCS1_GET() \
    (uint8_t)((ee0x5f4 & 0xff00u) >> 8U)
/** GOCS1 : Gain of over-current DAC 1 */
#define EE_GOCS1_GET() \
...
/** GAINDIFF_CURR1_G20 - Gain difference between 10x and 20x gain settings */
#define EE_GAINDIFF_CURR1_G20 \
    ee0x5d2, (MEM_EEPROM_START + 0x01d2u), (MEM_EEPROM_START + 0x01d2u), 0xff00u,  8U, 1U, 0U, 0x0000u
/** GAINDIFF_CURR2_G20 - Gain difference between 10x and 20x gain settings */
#define EE_GAINDIFF_CURR2_G20 \
    ee0x5d2, (MEM_EEPROM_START + 0x01d2u), (MEM_EEPROM_START + 0x01d2u), 0x00ffu,  0U, 1U, 0U, 0x0000u
/** APP_TRIM18 - application specific calibration information */
...
#define EE_TRIM_DRVSUP \
    ee0x5d6, (MEM_EEPROM_START + 0x01d6u), (MEM_EEPROM_START + 0x01d6u), 0x3000u, 12U, 1U, 0U, 0x0000u
/** GAIN_VSMF - Gain of filtered VSM at mid temp */
#define EE_GAIN_VSMF \
...
#define EE_TRIM_CPCLK \
    ee0x5f0, (MEM_EEPROM_START + 0x01f0u), (MEM_EEPROM_START + 0x01f0u), 0xffc0u,  6U, 1U, 0U, 0x0000u
/** TRIM_OTD - Trim setting over-temperature detection */
#define EE_TRIM_OTD \
...
/** OOCS2 - Offset of over-current DAC 2 */
#define EE_OOCS2 \
    ee0x5f2, (MEM_EEPROM_START + 0x01f2u), (MEM_EEPROM_START + 0x01f2u), 0xff00u,  8U, 1U, 0U, 0x0000u
/** GOCS2 - Gain of over-current DAC 2 */
#define EE_GOCS2 \
    ee0x5f2, (MEM_EEPROM_START + 0x01f2u), (MEM_EEPROM_START + 0x01f2u), 0x00ffu,  0U, 1U, 0U, 0x0000u
/** APP_TRIM34 - application specific calibration information */
