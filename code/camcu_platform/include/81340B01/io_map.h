...
extern volatile io_port_io_out_soft_t PORT_IO_OUT_SOFT __attribute__((nodp, addr(0x206)));
...
extern volatile io_port_io_out_en_t PORT_IO_OUT_EN __attribute__((nodp, addr(0x208)));
...
extern volatile io_port_io_enable_t PORT_IO_ENABLE __attribute__((nodp, addr(0x20a)));
...
extern volatile io_port_io_enable1_t PORT_IO_ENABLE1 __attribute__((nodp, addr(0x20c)));
...
extern volatile io_port_io_cfg0_t PORT_IO_CFG0 __attribute__((nodp, addr(0x20e)));
...
extern volatile io_port_io_cfg1_t PORT_IO_CFG1 __attribute__((nodp, addr(0x210)));
...
extern volatile io_port_io_cfg2_t PORT_IO_CFG2 __attribute__((nodp, addr(0x212)));

typedef struct io_port_io_uart_sel_s {
    uint16_t IO_UART_SEL : 12;
} io_port_io_uart_sel_t;

extern volatile io_port_io_uart_sel_t PORT_IO_UART_SEL __attribute__((nodp, addr(0x214)));
...
extern volatile io_port_io_trig_edge_cfg_t PORT_IO_TRIG_EDGE_CFG __attribute__((nodp, addr(0x216)));
...
extern volatile io_port_io_trig_edge_cfg1_t PORT_IO_TRIG_EDGE_CFG1 __attribute__((nodp, addr(0x218)));
...
extern volatile io_port_lin_xtx_cfg_t PORT_LIN_XTX_CFG __attribute__((nodp, addr(0x21a)));
...
extern volatile io_port_timer_cfg_t PORT_TIMER_CFG __attribute__((nodp, addr(0x21c)));
...
extern volatile io_port_timer_cfg1_t PORT_TIMER_CFG1 __attribute__((nodp, addr(0x21e)));
...
extern volatile io_port_comm_cfg_t PORT_COMM_CFG __attribute__((nodp, addr(0x220)));
...
extern volatile io_port_comm_cfg1_t PORT_COMM_CFG1 __attribute__((nodp, addr(0x222)));
...
extern volatile io_port_misc_out_t PORT_MISC_OUT __attribute__((nodp, addr(0x224)));
...
extern volatile io_port_misc2_out_t PORT_MISC2_OUT __attribute__((nodp, addr(0x226)));

typedef struct io_port_stopmd_ctrl_s {
    uint16_t SEL_STOP_MODE : 1;
} io_port_stopmd_ctrl_t;

extern volatile io_port_stopmd_ctrl_t PORT_STOPMD_CTRL __attribute__((nodp, addr(0x228)));
...
extern volatile io_port_stopmd_cfg_t PORT_STOPMD_CFG __attribute__((nodp, addr(0x22a)));

typedef struct io_port_dis_gtsm_s {
    uint16_t DIS_GTSM : 1;
} io_port_dis_gtsm_t;

extern volatile io_port_dis_gtsm_t PORT_DIS_GTSM __attribute__((nodp, addr(0x22c)));

typedef struct io_port_lin_xcfg_s {
    uint16_t LIN_XCFG;
} io_port_lin_xcfg_t;

extern volatile io_port_lin_xcfg_t PORT_LIN_XCFG __attribute__((nodp, addr(0x22e)));

typedef struct io_port_lin_xcfg_valid_s {
    const uint16_t LIN_XCFG_VALID;
} io_port_lin_xcfg_valid_t;

extern volatile io_port_lin_xcfg_valid_t PORT_LIN_XCFG_VALID __attribute__((nodp, addr(0x230)));

typedef struct io_port_clock_ctrl_s {
    uint16_t AC_SEL : 1;
} io_port_clock_ctrl_t;

extern volatile io_port_clock_ctrl_t PORT_CLOCK_CTRL __attribute__((nodp, addr(0x232)));
...
extern volatile io_trim_misc_t TRIM_MISC __attribute__((nodp, addr(0x234)));
...
extern volatile io_port_drv_ctrl_t PORT_DRV_CTRL __attribute__((nodp, addr(0x236)));
...
extern volatile io_port_drv1_prot_t PORT_DRV1_PROT __attribute__((nodp, addr(0x238)));
...
extern volatile io_port_drv2_prot_t PORT_DRV2_PROT __attribute__((nodp, addr(0x23a)));
...
extern volatile io_port_drv3_prot_t PORT_DRV3_PROT __attribute__((nodp, addr(0x23c)));
...
extern volatile io_port_drv_in_t PORT_DRV_IN __attribute__((nodp, addr(0x23e)));
...
extern volatile io_port_diag_in_t PORT_DIAG_IN __attribute__((nodp, addr(0x240)));

typedef struct io_port_div_vds_deb_s {
    uint16_t DIV_VDS : 3;
} io_port_div_vds_deb_t;

extern volatile io_port_div_vds_deb_t PORT_DIV_VDS_DEB __attribute__((nodp, addr(0x242)));
...
extern volatile io_port_cnt_vds_deb_t PORT_CNT_VDS_DEB __attribute__((nodp, addr(0x244)));

typedef struct io_port_div_mask_vds_s {
    uint16_t DIV_MASK_VDS : 4;
} io_port_div_mask_vds_t;

extern volatile io_port_div_mask_vds_t PORT_DIV_MASK_VDS __attribute__((nodp, addr(0x246)));
...
extern volatile io_port_cnt_mask_vds_ls_t PORT_CNT_MASK_VDS_LS __attribute__((nodp, addr(0x248)));
...
extern volatile io_port_cnt_mask_vds_hs_t PORT_CNT_MASK_VDS_HS __attribute__((nodp, addr(0x24a)));

typedef struct io_port_div_eild_s {
    uint16_t DIV_EILD : 3;
} io_port_div_eild_t;

extern volatile io_port_div_eild_t PORT_DIV_EILD __attribute__((nodp, addr(0x24c)));
...
extern volatile io_port_cnt_eild_lsoff_t PORT_CNT_EILD_LSOFF __attribute__((nodp, addr(0x24e)));
...
extern volatile io_port_cnt_eild_hsoff_t PORT_CNT_EILD_HSOFF __attribute__((nodp, addr(0x250)));
...
extern volatile io_trim_iild_t TRIM_IILD __attribute__((nodp, addr(0x252)));

typedef struct io_port_cdi_in_s {
    const uint16_t CDI : 3;
} io_port_cdi_in_t;

extern volatile io_port_cdi_in_t PORT_CDI_IN __attribute__((nodp, addr(0x254)));
...
extern volatile io_port_i2c_conf_t PORT_I2C_CONF __attribute__((nodp, addr(0x256)));

typedef struct io_port_i2c_dma_offset_s {
    uint16_t I2C_DMA_OFFSET;
} io_port_i2c_dma_offset_t;

extern volatile io_port_i2c_dma_offset_t PORT_I2C_DMA_OFFSET __attribute__((nodp, addr(0x258)));

typedef struct io_port_i2c_read_offset_s {
    uint16_t I2C_READ_OFFSET : 8;
} io_port_i2c_read_offset_t;

extern volatile io_port_i2c_read_offset_t PORT_I2C_READ_OFFSET __attribute__((nodp, addr(0x25a)));
...
extern volatile io_port_misc_test_t PORT_MISC_TEST __attribute__((nodp, addr(0x25c)));
...
extern volatile io_port_misc2_test_t PORT_MISC2_TEST __attribute__((nodp, addr(0x25e)));

typedef struct io_port_ppm_rbase_add_s {
    uint16_t PPM_RBASE_ADD;
} io_port_ppm_rbase_add_t;

extern volatile io_port_ppm_rbase_add_t PORT_PPM_RBASE_ADD __attribute__((nodp, addr(0x260)));

typedef struct io_port_ppm_tbase_add_s {
    uint16_t PPM_TBASE_ADD;
} io_port_ppm_tbase_add_t;

extern volatile io_port_ppm_tbase_add_t PORT_PPM_TBASE_ADD __attribute__((nodp, addr(0x262)));

typedef struct io_port_ppm_timeout_s {
    uint16_t PPM_TIMEOUT;
} io_port_ppm_timeout_t;

extern volatile io_port_ppm_timeout_t PORT_PPM_TIMEOUT __attribute__((nodp, addr(0x264)));
...
extern volatile io_port_ppm_ctrl_t PORT_PPM_CTRL __attribute__((nodp, addr(0x266)));

typedef struct io_port_ppm_buf_data_s {
    const uint16_t PPM_BUF_DATA;
} io_port_ppm_buf_data_t;

extern volatile io_port_ppm_buf_data_t PORT_PPM_BUF_DATA __attribute__((nodp, addr(0x268)));

typedef struct io_ppm_timer_s {
    uint16_t PPM_ON_TIME;
} io_ppm_timer_t;

extern volatile io_ppm_timer_t PPM_TIMER __attribute__((nodp, addr(0x26a)));
...
extern volatile io_port_ppm_flags_t PORT_PPM_FLAGS __attribute__((nodp, addr(0x26c)));

typedef struct io_port_tx_timeout_s {
    const uint16_t TX_TIMEOUT : 1;
} io_port_tx_timeout_t;

extern volatile io_port_tx_timeout_t PORT_TX_TIMEOUT __attribute__((nodp, addr(0x26e)));

typedef struct io_port_udma0_rda_s {
    uint16_t UDMA0_RDA;
} io_port_udma0_rda_t;

extern volatile io_port_udma0_rda_t PORT_UDMA0_RDA __attribute__((nodp, addr(0x270)));

typedef struct io_port_udma0_rdb_s {
    uint16_t UDMA0_RDB;
} io_port_udma0_rdb_t;

extern volatile io_port_udma0_rdb_t PORT_UDMA0_RDB __attribute__((nodp, addr(0x272)));

typedef struct io_port_udma0_tx_s {
    uint16_t UDMA0_TX;
} io_port_udma0_tx_t;

extern volatile io_port_udma0_tx_t PORT_UDMA0_TX __attribute__((nodp, addr(0x274)));
...
extern volatile io_port_udma0_size_t PORT_UDMA0_SIZE __attribute__((nodp, addr(0x276)));
...
extern volatile io_port_udma0_ctrl_t PORT_UDMA0_CTRL __attribute__((nodp, addr(0x278)));
...
extern volatile io_uart0_t UART0 __attribute__((nodp, addr(0x27a)));
...
extern volatile io_port_udma0_status_t PORT_UDMA0_STATUS __attribute__((nodp, addr(0x286)));

typedef struct io_port_udma1_rda_s {
    uint16_t UDMA1_RDA;
} io_port_udma1_rda_t;

extern volatile io_port_udma1_rda_t PORT_UDMA1_RDA __attribute__((nodp, addr(0x288)));

typedef struct io_port_udma1_rdb_s {
    uint16_t UDMA1_RDB;
} io_port_udma1_rdb_t;

extern volatile io_port_udma1_rdb_t PORT_UDMA1_RDB __attribute__((nodp, addr(0x28a)));

typedef struct io_port_udma1_tx_s {
    uint16_t UDMA1_TX;
} io_port_udma1_tx_t;

extern volatile io_port_udma1_tx_t PORT_UDMA1_TX __attribute__((nodp, addr(0x28c)));
...
extern volatile io_port_udma1_size_t PORT_UDMA1_SIZE __attribute__((nodp, addr(0x28e)));
...
extern volatile io_port_udma1_ctrl_t PORT_UDMA1_CTRL __attribute__((nodp, addr(0x290)));
...
extern volatile io_uart1_t UART1 __attribute__((nodp, addr(0x292)));
...
extern volatile io_port_udma1_status_t PORT_UDMA1_STATUS __attribute__((nodp, addr(0x29e)));
...
extern volatile io_port_curr_sens_t PORT_CURR_SENS __attribute__((nodp, addr(0x2a0)));
...
extern volatile io_port_cp_t PORT_CP __attribute__((nodp, addr(0x2a2)));
...
extern volatile io_trim_cp_t TRIM_CP __attribute__((nodp, addr(0x2a4)));
...
typedef struct io_port_linaa1_s {
    ...
    uint16_t LINAA_5V_ENABLE : 1;
} io_port_linaa1_t;

extern volatile io_port_linaa1_t PORT_LINAA1 __attribute__((nodp, addr(0x2a6)));
...
extern volatile io_port_linaa2_t PORT_LINAA2 __attribute__((nodp, addr(0x2a8)));
