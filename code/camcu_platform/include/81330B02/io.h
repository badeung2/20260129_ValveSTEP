...
extern volatile uint8_t error_IO_TRIM_RCO1M__PRE_TR_LIN_SLEWRATE_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_TRIM_RCO1M__PRE_TR_LIN_SLVTERM_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_TRIM_RCO1M__TR_UNUSED_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_SUPP2_TEST__TST_VDDA_OUT2_FV_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_SUPP2_TEST__TST_VDDD_OUT2_FV_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_SUPP2_TEST__TST_IO_LV_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_ADC_TRIM_TEST__SEL_TR_RCO32M_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_ADC_TRIM_TEST__SEL_TR_RCO1M_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_IO_OUT_EN__IO0_OD_ENABLE_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_IO_OUT_EN__IOX_OD_ENABLE_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x1ea  __attribute__((nodp, addr(0x1ea)));
extern volatile uint8_t error_IO_PORT_IO_CFG0__IO2_OUT_SEL_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_IO_CFG0__IO3_OUT_SEL_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_TIMER_CFG__TIMER0_CHB_SEL_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x1f0  __attribute__((nodp, addr(0x1f0)));
extern volatile uint8_t error_IO_PORT_COMM_CFG__SPI_SCK_IN_SEL_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_COMM_CFG__UNUSED_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_COMM_CFG__SPI_SS_IN_SEL_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_MISC2_OUT__WU_IO_EN_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_MISC2_OUT__ENABLE_OTD_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_MISC2_OUT__VSM_FILT_ON_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_LINAA1__LINAA_RST1_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_LINAA1__LINAA_RST2_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_LINAA1__LINAA_EN_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_LINAA1__LINAA_CDOUTEN_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_TRIM_MISC__TRIM_SDAFILT_IO_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_DRV_OUT__ENABLE_LS_OC_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV_OUT__DRVMOD_OPTION_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV_OUT__PARALLEL_MODE_DRV_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x210  __attribute__((nodp, addr(0x210)));
extern volatile uint8_t error_IO_PORT_DRV1_TEST__TST_STRS_VHS_HS_DRV_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_TEST__TST_STRS_VHS_LS_DRV_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_TEST__TST_OUT_LV1_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_TEST__TST_UVCMP_LV1_DRVSUP_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_TEST__TST_VBGCS_LV0_DRVSUP_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x212  __attribute__((nodp, addr(0x212)));
extern volatile uint8_t error_IO_PORT_DRV2_TEST__TST_DRVSUP_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV2_TEST__TEST_DRVMOD_CPCLK_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV2_TEST__TEST_DRV_ILD_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV2_TEST__TST_OC_REDUCE_LVL_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV2_TEST__TST_DRVSUP_DISC_CMP_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x214  __attribute__((nodp, addr(0x214)));
extern volatile uint8_t error_IO_PORT_DRV3_TEST__TST_AMP_DIV_LV0_CSA_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV3_TEST__TST_DAC_LV0_CSA_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV3_TEST__TST_V5V_DIV3_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV3_TEST__TST_DRVMOD_CPCLK_DAC_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x216  __attribute__((nodp, addr(0x216)));
extern volatile uint8_t error_IO_PORT_DRV_CTRL__DRV2_CTRL_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV_CTRL__DRV3_CTRL_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x218  __attribute__((nodp, addr(0x218)));
extern volatile uint8_t error_IO_PORT_DRV1_PROT__UV_VDDAF_PM_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_PROT__DIS_UV_VDDAF_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_PROT__OC_PM_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_PROT__DIS_OC_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_PROT__OV_HS_VDS_PM_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_PROT__DIS_OV_HS_VDS_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_PROT__OV_LS_VDS_PM_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_DRV1_PROT__DIS_OV_LS_VDS_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_I2C_CONF__SDA_FILT_ENABLE_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_I2C_CONF__I2C_SCL_CLK_SEL_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_MISC_TEST__DIS_TX_TIMEOUT_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_PPM_CTRL__PPM_DAT_IT_NB_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_PPM_CTRL__PPM_TX_RX_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t error_IO_PORT_PPM_CTRL__PPM_IN_SEL_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
extern volatile uint8_t error_IO_PORT_STEP2_CONF__STEP2_CNT_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x23a  __attribute__((nodp, addr(0x23a)));
extern volatile uint8_t error_IO_PORT_IO_ENABLE__IO_DISREC_has_no_byte_access; /* to catch attempts of byte access when not supported */
extern volatile uint8_t io_byte_0x23c  __attribute__((nodp, addr(0x23c)));
extern volatile uint8_t error_IO_PORT_TIMER_CFG1__TIMER1_CHB_SEL_has_no_byte_access; /* to catch attempts of byte access when not supported */
...
#define IO_PORT_SPARE_TEST__TST_VDDA_VT_MON_SUP_GET() \
	((io0x1da & 0x0004u) >> 2U)
#define IO_PORT_SPARE_TEST__TST_CPCLKSEL_DRV_GET() \
	((io0x1da & 0x0018u) >> 3U)
...
#define IO_PORT_COMM_CFG__SPI_SCK_IN_SEL_GET() \
	((io0x1f0 & 0x0300u) >> 8U)
#define IO_PORT_COMM_CFG__UNUSED_GET() \
	((io0x1f0 & 0x0c00u) >> 10U)
...
#define IO_PORT_IO_ENABLE__IO_ENABLE_GET() \
	((io0x23a & 0x000fu) >> 0U)
#define IO_PORT_IO_ENABLE__UNUSED_GET() \
	((io0x23a & 0x00f0u) >> 4U)
...
#define IO_MLX16__IO_IN0_PEND \
	io0x56, io_byte_0x56, 0x0056u, 0x0056, 0x0001u, 0x01u,  0U, 0, 1U, 12u, 0xffc0u, 0x003fu
#define IO_MLX16__ITC_PEND3 \
	io0x56, io_byte_0x56, 0x0056u, 0x0056, 0x003fu, 0x3fu,  0U, 0, 1U, 12u, 0xffc0u, 0x003fu
#define IO_MLX16__IO_IN1_PEND \
	io0x56, io_byte_0x56, 0x0056u, 0x0056, 0x0002u, 0x02u,  1U, 1, 1U, 12u, 0xffc0u, 0x003fu
#define IO_MLX16__IO_IN2_PEND \
	io0x56, io_byte_0x56, 0x0056u, 0x0056, 0x0004u, 0x04u,  2U, 2, 1U, 12u, 0xffc0u, 0x003fu
#define IO_MLX16__IO_IN3_PEND \
	io0x56, io_byte_0x56, 0x0056u, 0x0056, 0x0008u, 0x08u,  3U, 3, 1U, 12u, 0xffc0u, 0x003fu
#define IO_MLX16__TX_TIMEOUT_PEND \
	io0x56, io_byte_0x56, 0x0056u, 0x0056, 0x0010u, 0x10u,  4U, 4, 1U, 12u, 0xffc0u, 0x003fu
#define IO_MLX16__MLX16_SOFT_PEND \
	io0x56, io_byte_0x56, 0x0056u, 0x0056, 0x0020u, 0x20u,  5U, 5, 1U, 12u, 0xffc0u, 0x003fu
...
#define IO_MLX16__IO_IN0_ITC \
	io0x72, io_byte_0x72, 0x0072u, 0x0072, 0x0001u, 0x01u,  0U, 0, 1U, 14u, 0xffc0u, 0x0000u
#define IO_MLX16__ITC_MASK3 \
	io0x72, io_byte_0x72, 0x0072u, 0x0072, 0x003fu, 0x3fu,  0U, 0, 1U, 14u, 0xffc0u, 0x0000u
#define IO_MLX16__IO_IN1_ITC \
	io0x72, io_byte_0x72, 0x0072u, 0x0072, 0x0002u, 0x02u,  1U, 1, 1U, 14u, 0xffc0u, 0x0000u
#define IO_MLX16__IO_IN2_ITC \
	io0x72, io_byte_0x72, 0x0072u, 0x0072, 0x0004u, 0x04u,  2U, 2, 1U, 14u, 0xffc0u, 0x0000u
#define IO_MLX16__IO_IN3_ITC \
	io0x72, io_byte_0x72, 0x0072u, 0x0072, 0x0008u, 0x08u,  3U, 3, 1U, 14u, 0xffc0u, 0x0000u
#define IO_MLX16__TX_TIMEOUT_ITC \
	io0x72, io_byte_0x72, 0x0072u, 0x0072, 0x0010u, 0x10u,  4U, 4, 1U, 14u, 0xffc0u, 0x0000u
#define IO_MLX16__MLX16_SOFT_ITC \
	io0x72, io_byte_0x72, 0x0072u, 0x0072, 0x0020u, 0x20u,  5U, 5, 1U, 14u, 0xffc0u, 0x0000u
...
#define IO_MLX16__ITC_PRIO4 \
	io0x90, io_byte_0x90, 0x0090u, 0x0090, 0x0003u, 0x03u,  0U, 0, 1U, 12u, 0xfffcu, 0x0000u
...
#define IO_EEPROM_FLASH__FL_PAGE_NUMBER \
	io0x184, error_IO_EEPROM_FLASH__FL_PAGE_NUMBER_has_no_byte_access, 0x0184u, 0x0184, 0x000fu, 0x0fu,  0U, 0, 1U, 8u, 0xfe00u, 0x0000u
#define IO_EEPROM_FLASH__FL_SECTOR_NUMBER \
	io0x184, error_IO_EEPROM_FLASH__FL_SECTOR_NUMBER_has_no_byte_access, 0x0184u, 0x0184, 0x00f0u, 0xf0u,  4U, 4, 1U, 8u, 0xfe00u, 0x0000u
#define IO_EEPROM_FLASH__FL_CS_AREA \
	io0x184, error_IO_EEPROM_FLASH__FL_CS_AREA_has_no_byte_access, 0x0184u, 0x0185, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xfe00u, 0x0000u
...
#define IO_TRIM_BG_BIAS__PRE_TR_BIAS \
	io0x1c8, error_IO_TRIM_BG_BIAS__PRE_TR_BIAS_has_no_byte_access, 0x01c8u, 0x01c8, 0x3f00u, 0x3fu,  8U, 0, 1U, 8u, 0x0000u, 0x0000u
#define IO_TRIM_BG_BIAS__TR_UNUSED \
	io0x1c8, error_IO_TRIM_BG_BIAS__TR_UNUSED_has_no_byte_access, 0x01c8u, 0x01c8, 0x4000u, 0x40u, 14U, 6, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_TRIM_VDD__TR_UNUSED \
	io0x1ca, error_IO_TRIM_VDD__TR_UNUSED_has_no_byte_access, 0x01cau, 0x01ca, 0x4000u, 0x40u, 14U, 6, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_TRIM_RCO32M__TR_UNUSED \
	io0x1cc, error_IO_TRIM_RCO32M__TR_UNUSED_has_no_byte_access, 0x01ccu, 0x01cc, 0x7c00u, 0x7cu, 10U, 2, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_TRIM_RCO1M__PRE_TR_LIN_SLEWRATE \
	io0x1ce, error_IO_TRIM_RCO1M__PRE_TR_LIN_SLEWRATE_has_no_byte_access, 0x01ceu, 0x01ce, 0x0700u, 0x07u,  8U, 0, 1U, 8u, 0x0000u, 0x0000u
#define IO_TRIM_RCO1M__PRE_TR_LIN_SLVTERM \
	io0x1ce, error_IO_TRIM_RCO1M__PRE_TR_LIN_SLVTERM_has_no_byte_access, 0x01ceu, 0x01ce, 0x3800u, 0x38u, 11U, 3, 1U, 8u, 0x0000u, 0x0000u
#define IO_TRIM_RCO1M__TR_UNUSED \
	io0x1ce, error_IO_TRIM_RCO1M__TR_UNUSED_has_no_byte_access, 0x01ceu, 0x01ce, 0x4000u, 0x40u, 14U, 6, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_PORT_STEP_CONF__STEP_CNT \
	io0x1d2, error_IO_PORT_STEP_CONF__STEP_CNT_has_no_byte_access, 0x01d2u, 0x01d2, 0xff00u, 0xffu,  8U, 0, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_PORT_SUPP_TEST__SWITCHOFFUV_VDDD_RES \
	io0x1d4, error_IO_PORT_SUPP_TEST__SWITCHOFFUV_VDDD_RES_has_no_byte_access, 0x01d4u, 0x01d4, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0x8000u, 0x0000u
#define IO_PORT_SUPP_TEST__SBY_BIAS \
	io0x1d4, error_IO_PORT_SUPP_TEST__SBY_BIAS_has_no_byte_access, 0x01d4u, 0x01d4, 0x0400u, 0x04u, 10U, 2, 1U, 8u, 0x8000u, 0x0000u
#define IO_PORT_SUPP_TEST__LOW_VDDD \
	io0x1d4, error_IO_PORT_SUPP_TEST__LOW_VDDD_has_no_byte_access, 0x01d4u, 0x01d4, 0x0800u, 0x08u, 11U, 3, 1U, 8u, 0x8000u, 0x0000u
#define IO_PORT_SUPP_TEST__SHOVE_VDDD \
	io0x1d4, error_IO_PORT_SUPP_TEST__SHOVE_VDDD_has_no_byte_access, 0x01d4u, 0x01d4, 0x1000u, 0x10u, 12U, 4, 1U, 8u, 0x8000u, 0x0000u
#define IO_PORT_SUPP_TEST__SHOVE_VDDA \
	io0x1d4, error_IO_PORT_SUPP_TEST__SHOVE_VDDA_has_no_byte_access, 0x01d4u, 0x01d4, 0x2000u, 0x20u, 13U, 5, 1U, 8u, 0x8000u, 0x0000u
#define IO_PORT_SUPP_TEST__SHOVE_VAUX \
	io0x1d4, error_IO_PORT_SUPP_TEST__SHOVE_VAUX_has_no_byte_access, 0x01d4u, 0x01d4, 0x4000u, 0x40u, 14U, 6, 1U, 8u, 0x8000u, 0x0000u
...
#define IO_PORT_SUPP2_TEST__IDDQ_CLK10K \
	io0x1d6, error_IO_PORT_SUPP2_TEST__IDDQ_CLK10K_has_no_byte_access, 0x01d6u, 0x01d6, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_SUPP2_TEST__TST_VDDA_OUT2_FV \
	io0x1d6, error_IO_PORT_SUPP2_TEST__TST_VDDA_OUT2_FV_has_no_byte_access, 0x01d6u, 0x01d6, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_SUPP2_TEST__TST_VDDD_OUT2_FV \
	io0x1d6, error_IO_PORT_SUPP2_TEST__TST_VDDD_OUT2_FV_has_no_byte_access, 0x01d6u, 0x01d6, 0x0400u, 0x04u, 10U, 2, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_SUPP2_TEST__TST_IO_LV \
	io0x1d6, error_IO_PORT_SUPP2_TEST__TST_IO_LV_has_no_byte_access, 0x01d6u, 0x01d6, 0x0800u, 0x08u, 11U, 3, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_SUPP2_TEST__FGTSM \
	io0x1d6, error_IO_PORT_SUPP2_TEST__FGTSM_has_no_byte_access, 0x01d6u, 0x01d6, 0x1000u, 0x10u, 12U, 4, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_SUPP2_TEST__FSTOP \
	io0x1d6, error_IO_PORT_SUPP2_TEST__FSTOP_has_no_byte_access, 0x01d6u, 0x01d6, 0x2000u, 0x20u, 13U, 5, 1U, 8u, 0xc000u, 0x0000u
...
#define IO_PORT_SPARE_TEST__TST_CPCLKSEL_DRV \
...
#define IO_PORT_ADC_TRIM_TEST__SEL_TR_RCO32M \
	io0x1dc, error_IO_PORT_ADC_TRIM_TEST__SEL_TR_RCO32M_has_no_byte_access, 0x01dcu, 0x01dc, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xfc00u, 0x0000u
#define IO_PORT_ADC_TRIM_TEST__SEL_TR_RCO1M \
	io0x1dc, error_IO_PORT_ADC_TRIM_TEST__SEL_TR_RCO1M_has_no_byte_access, 0x01dcu, 0x01dc, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0xfc00u, 0x0000u
#define IO_PORT_IO_IN__IO_IN_SYNC \
	io0x1de, error_IO_PORT_IO_IN__IO_IN_SYNC_has_no_byte_access, 0x01deu, 0x01de, 0x000fu, 0x0fu,  0U, 0, 0U, 8u, 0xffffu, 0x0000u
...
#define IO_PORT_SUPP_IN__OVC_IT \
	io0x1e0, error_IO_PORT_SUPP_IN__OVC_IT_has_no_byte_access, 0x01e0u, 0x01e0, 0x0100u, 0x01u,  8U, 0, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_SUPP_IN__OVC_SYNC \
	io0x1e0, error_IO_PORT_SUPP_IN__OVC_SYNC_has_no_byte_access, 0x01e0u, 0x01e0, 0x0200u, 0x02u,  9U, 1, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_SUPP_IN__UV_VDDAF_IT \
	io0x1e0, error_IO_PORT_SUPP_IN__UV_VDDAF_IT_has_no_byte_access, 0x01e0u, 0x01e0, 0x0400u, 0x04u, 10U, 2, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_SUPP_IN__UV_VDDAF_SYNC \
	io0x1e0, error_IO_PORT_SUPP_IN__UV_VDDAF_SYNC_has_no_byte_access, 0x01e0u, 0x01e0, 0x0800u, 0x08u, 11U, 3, 0U, 8u, 0xffffu, 0x0000u
...
#define IO_PORT_MISC_IN__STOP_MODE \
	io0x1e2, error_IO_PORT_MISC_IN__STOP_MODE_has_no_byte_access, 0x01e2u, 0x01e2, 0x0100u, 0x01u,  8U, 0, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_MISC_IN__RSTAT \
	io0x1e2, error_IO_PORT_MISC_IN__RSTAT_has_no_byte_access, 0x01e2u, 0x01e2, 0x0200u, 0x02u,  9U, 1, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_MISC_IN__INTERNAL_WU \
	io0x1e2, error_IO_PORT_MISC_IN__INTERNAL_WU_has_no_byte_access, 0x01e2u, 0x01e2, 0x0400u, 0x04u, 10U, 2, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_MISC_IN__LIN_WU \
	io0x1e2, error_IO_PORT_MISC_IN__LIN_WU_has_no_byte_access, 0x01e2u, 0x01e2, 0x0800u, 0x08u, 11U, 3, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_MISC_IN__PHYSTAT1 \
	io0x1e2, error_IO_PORT_MISC_IN__PHYSTAT1_has_no_byte_access, 0x01e2u, 0x01e2, 0x1000u, 0x10u, 12U, 4, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_MISC_IN__LIN_RXD \
	io0x1e2, error_IO_PORT_MISC_IN__LIN_RXD_has_no_byte_access, 0x01e2u, 0x01e2, 0x2000u, 0x20u, 13U, 5, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_MISC_IN__LOCAL_WU \
	io0x1e2, error_IO_PORT_MISC_IN__LOCAL_WU_has_no_byte_access, 0x01e2u, 0x01e2, 0x4000u, 0x40u, 14U, 6, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_MISC_IN__XOR_WU_IO \
	io0x1e2, error_IO_PORT_MISC_IN__XOR_WU_IO_has_no_byte_access, 0x01e2u, 0x01e2, 0x8000u, 0x80u, 15U, 7, 0U, 8u, 0xffffu, 0x0000u
...
#define IO_PORT_IO_OUT_SOFT__IO_OUT_SOFT \
	io0x1e6, io_byte_0x1e6, 0x01e6u, 0x01e6, 0x000fu, 0x0fu,  0U, 0, 1U, 12u, 0xfff0u, 0x0000u
...
#define IO_PORT_IO_OUT_EN__IO0_OD_ENABLE \
	io0x1e8, error_IO_PORT_IO_OUT_EN__IO0_OD_ENABLE_has_no_byte_access, 0x01e8u, 0x01e8, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xfc00u, 0x0000u
#define IO_PORT_IO_OUT_EN__IOX_OD_ENABLE \
	io0x1e8, error_IO_PORT_IO_OUT_EN__IOX_OD_ENABLE_has_no_byte_access, 0x01e8u, 0x01e8, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0xfc00u, 0x0000u
...
#define IO_PORT_IO_CFG0__IO2_OUT_SEL \
	io0x1ea, error_IO_PORT_IO_CFG0__IO2_OUT_SEL_has_no_byte_access, 0x01eau, 0x01ea, 0x0f00u, 0x0fu,  8U, 0, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_IO_CFG0__IO3_OUT_SEL \
	io0x1ea, error_IO_PORT_IO_CFG0__IO3_OUT_SEL_has_no_byte_access, 0x01eau, 0x01ea, 0xf000u, 0xf0u, 12U, 4, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_PORT_TIMER_CFG__TIMER0_CHB_SEL \
	io0x1ee, error_IO_PORT_TIMER_CFG__TIMER0_CHB_SEL_has_no_byte_access, 0x01eeu, 0x01ee, 0x1f00u, 0x1fu,  8U, 0, 1U, 8u, 0xe000u, 0x0000u
#define IO_PORT_COMM_CFG__SPI_MOSI_IN_SEL \
	io0x1f0, io_byte_0x1f0, 0x01f0u, 0x01f0, 0x0003u, 0x03u,  0U, 0, 1U, 12u, 0xc0ccu, 0x0000u
#define IO_PORT_COMM_CFG__SPI_MISO_IN_SEL \
	io0x1f0, io_byte_0x1f0, 0x01f0u, 0x01f0, 0x0030u, 0x30u,  4U, 4, 1U, 12u, 0xc0ccu, 0x0000u
#define IO_PORT_COMM_CFG__SPI_SCK_IN_SEL \
	io0x1f0, error_IO_PORT_COMM_CFG__SPI_SCK_IN_SEL_has_no_byte_access, 0x01f0u, 0x01f0, 0x0300u, 0x03u,  8U, 0, 1U, 8u, 0xc0ccu, 0x0000u
#define IO_PORT_COMM_CFG__UNUSED \
	io0x1f0, error_IO_PORT_COMM_CFG__UNUSED_has_no_byte_access, 0x01f0u, 0x01f0, 0x0c00u, 0x0cu, 10U, 2, 1U, 8u, 0xc0ccu, 0x0000u
#define IO_PORT_COMM_CFG__SPI_SS_IN_SEL \
	io0x1f0, error_IO_PORT_COMM_CFG__SPI_SS_IN_SEL_has_no_byte_access, 0x01f0u, 0x01f0, 0x3000u, 0x30u, 12U, 4, 1U, 8u, 0xc0ccu, 0x0000u
...
#define IO_PORT_MISC_OUT__PROV_VS \
	io0x1f2, error_IO_PORT_MISC_OUT__PROV_VS_has_no_byte_access, 0x01f2u, 0x01f2, 0x0600u, 0x06u,  9U, 1, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_MISC_OUT__PRUV_VDDA \
	io0x1f2, error_IO_PORT_MISC_OUT__PRUV_VDDA_has_no_byte_access, 0x01f2u, 0x01f2, 0x0800u, 0x08u, 11U, 3, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_MISC_OUT__SEL_TEMP \
	io0x1f2, error_IO_PORT_MISC_OUT__SEL_TEMP_has_no_byte_access, 0x01f2u, 0x01f2, 0xf000u, 0xf0u, 12U, 4, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_PORT_MISC2_OUT__WU_IO_EN \
	io0x1f4, error_IO_PORT_MISC2_OUT__WU_IO_EN_has_no_byte_access, 0x01f4u, 0x01f4, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xf800u, 0x0000u
#define IO_PORT_MISC2_OUT__ENABLE_OTD \
	io0x1f4, error_IO_PORT_MISC2_OUT__ENABLE_OTD_has_no_byte_access, 0x01f4u, 0x01f4, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0xf800u, 0x0000u
#define IO_PORT_MISC2_OUT__VSM_FILT_ON \
	io0x1f4, error_IO_PORT_MISC2_OUT__VSM_FILT_ON_has_no_byte_access, 0x01f4u, 0x01f4, 0x0400u, 0x04u, 10U, 2, 1U, 8u, 0xf800u, 0x0000u
...
#define IO_PORT_LINAA1__LINAA_RST1 \
	io0x202, error_IO_PORT_LINAA1__LINAA_RST1_has_no_byte_access, 0x0202u, 0x0202, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0xe000u, 0x0000u
#define IO_PORT_LINAA1__LINAA_RST2 \
	io0x202, error_IO_PORT_LINAA1__LINAA_RST2_has_no_byte_access, 0x0202u, 0x0202, 0x0400u, 0x04u, 10U, 2, 1U, 8u, 0xe000u, 0x0000u
#define IO_PORT_LINAA1__LINAA_EN \
	io0x202, error_IO_PORT_LINAA1__LINAA_EN_has_no_byte_access, 0x0202u, 0x0202, 0x0800u, 0x08u, 11U, 3, 1U, 8u, 0xe000u, 0x0000u
#define IO_PORT_LINAA1__LINAA_CDOUTEN \
	io0x202, error_IO_PORT_LINAA1__LINAA_CDOUTEN_has_no_byte_access, 0x0202u, 0x0202, 0x1000u, 0x10u, 12U, 4, 1U, 8u, 0xe000u, 0x0000u
...
#define IO_TRIM_MISC__TRIM_SDAFILT_IO \
	io0x206, error_IO_TRIM_MISC__TRIM_SDAFILT_IO_has_no_byte_access, 0x0206u, 0x0206, 0x3000u, 0x30u, 12U, 4, 1U, 8u, 0x4000u, 0x0000u
...
#define IO_TRIM2_DRV__TRIM_SLWRT \
	io0x20a, io_byte_0x20a, 0x020au, 0x020a, 0x000fu, 0x0fu,  0U, 0, 1U, 12u, 0x7e00u, 0x0000u
#define IO_TRIM2_DRV__TRIM_CSA_GAIN \
	io0x20a, error_IO_TRIM2_DRV__TRIM_CSA_GAIN_has_no_byte_access, 0x020au, 0x020a, 0x01f0u, 0xf0u,  4U, 4, 1U, 8u, 0x7e00u, 0x0000u
#define IO_TRIM2_DRV__LOCK \
	io0x20a, io_byte_0x20b, 0x020au, 0x020b, 0x8000u, 0x80u, 15U, 7, 1U, 12u, 0x7e00u, 0x0000u
...
#define IO_PORT_DRV_OUT__ENABLE_LS_OC \
	io0x20e, error_IO_PORT_DRV_OUT__ENABLE_LS_OC_has_no_byte_access, 0x020eu, 0x020e, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xf000u, 0x0000u
#define IO_PORT_DRV_OUT__DRVMOD_OPTION \
	io0x20e, error_IO_PORT_DRV_OUT__DRVMOD_OPTION_has_no_byte_access, 0x020eu, 0x020e, 0x0600u, 0x06u,  9U, 1, 1U, 8u, 0xf000u, 0x0000u
#define IO_PORT_DRV_OUT__PARALLEL_MODE_DRV \
	io0x20e, error_IO_PORT_DRV_OUT__PARALLEL_MODE_DRV_has_no_byte_access, 0x020eu, 0x020e, 0x0800u, 0x08u, 11U, 3, 1U, 8u, 0xf000u, 0x0000u
...
#define IO_PORT_DRV1_TEST__TST_STRS_VHS_HS_DRV \
	io0x210, error_IO_PORT_DRV1_TEST__TST_STRS_VHS_HS_DRV_has_no_byte_access, 0x0210u, 0x0210, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_TEST__TST_STRS_VHS_LS_DRV \
	io0x210, error_IO_PORT_DRV1_TEST__TST_STRS_VHS_LS_DRV_has_no_byte_access, 0x0210u, 0x0210, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_TEST__TST_OUT_LV1 \
	io0x210, error_IO_PORT_DRV1_TEST__TST_OUT_LV1_has_no_byte_access, 0x0210u, 0x0210, 0x3c00u, 0x3cu, 10U, 2, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_TEST__TST_UVCMP_LV1_DRVSUP \
	io0x210, error_IO_PORT_DRV1_TEST__TST_UVCMP_LV1_DRVSUP_has_no_byte_access, 0x0210u, 0x0210, 0x4000u, 0x40u, 14U, 6, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_TEST__TST_VBGCS_LV0_DRVSUP \
	io0x210, error_IO_PORT_DRV1_TEST__TST_VBGCS_LV0_DRVSUP_has_no_byte_access, 0x0210u, 0x0210, 0x8000u, 0x80u, 15U, 7, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_PORT_DRV2_TEST__TST_DRVSUP \
	io0x212, error_IO_PORT_DRV2_TEST__TST_DRVSUP_has_no_byte_access, 0x0212u, 0x0212, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_DRV2_TEST__TEST_DRVMOD_CPCLK \
	io0x212, error_IO_PORT_DRV2_TEST__TEST_DRVMOD_CPCLK_has_no_byte_access, 0x0212u, 0x0212, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_DRV2_TEST__TEST_DRV_ILD \
	io0x212, error_IO_PORT_DRV2_TEST__TEST_DRV_ILD_has_no_byte_access, 0x0212u, 0x0212, 0x0c00u, 0x0cu, 10U, 2, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_DRV2_TEST__TST_OC_REDUCE_LVL \
	io0x212, error_IO_PORT_DRV2_TEST__TST_OC_REDUCE_LVL_has_no_byte_access, 0x0212u, 0x0212, 0x1000u, 0x10u, 12U, 4, 1U, 8u, 0xc000u, 0x0000u
#define IO_PORT_DRV2_TEST__TST_DRVSUP_DISC_CMP \
	io0x212, error_IO_PORT_DRV2_TEST__TST_DRVSUP_DISC_CMP_has_no_byte_access, 0x0212u, 0x0212, 0x2000u, 0x20u, 13U, 5, 1U, 8u, 0xc000u, 0x0000u
...
#define IO_PORT_DRV3_TEST__TST_AMP_DIV_LV0_CSA \
	io0x214, error_IO_PORT_DRV3_TEST__TST_AMP_DIV_LV0_CSA_has_no_byte_access, 0x0214u, 0x0214, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xf000u, 0x0000u
#define IO_PORT_DRV3_TEST__TST_DAC_LV0_CSA \
	io0x214, error_IO_PORT_DRV3_TEST__TST_DAC_LV0_CSA_has_no_byte_access, 0x0214u, 0x0214, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0xf000u, 0x0000u
#define IO_PORT_DRV3_TEST__TST_V5V_DIV3 \
	io0x214, error_IO_PORT_DRV3_TEST__TST_V5V_DIV3_has_no_byte_access, 0x0214u, 0x0214, 0x0400u, 0x04u, 10U, 2, 1U, 8u, 0xf000u, 0x0000u
#define IO_PORT_DRV3_TEST__TST_DRVMOD_CPCLK_DAC \
	io0x214, error_IO_PORT_DRV3_TEST__TST_DRVMOD_CPCLK_DAC_has_no_byte_access, 0x0214u, 0x0214, 0x0800u, 0x08u, 11U, 3, 1U, 8u, 0xf000u, 0x0000u
...
#define IO_PORT_DRV_CTRL__DRV2_CTRL \
	io0x216, error_IO_PORT_DRV_CTRL__DRV2_CTRL_has_no_byte_access, 0x0216u, 0x0216, 0x0f00u, 0x0fu,  8U, 0, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV_CTRL__DRV3_CTRL \
	io0x216, error_IO_PORT_DRV_CTRL__DRV3_CTRL_has_no_byte_access, 0x0216u, 0x0216, 0xf000u, 0xf0u, 12U, 4, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_PORT_DRV1_PROT__UV_VDDAF_PM \
	io0x218, error_IO_PORT_DRV1_PROT__UV_VDDAF_PM_has_no_byte_access, 0x0218u, 0x0218, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_PROT__DIS_UV_VDDAF \
	io0x218, error_IO_PORT_DRV1_PROT__DIS_UV_VDDAF_has_no_byte_access, 0x0218u, 0x0218, 0x0200u, 0x02u,  9U, 1, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_PROT__OC_PM \
	io0x218, error_IO_PORT_DRV1_PROT__OC_PM_has_no_byte_access, 0x0218u, 0x0218, 0x0400u, 0x04u, 10U, 2, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_PROT__DIS_OC \
	io0x218, error_IO_PORT_DRV1_PROT__DIS_OC_has_no_byte_access, 0x0218u, 0x0218, 0x0800u, 0x08u, 11U, 3, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_PROT__OV_HS_VDS_PM \
	io0x218, error_IO_PORT_DRV1_PROT__OV_HS_VDS_PM_has_no_byte_access, 0x0218u, 0x0218, 0x1000u, 0x10u, 12U, 4, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_PROT__DIS_OV_HS_VDS \
	io0x218, error_IO_PORT_DRV1_PROT__DIS_OV_HS_VDS_has_no_byte_access, 0x0218u, 0x0218, 0x2000u, 0x20u, 13U, 5, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_PROT__OV_LS_VDS_PM \
	io0x218, error_IO_PORT_DRV1_PROT__OV_LS_VDS_PM_has_no_byte_access, 0x0218u, 0x0218, 0x4000u, 0x40u, 14U, 6, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_DRV1_PROT__DIS_OV_LS_VDS \
	io0x218, error_IO_PORT_DRV1_PROT__DIS_OV_LS_VDS_has_no_byte_access, 0x0218u, 0x0218, 0x8000u, 0x80u, 15U, 7, 1U, 8u, 0x0000u, 0x0000u
...
#define IO_PORT_DRV_IN__OV_LS_VDS_SYNC \
	io0x21c, error_IO_PORT_DRV_IN__OV_LS_VDS_SYNC_has_no_byte_access, 0x021cu, 0x021c, 0x0f00u, 0x0fu,  8U, 0, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_DRV_IN__OV_LS_VDS0_IT \
	io0x21c, error_IO_PORT_DRV_IN__OV_LS_VDS0_IT_has_no_byte_access, 0x021cu, 0x021c, 0x1000u, 0x10u, 12U, 4, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_DRV_IN__OV_LS_VDS1_IT \
	io0x21c, error_IO_PORT_DRV_IN__OV_LS_VDS1_IT_has_no_byte_access, 0x021cu, 0x021c, 0x2000u, 0x20u, 13U, 5, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_DRV_IN__OV_LS_VDS2_IT \
	io0x21c, error_IO_PORT_DRV_IN__OV_LS_VDS2_IT_has_no_byte_access, 0x021cu, 0x021c, 0x4000u, 0x40u, 14U, 6, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_DRV_IN__OV_LS_VDS3_IT \
	io0x21c, error_IO_PORT_DRV_IN__OV_LS_VDS3_IT_has_no_byte_access, 0x021cu, 0x021c, 0x8000u, 0x80u, 15U, 7, 0U, 8u, 0xffffu, 0x0000u
...
#define IO_PORT_DIAG_IN__OV_LS_VDS_MEM \
	io0x21e, error_IO_PORT_DIAG_IN__OV_LS_VDS_MEM_has_no_byte_access, 0x021eu, 0x021e, 0x3c00u, 0x3cu, 10U, 2, 0U, 8u, 0xffffu, 0x0000u
#define IO_PORT_I2C_CONF__I2C_ADDR \
	io0x220, io_byte_0x220, 0x0220u, 0x0220, 0x007fu, 0x7fu,  0U, 0, 1U, 12u, 0xf800u, 0x0000u
#define IO_PORT_I2C_CONF__I2C_ADDR_VALID \
	io0x220, io_byte_0x220, 0x0220u, 0x0220, 0x0080u, 0x80u,  7U, 7, 1U, 12u, 0xf800u, 0x0000u
#define IO_PORT_I2C_CONF__SDA_FILT_ENABLE \
	io0x220, error_IO_PORT_I2C_CONF__SDA_FILT_ENABLE_has_no_byte_access, 0x0220u, 0x0220, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xf800u, 0x0000u
#define IO_PORT_I2C_CONF__I2C_SCL_CLK_SEL \
	io0x220, error_IO_PORT_I2C_CONF__I2C_SCL_CLK_SEL_has_no_byte_access, 0x0220u, 0x0220, 0x0600u, 0x06u,  9U, 1, 1U, 8u, 0xf800u, 0x0000u
...
#define IO_PORT_MISC_TEST__DIS_TX_TIMEOUT \
	io0x226, error_IO_PORT_MISC_TEST__DIS_TX_TIMEOUT_has_no_byte_access, 0x0226u, 0x0226, 0x0100u, 0x01u,  8U, 0, 1U, 8u, 0xfe00u, 0x0000u
...
#define IO_PORT_PPM_CTRL__PPM_DAT_IT_NB \
	io0x22e, error_IO_PORT_PPM_CTRL__PPM_DAT_IT_NB_has_no_byte_access, 0x022eu, 0x022e, 0x0300u, 0x03u,  8U, 0, 1U, 8u, 0x8000u, 0x0000u
#define IO_PORT_PPM_CTRL__PPM_TX_RX \
	io0x22e, error_IO_PORT_PPM_CTRL__PPM_TX_RX_has_no_byte_access, 0x022eu, 0x022e, 0x0400u, 0x04u, 10U, 2, 1U, 8u, 0x8000u, 0x0000u
#define IO_PORT_PPM_CTRL__PPM_IN_SEL \
	io0x22e, error_IO_PORT_PPM_CTRL__PPM_IN_SEL_has_no_byte_access, 0x022eu, 0x022e, 0x7800u, 0x78u, 11U, 3, 1U, 8u, 0x8000u, 0x0000u
...
#define IO_PORT_STEP2_CONF__STEP2_CNT \
	io0x238, error_IO_PORT_STEP2_CONF__STEP2_CNT_has_no_byte_access, 0x0238u, 0x0238, 0xff00u, 0xffu,  8U, 0, 1U, 8u, 0x0000u, 0x0000u
#define IO_PORT_IO_ENABLE__IO_ENABLE \
	io0x23a, io_byte_0x23a, 0x023au, 0x023a, 0x000fu, 0x0fu,  0U, 0, 1U, 12u, 0xf000u, 0x0000u
#define IO_PORT_IO_ENABLE__UNUSED \
	io0x23a, io_byte_0x23a, 0x023au, 0x023a, 0x00f0u, 0xf0u,  4U, 4, 1U, 12u, 0xf000u, 0x0000u
#define IO_PORT_IO_ENABLE__IO_DISREC \
	io0x23a, error_IO_PORT_IO_ENABLE__IO_DISREC_has_no_byte_access, 0x023au, 0x023a, 0x0f00u, 0x0fu,  8U, 0, 1U, 8u, 0xf000u, 0x0000u
#define IO_PORT_TIMER_CFG1__TIMER1_CHA_SEL \
	io0x23c, io_byte_0x23c, 0x023cu, 0x023c, 0x001fu, 0x1fu,  0U, 0, 1U, 12u, 0xe000u, 0x0000u
#define IO_PORT_TIMER_CFG1__UNUSED \
	io0x23c, io_byte_0x23c, 0x023cu, 0x023c, 0x00e0u, 0xe0u,  5U, 5, 1U, 12u, 0xe000u, 0x0000u
#define IO_PORT_TIMER_CFG1__TIMER1_CHB_SEL \
	io0x23c, error_IO_PORT_TIMER_CFG1__TIMER1_CHB_SEL_has_no_byte_access, 0x023cu, 0x023c, 0x1f00u, 0x1fu,  8U, 0, 1U, 8u, 0xe000u, 0x0000u
#define IO_PORT_IO_TRIG_EDGE_CFG__IO0_TRIG_EDGE_SEL \
	io0x23e, io_byte_0x23e, 0x023eu, 0x023e, 0x0003u, 0x03u,  0U, 0, 1U, 12u, 0xff00u, 0x0000u
#define IO_PORT_IO_TRIG_EDGE_CFG__IO1_TRIG_EDGE_SEL \
	io0x23e, io_byte_0x23e, 0x023eu, 0x023e, 0x000cu, 0x0cu,  2U, 2, 1U, 12u, 0xff00u, 0x0000u
#define IO_PORT_IO_TRIG_EDGE_CFG__IO2_TRIG_EDGE_SEL \
	io0x23e, io_byte_0x23e, 0x023eu, 0x023e, 0x0030u, 0x30u,  4U, 4, 1U, 12u, 0xff00u, 0x0000u
#define IO_PORT_IO_TRIG_EDGE_CFG__IO3_TRIG_EDGE_SEL \
	io0x23e, io_byte_0x23e, 0x023eu, 0x023e, 0x00c0u, 0xc0u,  6U, 6, 1U, 12u, 0xff00u, 0x0000u
#define IO_PORT_TX_TIMEOUT__TX_TIMEOUT \
	io0x240, error_IO_PORT_TX_TIMEOUT__TX_TIMEOUT_has_no_byte_access, 0x0240u, 0x0240, 0x0001u, 0x01u,  0U, 0, 0U, 8u, 0xffffu, 0x0000u
...
/*
 * Range: 0x0002u to 0x0240u
 * Variables: 210
 * Fields: 816
 * Occupation: 85.06% (357.2 bytes)
 */
