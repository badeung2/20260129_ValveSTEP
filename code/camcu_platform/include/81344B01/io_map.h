...
typedef struct io_trim_adc_s {
    uint16_t ADC_INTREF_TRM : 3;
    uint16_t ADC_BLOCK_LATCHCTRL : 1;
    uint16_t ADC_BLOCK_INTERCHOP : 1;
    uint16_t ADC_BLOCK_BYPASSBUF : 1;
    uint16_t reserved_6 : 9;
    uint16_t LOCK : 1;
} io_trim_adc_t;

extern volatile io_trim_adc_t TRIM_ADC __attribute__((io, addr(0x34)));

typedef struct io_port_lin_xkey_s {
    uint16_t LIN_XKEY;
} io_port_lin_xkey_t;

extern volatile io_port_lin_xkey_t PORT_LIN_XKEY __attribute__((io, addr(0x36)));
...
typedef struct io_mlx16_s {
    ...
    union {
        ...
        struct {
            ...
            uint16_t UV_BOOST_PEND : 1;
            uint16_t ANA_PLL_ERR_PEND : 1;
            uint16_t OVT_PEND : 1;
            uint16_t OVC_PEND : 1;
            uint16_t OC_VDDA_PEND : 1;
            uint16_t OV_HS_IO3_PEND : 1;
            uint16_t OV_HS_IO4_PEND : 1;
    ...
    union {
        ...
        struct {
            ...
            uint16_t OV_VDDA_PEND : 1;
            uint16_t OV_BOOST_PEND : 1;
            ...
            uint16_t IO_IN8_PEND : 1;
            uint16_t IO_IN9_PEND : 1;
            uint16_t IO_IN10_PEND : 1;
            uint16_t IO_IN11_PEND : 1;
    ...
    union {
        uint16_t ITC_PEND4;
        struct {
            uint16_t UART0_SB_PEND : 1;
            uint16_t UART0_RS_PEND : 1;
            uint16_t UART0_RR_PEND : 1;
            uint16_t UART0_TS_PEND : 1;
            uint16_t UART0_TR_PEND : 1;
            uint16_t UART0_TE_PEND : 1;
            uint16_t UDFR0_PEND : 1;
            uint16_t UDTF0_PEND : 1;
            uint16_t UART1_SB_PEND : 1;
            uint16_t UART1_RS_PEND : 1;
            uint16_t UART1_RR_PEND : 1;
            uint16_t UART1_TS_PEND : 1;
            uint16_t UART1_TR_PEND : 1;
            uint16_t UART1_TE_PEND : 1;
            uint16_t UDFR1_PEND : 1;
            uint16_t UDTF1_PEND : 1;
        };
    };
    union {
        uint16_t ITC_PEND5 : 5;
        struct {
            uint16_t ACTIVE_CDI_PEND : 1;
            uint16_t I2C_EOW_PEND : 1;
            uint16_t I2C_EOR_PEND : 1;
            uint16_t I2C_ERR_PEND : 1;
            uint16_t MLX16_SOFT_PEND : 1;
            uint16_t reserved_277 : 11;
        };
    };
    ...
    union {
        ...
        struct {
            ...
            uint16_t UV_BOOST_ITC : 1;
            uint16_t ANA_PLL_ERR_ITC : 1;
            uint16_t OVT_ITC : 1;
            uint16_t OVC_ITC : 1;
            uint16_t OC_VDDA_ITC : 1;
            uint16_t OV_HS_IO3_ITC : 1;
            uint16_t OV_HS_IO4_ITC : 1;
    ...
    union {
        ...
        struct {
            ...
            uint16_t OV_VDDA_ITC : 1;
            uint16_t OV_BOOST_ITC : 1;
            ...
            uint16_t IO_IN8_ITC : 1;
            uint16_t IO_IN9_ITC : 1;
            uint16_t IO_IN10_ITC : 1;
            uint16_t IO_IN11_ITC : 1;
    ...
    union {
        uint16_t ITC_MASK4;
        struct {
            uint16_t UART0_SB_ITC : 1;
            uint16_t UART0_RS_ITC : 1;
            uint16_t UART0_RR_ITC : 1;
            uint16_t UART0_TS_ITC : 1;
            uint16_t UART0_TR_ITC : 1;
            uint16_t UART0_TE_ITC : 1;
            uint16_t UDFR0_ITC : 1;
            uint16_t UDTF0_ITC : 1;
            uint16_t UART1_SB_ITC : 1;
            uint16_t UART1_RS_ITC : 1;
            uint16_t UART1_RR_ITC : 1;
            uint16_t UART1_TS_ITC : 1;
            uint16_t UART1_TR_ITC : 1;
            uint16_t UART1_TE_ITC : 1;
            uint16_t UDFR1_ITC : 1;
            uint16_t UDTF1_ITC : 1;
        };
    };
    union {
        uint16_t ITC_MASK5 : 5;
        struct {
            uint16_t ACTIVE_CDI_ITC : 1;
            uint16_t I2C_EOW_ITC : 1;
            uint16_t I2C_EOR_ITC : 1;
            uint16_t I2C_ERR_ITC : 1;
            uint16_t MLX16_SOFT_ITC : 1;
            uint16_t reserved_501 : 11;
        };
    };
    ...
    union {
        ...
        struct {
            ...
            uint16_t OV_VDDA_PRIO : 2;
            uint16_t OV_BOOST_PRIO : 2;
    ...
    union {
        ...
        struct {
            ...
            uint16_t IO_IN8_PRIO : 2;
            uint16_t IO_IN9_PRIO : 2;
        };
    };
    union {
        uint16_t ITC_PRIO5;
        struct {
            uint16_t IO_IN10_PRIO : 2;
            uint16_t IO_IN11_PRIO : 2;
            uint16_t TX_TIMEOUT_PRIO : 2;
            uint16_t UART0_SB_PRIO : 2;
            uint16_t UART0_RS_PRIO : 2;
            uint16_t UART0_RR_PRIO : 2;
            uint16_t UART0_TS_PRIO : 2;
            uint16_t UART0_TR_PRIO : 2;
        };
    };
    union {
        uint16_t ITC_PRIO6;
        struct {
            uint16_t UART0_TE_PRIO : 2;
            uint16_t UDFR0_PRIO : 2;
            uint16_t UDTF0_PRIO : 2;
            uint16_t UART1_SB_PRIO : 2;
            uint16_t UART1_RS_PRIO : 2;
            uint16_t UART1_RR_PRIO : 2;
            uint16_t UART1_TS_PRIO : 2;
            uint16_t UART1_TR_PRIO : 2;
        };
    };
    union {
        uint16_t ITC_PRIO7 : 14;
        struct {
            uint16_t UART1_TE_PRIO : 2;
            uint16_t UDFR1_PRIO : 2;
            uint16_t UDTF1_PRIO : 2;
            uint16_t ACTIVE_CDI_PRIO : 2;
            uint16_t I2C_EOW_PRIO : 2;
            uint16_t I2C_EOR_PRIO : 2;
            uint16_t I2C_ERR_PRIO : 2;
            uint16_t reserved_766 : 2;
        };
    };
...
typedef struct io_adc_block_s {
    ...
    uint16_t RESUME : 1;
    uint16_t SW_TRIG : 1;
    const uint16_t READY : 1;
    const uint16_t LAST_INT_SRC : 2;
    ...
    uint16_t reserved_55 : 1;
    uint16_t CLK_TO_INT : 2;
    uint16_t CM_PRCHRG_TIME : 3;
    uint16_t CM_PRCHRG : 2;
    uint16_t reserved_63 : 1;
    uint16_t COUNT : 3;
    const uint16_t TYPE : 1;
    uint16_t MODE : 1;
    uint16_t FR : 2;
    uint16_t START_PHI : 1;
    uint16_t OUTMODE : 1;
    uint16_t FORCE : 2;
    uint16_t NOCHOP : 1;
    uint16_t INTREF : 1;
    uint16_t SPEED : 2;
    uint16_t REF_ALWAYS_ON : 1;
    uint16_t SRC : 6;
    uint16_t TEST_INP : 1;
    uint16_t TEST_INN : 1;
    uint16_t TEST_COMP : 1;
    uint16_t TEST_ANA : 1;
    uint16_t TEST_EN_TESTOV : 1;
    uint16_t TEST_COMPNODELAY : 1;
    uint16_t TEST_CMM : 2;
    uint16_t TEST_NONOV_CTRL : 1;
    uint16_t TEST_CHOP_TESTOV : 1;
    uint16_t CORR_15_0;
    uint16_t CORR_31_16;
    uint16_t CORR_46_32 : 15;
} io_adc_block_t;

extern volatile io_adc_block_t ADC_BLOCK __attribute__((nodp, addr(0x166)));
...
extern volatile io_eeprom_flash_t EEPROM_FLASH __attribute__((nodp, addr(0x196)));
...
extern volatile io_colin_t COLIN __attribute__((nodp, addr(0x1cc)));
...
extern volatile io_trim_bg_bias_t TRIM_BG_BIAS __attribute__((nodp, addr(0x1e6)));
...
extern volatile io_trim_vdd_t TRIM_VDD __attribute__((nodp, addr(0x1e8)));
...
extern volatile io_trim_rco32m_t TRIM_RCO32M __attribute__((nodp, addr(0x1ea)));

typedef struct io_trim_rco1m_s {
    uint16_t TR_RCO1M : 8;
    uint16_t TR_LIN_SLEWRATE : 3;
    uint16_t TR_LIN_SLVTERM : 3;
    uint16_t TR_UNUSED : 1;
    uint16_t LOCK : 1;
} io_trim_rco1m_t;

extern volatile io_trim_rco1m_t TRIM_RCO1M __attribute__((nodp, addr(0x1ec)));
...
extern volatile io_port_sscm_conf_t PORT_SSCM_CONF __attribute__((nodp, addr(0x1ee)));
...
extern volatile io_port_step_conf_t PORT_STEP_CONF __attribute__((nodp, addr(0x1f0)));
...
extern volatile io_port_supp_test_t PORT_SUPP_TEST __attribute__((nodp, addr(0x1f2)));
...
typedef struct io_port_supp2_test_s {
    ...
    uint16_t TST_GNDD_TA1 : 1;
    uint16_t IDDQ_CLK10K : 1;
    uint16_t FGTSM : 1;
    uint16_t FSTOP : 1;
} io_port_supp2_test_t;

extern volatile io_port_supp2_test_t PORT_SUPP2_TEST __attribute__((nodp, addr(0x1f4)));

typedef struct io_port_lin_test_s {
    uint16_t TEST_2U8_BIASLIN : 1;
} io_port_lin_test_t;

extern volatile io_port_lin_test_t PORT_LIN_TEST __attribute__((nodp, addr(0x1f6)));

typedef struct io_port_spare_test_s {
    uint16_t TEST_SUP : 8;
} io_port_spare_test_t;

extern volatile io_port_spare_test_t PORT_SPARE_TEST __attribute__((nodp, addr(0x1f8)));

typedef struct io_port_io_in_s {
    const uint16_t IO_IN_SYNC : 12;
} io_port_io_in_t;

extern volatile io_port_io_in_t PORT_IO_IN __attribute__((nodp, addr(0x1fa)));

typedef struct io_port_supp_in_s {
    const uint16_t UV_VDDA_IT : 1;
    const uint16_t UV_VDDA_SYNC : 1;
    const uint16_t OV_VDDA_IT : 1;
    const uint16_t OV_VDDA_SYNC : 1;
    ...
    const uint16_t UV_BOOST_IT : 1;
    const uint16_t UV_BOOST_SYNC : 1;
    const uint16_t OV_BOOST_IT : 1;
    const uint16_t OV_BOOST_SYNC : 1;
} io_port_supp_in_t;

extern volatile io_port_supp_in_t PORT_SUPP_IN __attribute__((nodp, addr(0x1fc)));

typedef struct io_port_supp2_in_s {
    const uint16_t OC_VDDA_IT : 1;
    const uint16_t OC_VDDA_SYNC : 1;
    const uint16_t OV_HS_IO3_IT : 1;
    const uint16_t OV_HS_IO3_SYNC : 1;
    const uint16_t OV_HS_IO4_IT : 1;
    const uint16_t OV_HS_IO4_SYNC : 1;
} io_port_supp2_in_t;

extern volatile io_port_supp2_in_t PORT_SUPP2_IN __attribute__((nodp, addr(0x1fe)));
...
extern volatile io_port_misc_in_t PORT_MISC_IN __attribute__((nodp, addr(0x200)));

typedef struct io_port_supp_cfg_s {
    uint16_t UV_VDDA_FILT_SEL : 1;
    uint16_t OV_VDDA_FILT_SEL : 1;
    uint16_t OC_VDDA_FILT_SEL : 1;
    uint16_t UV_BOOST_FILT_SEL : 1;
    uint16_t OV_BOOST_FILT_SEL : 1;
    uint16_t UV_VS_FILT_SEL : 1;
    uint16_t OV_VS_FILT_SEL : 1;
    uint16_t OVT_FILT_SEL : 1;
    uint16_t OV_HS_IO3_FILT_SEL : 1;
    uint16_t OV_HS_IO4_FILT_SEL : 1;
} io_port_supp_cfg_t;

extern volatile io_port_supp_cfg_t PORT_SUPP_CFG __attribute__((nodp, addr(0x202)));

typedef struct io_port_oc_deb_s {
    uint16_t CNT_OC : 4;
    uint16_t DIV_OC : 3;
} io_port_oc_deb_t;

extern volatile io_port_oc_deb_t PORT_OC_DEB __attribute__((nodp, addr(0x204)));

typedef struct io_port_mask_ov_hs_io_s {
    uint16_t CNT_MASK3_OV_HS_IO : 4;
    uint16_t CNT_MASK4_OV_HS_IO : 4;
    uint16_t DIV_MASK_OV_HS_IO : 4;
} io_port_mask_ov_hs_io_t;

extern volatile io_port_mask_ov_hs_io_t PORT_MASK_OV_HS_IO __attribute__((nodp, addr(0x206)));

typedef struct io_port_io_out_soft_s {
    uint16_t IO_OUT_SOFT : 12;
} io_port_io_out_soft_t;

extern volatile io_port_io_out_soft_t PORT_IO_OUT_SOFT __attribute__((nodp, addr(0x208)));

typedef struct io_port_io_out_en_s {
    uint16_t IO_OD_ENABLE : 5;
    uint16_t IO_HS_ENABLE : 5;
    uint16_t IO_LV_ENABLE : 5;
} io_port_io_out_en_t;

extern volatile io_port_io_out_en_t PORT_IO_OUT_EN __attribute__((nodp, addr(0x20a)));
...
extern volatile io_port_io_enable_t PORT_IO_ENABLE __attribute__((nodp, addr(0x20c)));

typedef struct io_port_io_enable1_s {
    uint16_t IO_ENABLE : 4;
    uint16_t IO_DISREC : 4;
} io_port_io_enable1_t;

extern volatile io_port_io_enable1_t PORT_IO_ENABLE1 __attribute__((nodp, addr(0x20e)));
...
extern volatile io_port_io_cfg0_t PORT_IO_CFG0 __attribute__((nodp, addr(0x210)));
...
extern volatile io_port_io_cfg1_t PORT_IO_CFG1 __attribute__((nodp, addr(0x212)));

typedef struct io_port_io_cfg2_s {
    uint16_t IO8_OUT_SEL : 4;
    uint16_t IO9_OUT_SEL : 4;
    uint16_t IO10_OUT_SEL : 4;
    uint16_t IO11_OUT_SEL : 4;
} io_port_io_cfg2_t;

extern volatile io_port_io_cfg2_t PORT_IO_CFG2 __attribute__((nodp, addr(0x214)));

typedef struct io_port_io_uart_sel_s {
    uint16_t IO_UART_SEL : 12;
} io_port_io_uart_sel_t;

extern volatile io_port_io_uart_sel_t PORT_IO_UART_SEL __attribute__((nodp, addr(0x216)));
...
extern volatile io_port_io_trig_edge_cfg_t PORT_IO_TRIG_EDGE_CFG __attribute__((nodp, addr(0x218)));

typedef struct io_port_io_trig_edge_cfg1_s {
    uint16_t IO8_TRIG_EDGE_SEL : 2;
    uint16_t IO9_TRIG_EDGE_SEL : 2;
    uint16_t IO10_TRIG_EDGE_SEL : 2;
    uint16_t IO11_TRIG_EDGE_SEL : 2;
} io_port_io_trig_edge_cfg1_t;

extern volatile io_port_io_trig_edge_cfg1_t PORT_IO_TRIG_EDGE_CFG1 __attribute__((nodp, addr(0x21a)));

typedef struct io_port_lin_xtx_cfg_s {
    uint16_t LIN_XTX_OUT_SEL : 5;
    uint16_t LIN_COLIN_RX_SEL : 2;
    uint16_t LIN_OUT_SOFT : 1;
    uint16_t LIN_IN_SOFT : 1;
} io_port_lin_xtx_cfg_t;

extern volatile io_port_lin_xtx_cfg_t PORT_LIN_XTX_CFG __attribute__((nodp, addr(0x21c)));
...
extern volatile io_port_timer_cfg_t PORT_TIMER_CFG __attribute__((nodp, addr(0x21e)));
...
extern volatile io_port_timer_cfg1_t PORT_TIMER_CFG1 __attribute__((nodp, addr(0x220)));

typedef struct io_port_comm_cfg_s {
    uint16_t SPI_MOSI_IN_SEL : 4;
    uint16_t SPI_MISO_IN_SEL : 4;
    uint16_t SPI_SCK_IN_SEL : 4;
    uint16_t SPI_SS_IN_SEL : 4;
} io_port_comm_cfg_t;

extern volatile io_port_comm_cfg_t PORT_COMM_CFG __attribute__((nodp, addr(0x222)));

typedef struct io_port_comm_cfg1_s {
    uint16_t UART0_RX_SEL : 4;
    uint16_t UART1_RX_SEL : 4;
} io_port_comm_cfg1_t;

extern volatile io_port_comm_cfg1_t PORT_COMM_CFG1 __attribute__((nodp, addr(0x224)));
...
extern volatile io_port_misc_out_t PORT_MISC_OUT __attribute__((nodp, addr(0x226)));
...
typedef struct io_port_misc2_out_s {
    ...
    uint16_t DIS_TEMPSENSE : 1;
} io_port_misc2_out_t;

extern volatile io_port_misc2_out_t PORT_MISC2_OUT __attribute__((nodp, addr(0x228)));

typedef struct io_port_stopmd_ctrl_s {
    uint16_t SEL_STOP_MODE : 1;
} io_port_stopmd_ctrl_t;

extern volatile io_port_stopmd_ctrl_t PORT_STOPMD_CTRL __attribute__((nodp, addr(0x22a)));
...
extern volatile io_port_stopmd_cfg_t PORT_STOPMD_CFG __attribute__((nodp, addr(0x22c)));

typedef struct io_port_dis_gtsm_s {
    uint16_t DIS_GTSM : 1;
} io_port_dis_gtsm_t;

extern volatile io_port_dis_gtsm_t PORT_DIS_GTSM __attribute__((nodp, addr(0x22e)));

typedef struct io_port_lin_xcfg_s {
    uint16_t LIN_XCFG;
} io_port_lin_xcfg_t;

extern volatile io_port_lin_xcfg_t PORT_LIN_XCFG __attribute__((nodp, addr(0x230)));

typedef struct io_port_lin_xcfg_valid_s {
    const uint16_t LIN_XCFG_VALID;
} io_port_lin_xcfg_valid_t;

extern volatile io_port_lin_xcfg_valid_t PORT_LIN_XCFG_VALID __attribute__((nodp, addr(0x232)));

typedef struct io_port_clock_ctrl_s {
    uint16_t AC_SEL : 1;
} io_port_clock_ctrl_t;

extern volatile io_port_clock_ctrl_t PORT_CLOCK_CTRL __attribute__((nodp, addr(0x234)));
...
extern volatile io_trim_misc_t TRIM_MISC __attribute__((nodp, addr(0x236)));
...
extern volatile io_port_drv_ctrl_t PORT_DRV_CTRL __attribute__((nodp, addr(0x238)));
...
extern volatile io_port_drv1_prot_t PORT_DRV1_PROT __attribute__((nodp, addr(0x23a)));

typedef struct io_port_drv2_prot_s {
    uint16_t DIS_DRV : 1;
    uint16_t EN_DRV : 1;
    uint16_t FREEZE_LS : 3;
    uint16_t FREEZE_HS : 3;
} io_port_drv2_prot_t;

extern volatile io_port_drv2_prot_t PORT_DRV2_PROT __attribute__((nodp, addr(0x23c)));

typedef struct io_port_drv3_prot_s {
    uint16_t OV_BOOST_PM : 1;
    uint16_t DIS_OV_BOOST : 1;
    uint16_t UV_BOOST_PM : 1;
    uint16_t DIS_UV_BOOST : 1;
    uint16_t OV_VDDA_PM : 1;
    uint16_t DIS_OV_VDDA : 1;
    uint16_t OC_VDDA_PM : 1;
    uint16_t DIS_OC_VDDA : 1;
} io_port_drv3_prot_t;

extern volatile io_port_drv3_prot_t PORT_DRV3_PROT __attribute__((nodp, addr(0x23e)));

typedef struct io_port_drv_in_s {
    const uint16_t OV_HS_VDS_SYNC : 3;
    const uint16_t OV_HS_VDS0_IT : 1;
    const uint16_t OV_HS_VDS1_IT : 1;
    const uint16_t OV_HS_VDS2_IT : 1;
    const uint16_t OV_LS_VDS_SYNC : 3;
    const uint16_t OV_LS_VDS0_IT : 1;
    const uint16_t OV_LS_VDS1_IT : 1;
    const uint16_t OV_LS_VDS2_IT : 1;
} io_port_drv_in_t;

extern volatile io_port_drv_in_t PORT_DRV_IN __attribute__((nodp, addr(0x240)));
...
typedef struct io_port_diag_in_s {
    ...
    const uint16_t OV_VDDA_MEM : 1;
    const uint16_t OVC_MEM : 1;
    const uint16_t OC_VDDA_MEM : 1;
    const uint16_t UV_BOOST_MEM : 1;
    const uint16_t OV_BOOST_MEM : 1;
    const uint16_t OV_HS_VDS_MEM : 3;
    const uint16_t OV_LS_VDS_MEM : 3;
} io_port_diag_in_t;

extern volatile io_port_diag_in_t PORT_DIAG_IN __attribute__((nodp, addr(0x242)));

typedef struct io_port_div_vds_deb_s {
    uint16_t DIV_VDS : 3;
} io_port_div_vds_deb_t;

extern volatile io_port_div_vds_deb_t PORT_DIV_VDS_DEB __attribute__((nodp, addr(0x244)));

typedef struct io_port_cnt_vds_deb_s {
    uint16_t CNT0_VDS : 4;
    uint16_t CNT1_VDS : 4;
    uint16_t CNT2_VDS : 4;
} io_port_cnt_vds_deb_t;

extern volatile io_port_cnt_vds_deb_t PORT_CNT_VDS_DEB __attribute__((nodp, addr(0x246)));

typedef struct io_port_div_mask_vds_s {
    uint16_t DIV_MASK_VDS : 4;
} io_port_div_mask_vds_t;

extern volatile io_port_div_mask_vds_t PORT_DIV_MASK_VDS __attribute__((nodp, addr(0x248)));

typedef struct io_port_cnt_mask_vds_ls_s {
    uint16_t CNT_MASK0_VDS_LS : 4;
    uint16_t CNT_MASK1_VDS_LS : 4;
    uint16_t CNT_MASK2_VDS_LS : 4;
} io_port_cnt_mask_vds_ls_t;

extern volatile io_port_cnt_mask_vds_ls_t PORT_CNT_MASK_VDS_LS __attribute__((nodp, addr(0x24a)));

typedef struct io_port_cnt_mask_vds_hs_s {
    uint16_t CNT_MASK0_VDS_HS : 4;
    uint16_t CNT_MASK1_VDS_HS : 4;
    uint16_t CNT_MASK2_VDS_HS : 4;
} io_port_cnt_mask_vds_hs_t;

extern volatile io_port_cnt_mask_vds_hs_t PORT_CNT_MASK_VDS_HS __attribute__((nodp, addr(0x24c)));

typedef struct io_port_div_eild_s {
    uint16_t DIV_EILD : 3;
} io_port_div_eild_t;

extern volatile io_port_div_eild_t PORT_DIV_EILD __attribute__((nodp, addr(0x24e)));

typedef struct io_port_cnt_eild_lsoff_s {
    uint16_t CNT_EILD0_LSOFF : 4;
    uint16_t CNT_EILD1_LSOFF : 4;
    uint16_t CNT_EILD2_LSOFF : 4;
} io_port_cnt_eild_lsoff_t;

extern volatile io_port_cnt_eild_lsoff_t PORT_CNT_EILD_LSOFF __attribute__((nodp, addr(0x250)));

typedef struct io_port_cnt_eild_hsoff_s {
    uint16_t CNT_EILD0_HSOFF : 4;
    uint16_t CNT_EILD1_HSOFF : 4;
    uint16_t CNT_EILD2_HSOFF : 4;
} io_port_cnt_eild_hsoff_t;

extern volatile io_port_cnt_eild_hsoff_t PORT_CNT_EILD_HSOFF __attribute__((nodp, addr(0x252)));

typedef struct io_trim_iild_s {
    uint16_t CNT_IILD : 4;
    uint16_t reserved_4 : 11;
    uint16_t LOCK : 1;
} io_trim_iild_t;

extern volatile io_trim_iild_t TRIM_IILD __attribute__((nodp, addr(0x254)));

typedef struct io_port_cdi_in_s {
    const uint16_t CDI : 3;
} io_port_cdi_in_t;

extern volatile io_port_cdi_in_t PORT_CDI_IN __attribute__((nodp, addr(0x256)));

typedef struct io_port_i2c_conf_s {
    uint16_t I2C_ADDR : 7;
    uint16_t I2C_ADDR_VALID : 1;
    uint16_t SDA_FILT_ENABLE : 1;
    uint16_t I2C_SCL_CLK_SEL : 4;
} io_port_i2c_conf_t;

extern volatile io_port_i2c_conf_t PORT_I2C_CONF __attribute__((nodp, addr(0x258)));

typedef struct io_port_i2c_dma_offset_s {
    uint16_t I2C_DMA_OFFSET;
} io_port_i2c_dma_offset_t;

extern volatile io_port_i2c_dma_offset_t PORT_I2C_DMA_OFFSET __attribute__((nodp, addr(0x25a)));

typedef struct io_port_i2c_read_offset_s {
    uint16_t I2C_READ_OFFSET : 8;
} io_port_i2c_read_offset_t;

extern volatile io_port_i2c_read_offset_t PORT_I2C_READ_OFFSET __attribute__((nodp, addr(0x25c)));
...
typedef struct io_port_misc_test_s {
    ...
    uint16_t TEST_SCREEN : 1;
    uint16_t TST_TA0_IO : 2;
    uint16_t TST_TA0_BUF_ENABLE : 1;
    uint16_t TST_VDDD_IO4 : 1;
    uint16_t SWI_5K : 1;
    uint16_t SWI_1K : 1;
    uint16_t TST_SHOVE_IO : 1;
    uint16_t TST_CS_DAC : 1;
} io_port_misc_test_t;

extern volatile io_port_misc_test_t PORT_MISC_TEST __attribute__((nodp, addr(0x25e)));

typedef struct io_port_misc2_test_s {
    uint16_t TST_ADC_IN : 2;
    uint16_t TA_CTRL_ADC : 3;
    uint16_t VDDD_MONITOR_TEST : 2;
    uint16_t ADC_BLOCK_TOGGLE : 1;
} io_port_misc2_test_t;

extern volatile io_port_misc2_test_t PORT_MISC2_TEST __attribute__((nodp, addr(0x260)));

typedef struct io_port_ppm_rbase_add_s {
    uint16_t PPM_RBASE_ADD;
} io_port_ppm_rbase_add_t;

extern volatile io_port_ppm_rbase_add_t PORT_PPM_RBASE_ADD __attribute__((nodp, addr(0x262)));

typedef struct io_port_ppm_tbase_add_s {
    uint16_t PPM_TBASE_ADD;
} io_port_ppm_tbase_add_t;

extern volatile io_port_ppm_tbase_add_t PORT_PPM_TBASE_ADD __attribute__((nodp, addr(0x264)));

typedef struct io_port_ppm_timeout_s {
    uint16_t PPM_TIMEOUT;
} io_port_ppm_timeout_t;

extern volatile io_port_ppm_timeout_t PORT_PPM_TIMEOUT __attribute__((nodp, addr(0x266)));
...
extern volatile io_port_ppm_ctrl_t PORT_PPM_CTRL __attribute__((nodp, addr(0x268)));

typedef struct io_port_ppm_buf_data_s {
    const uint16_t PPM_BUF_DATA;
} io_port_ppm_buf_data_t;

extern volatile io_port_ppm_buf_data_t PORT_PPM_BUF_DATA __attribute__((nodp, addr(0x26a)));

typedef struct io_ppm_timer_s {
    uint16_t PPM_ON_TIME;
} io_ppm_timer_t;

extern volatile io_ppm_timer_t PPM_TIMER __attribute__((nodp, addr(0x26c)));
...
extern volatile io_port_ppm_flags_t PORT_PPM_FLAGS __attribute__((nodp, addr(0x26e)));

typedef struct io_port_tx_timeout_s {
    const uint16_t TX_TIMEOUT : 1;
} io_port_tx_timeout_t;

extern volatile io_port_tx_timeout_t PORT_TX_TIMEOUT __attribute__((nodp, addr(0x270)));

typedef struct io_port_udma0_rda_s {
    uint16_t UDMA0_RDA;
} io_port_udma0_rda_t;

extern volatile io_port_udma0_rda_t PORT_UDMA0_RDA __attribute__((nodp, addr(0x272)));

typedef struct io_port_udma0_rdb_s {
    uint16_t UDMA0_RDB;
} io_port_udma0_rdb_t;

extern volatile io_port_udma0_rdb_t PORT_UDMA0_RDB __attribute__((nodp, addr(0x274)));

typedef struct io_port_udma0_tx_s {
    uint16_t UDMA0_TX;
} io_port_udma0_tx_t;

extern volatile io_port_udma0_tx_t PORT_UDMA0_TX __attribute__((nodp, addr(0x276)));

typedef struct io_port_udma0_size_s {
    uint16_t UDMA0_SIZRX : 8;
    uint16_t UDMA0_SIZTX : 8;
} io_port_udma0_size_t;

extern volatile io_port_udma0_size_t PORT_UDMA0_SIZE __attribute__((nodp, addr(0x278)));

typedef struct io_port_udma0_ctrl_s {
    uint16_t UDMA0_EN : 1;
    uint16_t UDMA0_TXSTART : 1;
    uint16_t UDMA0_LSB_FIRST : 1;
    uint16_t UDMA0_LOWBYTE_FIRST : 1;
    uint16_t UART0_STOP_MODE : 1;
} io_port_udma0_ctrl_t;

extern volatile io_port_udma0_ctrl_t PORT_UDMA0_CTRL __attribute__((nodp, addr(0x27a)));

typedef struct io_uart0_s {
    uint16_t BRRD;
    uint16_t TRD;
    const uint16_t RRD;
...
extern volatile io_uart0_t UART0 __attribute__((nodp, addr(0x27c)));

typedef struct io_port_udma0_status_s {
    const uint16_t UDMA0_RD_BUFFER_VALID : 1;
    const uint16_t UDMA0_FRC : 1;
    const uint16_t UDMA0_FTR : 1;
    const uint16_t CUSTOM_UART0_DMA_ERR : 1;
} io_port_udma0_status_t;

extern volatile io_port_udma0_status_t PORT_UDMA0_STATUS __attribute__((nodp, addr(0x288)));

typedef struct io_port_udma1_rda_s {
    uint16_t UDMA1_RDA;
} io_port_udma1_rda_t;

extern volatile io_port_udma1_rda_t PORT_UDMA1_RDA __attribute__((nodp, addr(0x28a)));

typedef struct io_port_udma1_rdb_s {
    uint16_t UDMA1_RDB;
} io_port_udma1_rdb_t;

extern volatile io_port_udma1_rdb_t PORT_UDMA1_RDB __attribute__((nodp, addr(0x28c)));

typedef struct io_port_udma1_tx_s {
    uint16_t UDMA1_TX;
} io_port_udma1_tx_t;

extern volatile io_port_udma1_tx_t PORT_UDMA1_TX __attribute__((nodp, addr(0x28e)));

typedef struct io_port_udma1_size_s {
    uint16_t UDMA1_SIZRX : 8;
    uint16_t UDMA1_SIZTX : 8;
} io_port_udma1_size_t;

extern volatile io_port_udma1_size_t PORT_UDMA1_SIZE __attribute__((nodp, addr(0x290)));

typedef struct io_port_udma1_ctrl_s {
    uint16_t UDMA1_EN : 1;
    uint16_t UDMA1_TXSTART : 1;
    uint16_t UDMA1_LSB_FIRST : 1;
    uint16_t UDMA1_LOWBYTE_FIRST : 1;
    uint16_t UART1_STOP_MODE : 1;
} io_port_udma1_ctrl_t;

extern volatile io_port_udma1_ctrl_t PORT_UDMA1_CTRL __attribute__((nodp, addr(0x292)));

typedef struct io_uart1_s {
    uint16_t BRRD;
    uint16_t TRD;
    const uint16_t RRD;
    const uint16_t LFCD : 8;
...
extern volatile io_uart1_t UART1 __attribute__((nodp, addr(0x294)));

typedef struct io_port_udma1_status_s {
    const uint16_t UDMA1_RD_BUFFER_VALID : 1;
    const uint16_t UDMA1_FRC : 1;
    const uint16_t UDMA1_FTR : 1;
    const uint16_t CUSTOM_UART1_DMA_ERR : 1;
} io_port_udma1_status_t;

extern volatile io_port_udma1_status_t PORT_UDMA1_STATUS __attribute__((nodp, addr(0x2a0)));

typedef struct io_port_curr_sens_s {
    uint16_t SET_CS : 8;
    uint16_t EN_CSA : 1;
    uint16_t CSA_ZERO : 1;
    uint16_t CSA_HIGHGAIN : 1;
    uint16_t EN_OC : 1;
    uint16_t CSA_CHOP : 1;
    uint16_t CSA_BYPASS : 1;
} io_port_curr_sens_t;

extern volatile io_port_curr_sens_t PORT_CURR_SENS __attribute__((nodp, addr(0x2a2)));

typedef struct io_port_cp_s {
    uint16_t EN_CP : 1;
    uint16_t SET_CPDRV : 1;
    uint16_t CP_TRI : 1;
} io_port_cp_t;

extern volatile io_port_cp_t PORT_CP __attribute__((nodp, addr(0x2a4)));

typedef struct io_trim_cp_s {
    uint16_t TR_RCO50K : 4;
    uint16_t TR_CP : 4;
    uint16_t reserved_8 : 7;
    uint16_t LOCK : 1;
} io_trim_cp_t;

extern volatile io_trim_cp_t TRIM_CP __attribute__((nodp, addr(0x2a6)));

typedef struct io_port_active_cdi_s {
    uint16_t ACTIVE_CDI_PHASE : 2;
    uint16_t ACTIVE_CDI_CLK_DIV : 4;
    uint16_t ACTIVE_CDI_DEB : 2;
    uint16_t ACTIVE_CDI_MSK : 4;
    uint16_t ACTIVE_CDI_EDGE_SEL : 2;
    uint16_t ACTIVE_CDI_CLK_PREDIV2 : 1;
    uint16_t CDI_FET_SWITCH_ALL : 1;
} io_port_active_cdi_t;

extern volatile io_port_active_cdi_t PORT_ACTIVE_CDI __attribute__((nodp, addr(0x2a8)));

typedef struct io_port_active_cdi_in_s {
    const uint16_t ACTIVE_CDI_COMP_SYNC : 1;
    const uint16_t ACTIVE_CDI_VALID : 1;
} io_port_active_cdi_in_t;

extern volatile io_port_active_cdi_in_t PORT_ACTIVE_CDI_IN __attribute__((nodp, addr(0x2aa)));
