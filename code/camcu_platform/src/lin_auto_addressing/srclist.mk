...
# SEARCH PATHES
#
VPATH += $(APP_MOD_DIR)/lin_auto_addressing/$(PRODUCT)


#
# SOURCE FILES LIST
#
APP_MODULES_SRCS += mdl_LIN_AA_0xB5.c
APP_MODULES_SRCS += mdl_LIN_AA.c


#
# HEADER SEARCH PATHES
#
INC_DIRS += $(APP_MOD_DIR)/lin_auto_addressing/$(PRODUCT)
